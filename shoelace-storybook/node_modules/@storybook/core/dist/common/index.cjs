...
var vh = Object.getPrototypeOf, xh = Object.prototype.hasOwnProperty;
var g = (r, A) => hr(r, "name", { value: A, configurable: !0 });
var wC = (r, A) => () => (r && (A = r(r = 0)), A);
var j = (r, A) => () => (A || r((A = { exports: {} }).exports, A), A.exports), wg = (r, A) => {
  for (var e in A)
    hr(r, e, { get: A[e], enumerable: !0 });
}, dC = (r, A, e, t) => {
  if (A && typeof A == "object" || typeof A == "function")
    for (let i of Jh(A))
      !xh.call(r, i) && i !== e && hr(r, i, { get: () => A[i], enumerable: !(t = Gh(A, i)) || t.enumerable });
  return r;
};
var J = (r, A, e) => (e = r != null ? Uh(vh(r)) : {}, dC(
  ...
  r
)), te = (r) => dC(hr({}, "__esModule", { value: !0 }), r);
...
var NC = j((qD, FC) => {
  ...
  FC.exports = KC;
  function KC(r, A, e) {
    r instanceof RegExp && (r = DC(r, e)), A instanceof RegExp && (A = DC(A, e));
    var t = SC(r, A, e);
    return t && {
      start: t[0],
      end: t[1],
...
var GC = j((WD, UC) => {
  var kC = NC();
  UC.exports = Hh;
  var MC = "\0SLASH" + Math.random() + "\0", RC = "\0OPEN" + Math.random() + "\0", yg = "\0CLOSE" + Math.random() + "\0", bC = "\0COMMA" + Math.
  random() + "\0", LC = "\0PERIOD" + Math.random() + "\0";
  function mg(r) {
    return parseInt(r, 10) == r ? parseInt(r, 10) : r.charCodeAt(0);
  }
  g(mg, "numeric");
  function _h(r) {
    return r.split("\\\\").join(MC).split("\\{").join(RC).split("\\}").join(yg).split("\\,").join(bC).split("\\.").join(LC);
  }
  g(_h, "escapeBraces");
  function Th(r) {
    return r.split(MC).join("\\").split(RC).join("{").split(yg).join("}").split(bC).join(",").split(LC).join(".");
  }
  g(Th, "unescapeBraces");
  function YC(r) {
    if (!r)
  ...
  g(YC, "parseCommaParts");
  function Hh(r) {
    return r ? (r.substr(0, 2) === "{}" && (r = "\\{\\}" + r.substr(2)), ur(_h(r), !0).map(Th)) : [];
  }
  g(Hh, "expandTop");
  function jh(r) {
    return "{" + r + "}";
  ...
  function ur(r, A) {
    ...
    if (/\$$/.test(t.pre))
      ...
      indexOf(",") >= 0;
      if (!h && !u)
        return t.post.match(/,.*\}/) ? (r = t.pre + "{" + t.body + yg + t.post, ur(r)) : [r];
      var f;
      if (h)
        f = t.body.split(/\.\./);
      else if (f = YC(t.body), f.length === 1 && (f = ur(f[0], !1).map(jh), f.length === 1))
        return o.map(function(hA) {
          return t.pre + f[0] + hA;
        });
      var p;
      if (h) {
        var m = mg(f[0]), D = mg(f[1]), U = Math.max(f[0].length, f[1].length), R = f.length == 3 ? Math.abs(mg(f[2])) : 1, T = zh, M = D < m;
        M && (R *= -1, T = Wh);
        var x = f.some(qh);
        p = [];
...
var Hg = j((pS, Tg) => {
  "use strict";
  var SI = require("path"), FI = require("module"), ru = require("fs"), NI = /* @__PURE__ */ g((r, A, e) => {
    if (typeof r != "string")
    ...
    let t = SI.join(r, "noop.js"), i = /* @__PURE__ */ g(() => FI._resolveFilename(A, {
      id: t,
      filename: t,
      paths: FI._nodeModulePaths(r)
    }), "resolveFileName");
    if (e)
      try {
        return i();
  ...
  Tg.exports = (r, A) => NI(r, A);
  Tg.exports.silent = (r, A) => NI(r, A, !0);
});

// ../node_modules/common-path-prefix/index.js
var _I = j((GS, OI) => {
  "use strict";
  var { sep: Cu } = require("path"), Iu = /* @__PURE__ */ g((r) => {
    for (let A of r) {
      let e = /(\/|\\)/.exec(A);
  ...
  OI.exports = /* @__PURE__ */ g(function(A, e = Iu(A)) {
    let [t = "", ...i] = A;
...
var ma = j((UF, Ue) => {
  var ns = require("fs"), Cs = require("path"), Pu = require("os"), Ou = require("crypto"), _u = fa(), Is = _u.version, Tu = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
  function Hu(r) {
    let A = {}, e = r.toString();
    e = e.replace(/\r\n?/mg, `
`);
    let t;
    for (; (t = Tu.exec(e)) != null; ) {
      let i = t[1], o = t[2] || "";
      o = o.trim();
      let s = o[0];
...
`), o = o.replace(/\\r/g, "\r")), A[i] = o;
  ...
  g(Hu, "parse");
  function ju(r) {
    let A = pa(r), e = pA.configDotenv({ path: A });
    if (!e.parsed) {
      let s = new Error(`MISSING_DATA: Cannot parse ${A} for an unknown reason`);
      throw s.code = "MISSING_DATA", s;
    }
    let t = da(r).split(","), i = t.length, o;
    for (let s = 0; s < i; s++)
      try {
        let I = t[s].trim(), E = Wu(e, I);
  ...
  g(ju, "_parseVault");
  function qu(r) {
    console.log(`[dotenv@${Is}][INFO] ${r}`);
  }
  g(qu, "_log");
  function zu(r) {
    console.log(`[dotenv@${Is}][WARN] ${r}`);
  }
  g(zu, "_warn");
  function Xi(r) {
    console.log(`[dotenv@${Is}][DEBUG] ${r}`);
  }
  g(Xi, "_debug");
  function da(r) {
...
t?environment=development");
  ...
  function pa(r) {
    ...
    if (r && r.path && r.path.length > 0)
      if (Array.isArray(r.path))
        for (let e of r.path)
          ns.existsSync(e) && (A = e.endsWith(".vault") ? e : `${e}.vault`);
      else
        A = r.path.endsWith(".vault") ? r.path : `${r.path}.vault`;
    else
      A = Cs.resolve(process.cwd(), ".env.vault");
    return ns.existsSync(A) ? A : null;
  }
  g(pa, "_vaultPath");
  function wa(r) {
    return r[0] === "~" ? Cs.join(Pu.homedir(), r.slice(1)) : r;
  }
  g(wa, "_resolveHome");
  function Xu(r) {
    qu("Loading env from encrypted .env.vault");
    let A = pA._parseVault(r), e = process.env;
    return r && r.processEnv != null && (e = r.processEnv), pA.populate(e, A, r), { parsed: A };
  }
  g(Xu, "_configVault");
  function Vu(r) {
    let A = Cs.resolve(process.cwd(), ".env"), e = "utf8", t = !!(r && r.debug);
    r && r.encoding ? e = r.encoding : t && Xi("No encoding is specified. UTF-8 is used by default");
    let i = [A];
    if (r && r.path)
      if (!Array.isArray(r.path))
        i = [wa(r.path)];
    ...
    for (let E of i)
      try {
        let B = pA.parse(ns.readFileSync(E, { encoding: e }));
        pA.populate(s, B, r);
      } catch (B) {
        t && Xi(`Failed to load ${E} ${B.message}`), o = B;
      }
    let I = process.env;
  ...
  function Zu(r) {
    ...
    let A = pa(r);
    return A ? pA._configVault(r) : (zu(`You set DOTENV_KEY but you are missing a .env.vault file at ${A}. Did you forget to build it?`), pA.
    configDotenv(r));
  }
  g(Zu, "config");
  function $u(r, A) {
    ...
    t = t.subarray(12, -16);
    try {
      let s = Ou.createDecipheriv("aes-256-gcm", e, i);
...
e data";
  ...
  function Af(r, A, e = {}) {
    ...
    for (let o of Object.keys(A))
      Object.prototype.hasOwnProperty.call(r, o) ? (i === !0 && (r[o] = A[o]), t && Xi(i === !0 ? `"${o}" is already defined and WAS overwri\
...
var Ka = j((JF, Da) => {
  ...
  g(rf, "expand");
  Da.exports.expand = rf;
});

// ../node_modules/picomatch/lib/constants.js
var Pr = j((KN, qa) => {
  "use strict";
  var wf = require("path"), ke = "\\\\/", _a = `[^${ke}]`, Je = "\\.", df = "\\+", pf = "\\?", Zi = "\\/", mf = "(?=.)", Ta = "[^/]", ls = `\
(?:${Zi}|$)`, Ha = `(?:^|${Zi})`, us = `${Je}{1,2}${ls}`, yf = `(?!${Je})`, Df = `(?!${Ha}${us})`, Kf = `(?!${Je}{0,1}${ls})`, Sf = `(?!${us}\
)`, Ff = `[^.${Zi}]`, Nf = `${Ta}*?`, ja = {
    DOT_LITERAL: Je,
    PLUS_LITERAL: df,
    QMARK_LITERAL: pf,
...
var $i = j((jA) => {
  "use strict";
  var Rf = require("path"), bf = process.platform === "win32", {
    REGEX_BACKSLASH: Lf,
    REGEX_REMOVE_BACKSLASH: Yf,
    REGEX_SPECIAL_CHARS: Uf,
    REGEX_SPECIAL_CHARS_GLOBAL: Gf
  } = Pr();
  jA.isObject = (r) => r !== null && typeof r == "object" && !Array.isArray(r);
  jA.hasRegexChars = (r) => Uf.test(r);
  jA.isRegexChar = (r) => r.length === 1 && jA.hasRegexChars(r);
  jA.escapeRegex = (r) => r.replace(Gf, "\\$1");
  jA.toPosixSlashes = (r) => r.replace(Lf, "/");
  jA.removeBackslashes = (r) => r.replace(Yf, (A) => A === "\\" ? "" : A);
  jA.supportsLookbehinds = () => {
    let r = process.version.slice(1).split(".").map(Number);
    return r.length === 3 && r[0] >= 9 || r[0] === 8 && r[1] >= 10;
  };
  jA.isWindows = (r) => r && typeof r.windows == "boolean" ? r.windows : bf === !0 || Rf.sep === "\\";
  jA.escapeLast = (r, A, e) => {
...
var eE = j((FN, AE) => {
  ...
  var za = $i(), {
    ...
    CHAR_DOT: ws,
    /* . */
    CHAR_EXCLAMATION_MARK: ds,
    /* ! */
    CHAR_FORWARD_SLASH: $a,
    /* / */
    CHAR_LEFT_CURLY_BRACE: ps,
    /* { */
    CHAR_LEFT_PARENTHESES: ms,
    /* ( */
    CHAR_LEFT_SQUARE_BRACKET: xf,
    /* [ */
    CHAR_PLUS: Pf,
    /* + */
    CHAR_QUESTION_MARK: Wa,
    /* ? */
    CHAR_RIGHT_CURLY_BRACE: Of,
    /* } */
    CHAR_RIGHT_PARENTHESES: Xa,
    /* ) */
    CHAR_RIGHT_SQUARE_BRACKET: _f
    /* ] */
  } = Pr(), Va = /* @__PURE__ */ g((r) => r === $a || r === Or, "isPathSeparator"), Za = /* @__PURE__ */ g((r) => {
    r.isPrefix !== !0 && (r.depth = r.isGlobstar ? 1 / 0 : 1);
  }, "depth"), Tf = /* @__PURE__ */ g((r, A) => {
    ...
    for (; B < t; ) {
      ...
      let kA;
      if (P === Or) {
        T = Z.backslashes = !0, P = cA(), P === ps && (R = !0);
        continue;
      }
      if (R === !0 || P === ps) {
        for (gA++; hA() !== !0 && (P = cA()); ) {
      ...
      if (e.noext !== !0 && (P === Pf || P === Jf || P === fs || P === Wa || P === ds) === !0 && F() === ms) {
        if (m = Z.isGlob = !0, D = Z.isExtglob = !0, V = !0, P === ds && B === h && (x = !0), i === !0) {
          for (; hA() !== !0 && (P = cA()); ) {
            if (P === Or) {
      ...
      if (P === fs) {
        if (sA === fs && (U = Z.isGlobstar = !0), m = Z.isGlob = !0, V = !0, i === !0)
          continue;
        break;
      }
      if (P === Wa) {
    ...
    e.noext === !0 && (D = !1, m = !1);
    let BA = E, Ce = "", K = "";
    h > 0 && (Ce = E.slice(0, h), E = E.slice(h), u -= h), BA && m === !0 && u > 0 ? (BA = E.slice(0, u), K = E.slice(u)) : m === !0 ? (BA =
    "", K = E) : BA = E, BA && BA !== "" && BA !== "/" && BA !== E && Va(BA.charCodeAt(BA.length - 1)) && (BA = BA.slice(0, -1)), e.unescape ===
    !0 && (K && (K = za.removeBackslashes(K)), BA && T === !0 && (BA = za.removeBackslashes(BA)));
    let S = {
      prefix: Ce,
      input: r,
      start: h,
    ...
    if (e.tokens === !0 && (S.maxDepth = 0, Va(P) || s.push(Z), S.tokens = s), e.parts === !0 || e.tokens === !0) {
      let kA;
      for (let oA = 0; oA < o.length; oA++) {
        let MA = kA ? kA + 1 : h, WA = o[oA], yA = r.slice(MA, WA);
        e.tokens && (oA === 0 && h !== 0 ? (s[oA].isPrefix = !0, s[oA].value = Ce) : s[oA].value = yA, Za(s[oA]), S.maxDepth += s[oA].depth),
        (oA !== 0 || yA !== "") && I.push(yA), kA = WA;
      }
      if (kA && kA + 1 < r.length) {
        let oA = r.slice(kA + 1);
        I.push(oA), e.tokens && (s[s.length - 1].value = oA, Za(s[s.length - 1]), S.maxDepth += s[s.length - 1].depth);
      }
...
var iE = j((kN, rE) => {
  ...
  var Ao = Pr(), Ae = $i(), {
    MAX_LENGTH: eo,
    POSIX_REGEX_SOURCE: Hf,
    REGEX_NON_SPECIAL_CHARS: jf,
    REGEX_SPECIAL_CHARS_BACKREF: qf,
    REPLACEMENTS: tE
  } = Ao, zf = /* @__PURE__ */ g((r, A) => {
    ...
    return e;
  }, "expandRange"), Wt = /* @__PURE__ */ g((r, A) => `Missing ${r}: "${A}" - use "\\\\${A}" to match literal characters`, "syntaxError"), ys = /* @__PURE__ */ g(
  (r, A) => {
    if (typeof r != "string")
      throw new TypeError("Expected a string");
    r = tE[r] || r;
    let e = { ...A }, t = typeof e.maxLength == "number" ? Math.min(eo, e.maxLength) : eo, i = r.length;
    if (i > t)
      throw new SyntaxError(`Input length: ${i}, exceeds maximum allowed length: ${t}`);
    let o = { type: "bos", value: "", output: e.prepend || "" }, s = [o], I = e.capture ? "" : "?:", E = Ae.isWindows(A), B = Ao.globChars(E),
    h = Ao.extglobChars(B), {
      DOT_LITERAL: u,
      PLUS_LITERAL: f,
      SLASH_LITERAL: p,
    ...
    let cA = [], BA = [], Ce = [], K = o, S, kA = /* @__PURE__ */ g(() => F.index === i - 1, "eos"), oA = F.peek = (Y = 1) => r[F.index + Y],
    MA = F.advance = () => r[++F.index] || "", WA = /* @__PURE__ */ g(() => r.slice(F.index + 1), "remaining"), yA = /* @__PURE__ */ g((Y = "", IA = 0) => {
      ...
      if (K.type === "globstar") {
        ...
        "paren");
        Y.type !== "slash" && Y.type !== "paren" && !IA && !b && (F.output = F.output.slice(0, -K.output.length), K.type = "star", K.value =
        "*", K.output = hA, F.output += K.output);
      }
      if (cA.length && Y.type !== "paren" && (cA[cA.length - 1].inner += Y.value), (Y.value || Y.output) && at(Y), K && K.type === "text" &&
      Y.type === "text") {
      ...
      if (Y.type === "negate") {
        ...
        `)$))${N}`), Y.inner.includes("*") && (b = WA()) && /^\.[^\\/.]+$/.test(b)) {
          let QA = ys(b, { ...A, fastpaths: !1 }).output;
          IA = Y.close = `)${QA})${N})`;
        }
        Y.prev.type === "bos" && (F.negatedExtglob = !0);
      }
      rA({ type: "paren", extglob: !0, value: S, output: IA }), Me("parens");
    }, "extglobClose");
    if (e.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(r)) {
      let Y = !1, IA = r.replace(qf, (b, N, QA, DA, lA, Kt) => DA === "\\" ? (Y = !0, b) : DA === "?" ? N ? N + DA + (lA ? M.repeat(lA.length) :
...
\\" : "")), IA === r && e.contains === !0 ? (F.output = r, F) : (F.output = Ae.wrapOutput(IA, F, A), F);
    ...
    for (; !kA(); ) {
      ...
      if (S === "\\") {
        ...
        let N = /^\\+/.exec(WA()), QA = 0;
        if (N && N[0].length > 2 && (QA = N[0].length, F.index += QA, QA % 2 !== 0 && (S += "\\")), e.unescape === !0 ? S = MA() : S += MA(),
        F.brackets === 0) {
      ...
      if (F.brackets > 0 && (S !== "]" || K.value === "[" || K.value === "[^")) {
        if (e.posix !== !1 && S === ":") {
          ...
          if (b.includes("[") && (K.posix = !0, b.includes(":"))) {
            let N = K.value.lastIndexOf("["), QA = K.value.slice(0, N), DA = K.value.slice(N + 2), lA = Hf[DA];
            if (lA) {
              K.value = QA + lA, F.backtrack = !0, MA(), !o.output && s.indexOf(K) === 1 && (o.output = m);
              continue;
            }
          }
        }
      ...
      if (S === "(") {
        He("parens"), rA({ type: "paren", value: S });
        continue;
      }
      if (S === ")") {
        ...
        rA({ type: "paren", value: S, output: F.parens ? ")" : "\\)" }), Me("parens");
        continue;
      }
      if (S === "[") {
      ...
      if (S === ",") {
        let b = S, N = BA[BA.length - 1];
        N && Ce[Ce.length - 1] === "braces" && (N.comma = !0, b = "|"), rA({ type: "comma", value: S, output: b });
        continue;
      }
      if (S === "/") {
      ...
      if (S === "?") {
        ...
        if (K && K.type === "paren") {
          ...
          (K.value === "(" && !/[!=<:]/.test(N) || N === "<" && !/<([!=]|\w+>)/.test(WA())) && (QA = `\\${S}`), rA({ type: "text", value: S,
          output: QA });
          continue;
        }
      ...
      if (K && (K.type === "globstar" || K.star === !0)) {
        K.type = "star", K.star = !0, K.value += S, K.output = hA, F.backtrack = !0, F.globstar = !0, yA(S);
        continue;
      }
      let Y = WA();
      ...
      if (K.type === "star") {
        ...
        let b = K.prev, N = b.prev, QA = b.type === "slash" || b.type === "bos", DA = N && (N.type === "star" || N.type === "globstar");
...
|${p}${Er})`, K.value += S, F.output += b.output + K.output, F.globstar = !0, yA(S + MA()), rA({ type: "slash", value: "/", output: "" });
          continue;
        }
        if (b.type === "bos" && Y[0] === "/") {
          K.type = "globstar", K.value += S, K.output = `(?:^|${p}|${sA(e)}${p})`, F.output = K.output, F.globstar = !0, yA(S + MA()), rA({ type: "\
slash", value: "/", output: "" });
          continue;
        }
  ...
  ys.fastpaths = (r, A) => {
    ...
    let o = Ae.isWindows(A), {
      ...
      STAR: p,
      START_ANCHOR: m
    } = Ao.globChars(o), D = e.dot ? u : h, U = e.dot ? f : h, R = e.capture ? "" : "?:", T = { negated: !1, prefix: "" }, M = e.bash === !0 ?
    ".*?" : p;
    e.capture && (M = `(${M})`);
...
var gE = j((RN, oE) => {
  "use strict";
  var Wf = require("path"), Xf = eE(), Ds = iE(), Ks = $i(), Vf = Pr(), Zf = /* @__PURE__ */ g((r) => r && typeof r == "object" && !Array.isArray(
  r), "isObject"), wA = /* @__PURE__ */ g((r, A, e = !1) => {
    ...
    let t = Zf(r) && r.tokens && r.input;
    if (r === "" || typeof r != "string" && !t)
      throw new TypeError("Expected pattern to be a non-empty string");
    let i = A || {}, o = Ks.isWindows(A), s = t ? wA.compileRe(r, A) : wA.makeRe(r, A, !1, !0), I = s.state;
    delete s.state;
...
ion" && i.onIgnore(D), D.isMatch = !1, u ? D : !1) : (typeof i.onMatch == "function" && i.onMatch(D), u ? D : !0);
  ...
  wA.test = (r, A, e, { glob: t, posix: i } = {}) => {
    ...
    let o = e || {}, s = o.format || (i ? Ks.toPosixSlashes : null), I = r === t, E = I && s ? s(r) : r;
  ...
  wA.matchBase = (r, A, e, t = Ks.isWindows(e)) => (A instanceof RegExp ? A : wA.makeRe(A, e)).test(Wf.basename(r));
  wA.isMatch = (r, A, e) => wA(A, e)(r);
  wA.parse = (r, A) => Array.isArray(r) ? r.map((e) => wA.parse(e, A)) : Ds(r, { ...A, fastpaths: !1 });
  wA.scan = (r, A) => Xf(r, A);
  ...
  wA.makeRe = (r, A = {}, e = !1, t = !1) => {
    ...
    return A.fastpaths !== !1 && (r[0] === "." || r[0] === "*") && (i.output = Ds.fastpaths(r, A)), i.output || (i = Ds(r, A)), wA.compileRe(
    i, A, e, t);
  };
  wA.toRegex = (r, A) => {
    try {
...
var go = j((VN, Ns) => {
  var cE = process.argv || [], oo = process.env, rw = !("NO_COLOR" in oo || cE.includes("--no-color")) && ("FORCE_COLOR" in oo || cE.includes(
  "--color") || process.platform === "win32" || require != null && require("tty").isatty(1) && oo.TERM !== "dumb" || "CI" in oo), iw = /* @__PURE__ */ g(
  (r, A, e = r) => (t) => {
    let i = "" + t, o = i.indexOf(A, r.length);
    return ~o ? r + ow(i, A, e, o) + A : r + i + A;
  }, "formatter"), ow = /* @__PURE__ */ g((r, A, e, t) => {
    let i = "", o = 0;
    do
      i += r.substring(o, t) + e, o = t + A.length, t = r.indexOf(A, o);
    while (~t);
    return i + r.substring(o);
  }, "replaceClose"), BE = /* @__PURE__ */ g((r = rw) => {
    let A = r ? iw : () => String;
    return {
      isColorSupported: r,
...
var KE = j((Ik, DE) => {
  ...
  g(Bw, "checkPathExt");
  function mE(r, A, e) {
    return !r.isSymbolicLink() && !r.isFile() ? !1 : Bw(A, e);
  }
  g(mE, "checkStat");
  function yE(r, A, e) {
    pE.stat(r, function(t, i) {
      e(t, t ? !1 : mE(i, r, A));
    });
  }
  g(yE, "isexe");
  function Qw(r, A) {
    return mE(pE.statSync(r), r, A);
  }
  g(Qw, "sync");
});
...
var ME = j((Ek, kE) => {
  ...
  var SE = require("fs");
  function FE(r, A, e) {
    SE.stat(r, function(t, i) {
      e(t, t ? !1 : NE(i, A));
    });
  }
  g(FE, "isexe");
  function hw(r, A) {
    return NE(SE.statSync(r), A);
  }
  g(hw, "sync");
  function NE(r, A) {
    return r.isFile() && lw(r, A);
  }
  g(NE, "checkStat");
  function lw(r, A) {
...
var bE = j((Qk, RE) => {
  var Bk = require("fs"), Co;
  process.platform === "win32" || global.TESTING_WINDOWS ? Co = KE() : Co = ME();
  RE.exports = Ms;
  Ms.sync = uw;
  function Ms(r, A, e) {
...
var xE = j((lk, vE) => {
  var Xt = process.platform === "win32" || process.env.OSTYPE === "cygwin" || process.env.OSTYPE === "msys", LE = require("path"), fw = Xt ?
  ";" : ":", YE = bE(), UE = /* @__PURE__ */ g((r) => Object.assign(new Error(`not found: ${r}`), { code: "ENOENT" }), "getNotFoundError"), GE = /* @__PURE__ */ g(
  (r, A) => {
    let e = A.colon || fw, t = r.match(/\//) || Xt && r.match(/\\/) ? [""] : [
  ...
  }, "getPathInfo"), JE = /* @__PURE__ */ g((r, A, e) => {
    typeof A == "function" && (e = A, A = {}), A || (A = {});
    let { pathEnv: t, pathExt: i, pathExtExe: o } = GE(r, A), s = [], I = /* @__PURE__ */ g((B) => new Promise((h, u) => {
      if (B === t.length)
        return A.all && s.length ? h(s) : u(UE(r));
      let f = t[B], p = /^".*"$/.test(f) ? f.slice(1, -1) : f, m = LE.join(p, r), D = !p && /^\.[\\\/]/.test(r) ? r.slice(0, 2) + m : m;
      h(E(D, B, 0));
    }), "step"), E = /* @__PURE__ */ g((B, h, u) => new Promise((f, p) => {
      if (u === i.length)
        return f(I(h + 1));
      let m = i[u];
      YE(B + m, { pathExt: o }, (D, U) => {
        if (!D && U)
          if (A.all)
            s.push(B + m);
          else
  ...
  }, "which"), ww = /* @__PURE__ */ g((r, A) => {
    A = A || {};
    let { pathEnv: e, pathExt: t, pathExtExe: i } = GE(r, A), o = [];
    for (let s = 0; s < e.length; s++) {
      let I = e[s], E = /^".*"$/.test(I) ? I.slice(1, -1) : I, B = LE.join(E, r), h = !E && /^\.[\\\/]/.test(r) ? r.slice(0, 2) + B : B;
      for (let u = 0; u < t.length; u++) {
        let f = h + t[u];
        try {
          if (YE.sync(f, { pathExt: i }))
            if (A.all)
              o.push(f);
            else
              return f;
...
var OE = j((fk, Rs) => {
  ...
  Rs.exports = PE;
  Rs.exports.default = PE;
});

// ../node_modules/cross-spawn/lib/util/resolveCommand.js
var jE = j((dk, HE) => {
  "use strict";
  var _E = require("path"), dw = xE(), pw = OE();
  function TE(r, A) {
    ...
    try {
      s = dw.sync(r.command, {
        path: e[pw({ env: e })],
        pathExt: A ? _E.delimiter : void 0
      });
    } catch {
    } finally {
      o && process.chdir(t);
    }
    return s && (s = _E.resolve(i ? r.options.cwd : "", s)), s;
  }
  g(TE, "resolveCommandAttempt");
  function mw(r) {
    return TE(r) || TE(r, !0);
  }
  g(mw, "resolveCommand");
...
var qE = j((mk, Ls) => {
  ...
  var bs = /([()\][%!^"`<>&|;, *?])/g;
  function yw(r) {
    return r = r.replace(bs, "^$1"), r;
  }
  g(yw, "escapeCommand");
  function Dw(r, A) {
    return r = `${r}`, r = r.replace(/(\\*)"/g, '$1$1\\"'), r = r.replace(/(\\*)$/, "$1$1"), r = `"${r}"`, r = r.replace(bs, "^$1"), A && (r =
    r.replace(bs, "^$1")), r;
  }
  g(Dw, "escapeArgument");
  Ls.exports.command = yw;
  Ls.exports.argument = Dw;
});
...
var $E = j((Sk, ZE) => {
  "use strict";
  var Ys = require("fs"), Sw = VE();
  function Fw(r) {
    let e = Buffer.alloc(150), t;
    try {
      t = Ys.openSync(r, "r"), Ys.readSync(t, e, 0, 150, 0), Ys.closeSync(t);
    } catch {
    }
    return Sw(e.toString());
  }
  g(Fw, "readShebang");
  ZE.exports = Fw;
});
...
var rc = j((Nk, tc) => {
  "use strict";
  var Nw = require("path"), Ac = jE(), ec = qE(), kw = $E(), Mw = process.platform === "win32", Rw = /\.(?:com|exe)$/i, bw = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;
  function Lw(r) {
    r.file = Ac(r);
    let A = r.file && kw(r.file);
    return A ? (r.args.unshift(r.file), r.command = A, Ac(r)) : r.file;
  }
  g(Lw, "detectShebang");
  function Yw(r) {
    if (!Mw)
      return r;
    let A = Lw(r), e = !Rw.test(A);
    if (r.options.forceShell || e) {
      let t = bw.test(A);
      r.command = Nw.normalize(r.command), r.command = ec.command(r.command), r.args = r.args.map((o) => ec.argument(o, t));
...
var gc = j((Mk, oc) => {
  ...
  function ic(r, A) {
    return Us && r === 1 && !A.file ? Gs(A.original, "spawn") : null;
  }
  g(ic, "verifyENOENT");
  function Jw(r, A) {
    return Us && r === 1 && !A.file ? Gs(A.original, "spawnSync") : null;
  }
...
var xs = j((bk, Vt) => {
  "use strict";
  var sc = require("child_process"), Js = rc(), vs = gc();
  function nc(r, A, e) {
    let t = Js(r, A, e), i = sc.spawn(t.command, t.args, t.options);
    return vs.hookChildProcess(i, t), i;
  }
  g(nc, "spawn");
  function vw(r, A, e) {
    let t = Js(r, A, e), i = sc.spawnSync(t.command, t.args, t.options);
    return i.error = i.error || vs.verifyENOENTSync(i.status, t), i;
  }
  g(vw, "spawnSync");
  Vt.exports = nc;
  Vt.exports.spawn = nc;
  Vt.exports.sync = vw;
  Vt.exports._parse = Js;
  Vt.exports._enoent = vs;
});

// ../node_modules/merge-stream/index.js
var Pc = j((XM, xc) => {
  "use strict";
  var { PassThrough: Nd } = require("stream");
  xc.exports = function() {
    var r = [], A = new Nd({ objectMode: !0 });
...
function $r(r) {
  return this instanceof $r ? (this.v = r, this) : new $r(r);
}
function gp(r, A, e) {
  ...
  function E(f) {
    f.value instanceof $r ? Promise.resolve(f.value.v).then(B, h) : u(o[0][2], f);
  }
  function B(f) {
    I("next", f);
  }
...
function sp(r) {
  ...
  function t(i, o) {
    A[i] = r[i] ? function(s) {
      return (e = !e) ? { value: $r(r[i](s)), done: i === "return" } : o ? o(s) : s;
    } : o;
  }
}
function np(r) {
  ...
  return A ? A.call(r) : (r = typeof fn == "function" ? fn(r) : r[Symbol.iterator](), e = {}, t("next"), t("throw"), t("return"), e[Symbol.asyncIterator] =
  function() {
    return this;
  }, e);
  function t(o) {
...
var ln, un, fe = wC(() => {
  ...
  g(Wd, "__extends");
  un = /* @__PURE__ */ g(function() {
    return un = Object.assign || /* @__PURE__ */ g(function(A) {
      for (var e, t = 1, i = arguments.length; t < i; t++) {
        e = arguments[t];
        for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (A[o] = e[o]);
      }
      return A;
    }, "__assign"), un.apply(this, arguments);
  }, "__assign");
  g(Xd, "__rest");
  g(Vd, "__decorate");
  g(Zd, "__param");
...
var Lo = j((uA) => {
  ...
  var Bp = (fe(), te(ue)), LB = Bp.__importStar(require("util")), mA = Ai();
  ...
  uA.BigIntStatsEntry = bo;
  function YB() {
    return new Ro();
  }
  g(YB, "makeDefaultStats");
  uA.makeDefaultStats = YB;
  function Qp() {
    return UB(YB());
  }
  g(Qp, "makeEmptyStats");
  uA.makeEmptyStats = Qp;
  function UB(r) {
    for (let A in r)
      if (Object.prototype.hasOwnProperty.call(r, A)) {
        let e = r[A];
        typeof e == "number" ? r[A] = 0 : typeof e == "bigint" ? r[A] = BigInt(0) : LB.types.isDate(e) && (r[A] = /* @__PURE__ */ new Date(0));
      }
    return r;
  }
  g(UB, "clearStats");
  ...
  function hp(r) {
    ...
    for (let e in r)
      if (Object.prototype.hasOwnProperty.call(r, e)) {
        let t = r[e];
        typeof t == "number" ? A[e] = BigInt(t) : LB.types.isDate(t) && (A[e] = new Date(t));
      }
  ...
  g(hp, "convertToBigIntStats");
  uA.convertToBigIntStats = hp;
  function lp(r, A) {
...
var OA = j((aA) => {
  ...
  var up = (fe(), te(ue)), Yo = up.__importDefault(require("path")), GB;
  (function(r) {
  ...
  aA.npath = Object.create(Yo.default);
  aA.ppath = Object.create(Yo.default.posix);
  aA.npath.cwd = () => process.cwd();
  aA.ppath.cwd = () => dn(process.cwd());
  aA.ppath.resolve = (...r) => r.length > 0 && aA.ppath.isAbsolute(r[0]) ? Yo.default.posix.resolve(...r) : Yo.default.posix.resolve(aA.ppath.
  cwd(), ...r);
  var JB = /* @__PURE__ */ g(function(r, A, e) {
    return A = r.normalize(A), e = r.normalize(e), A === e ? "." : (A.endsWith(r.sep) || (A = A + r.sep), e.startsWith(A) ? e.slice(A.length) :
    null);
  }, "contains");
  aA.npath.fromPortablePath = vB;
  aA.npath.toPortablePath = dn;
  aA.npath.contains = (r, A) => JB(aA.npath, r, A);
  aA.ppath.contains = (r, A) => JB(aA.ppath, r, A);
  var fp = /^([a-zA-Z]:.*)$/, wp = /^\/\/(\.\/)?(.*)$/, dp = /^\/([a-zA-Z]:.*)$/, pp = /^\/unc\/(\.dot\/)?(.*)$/;
  function vB(r) {
    ...
    if (A = r.match(dp))
      r = A[1];
    else if (e = r.match(pp))
      r = `\\\\${e[1] ? ".\\" : ""}${e[2]}`;
    else
      return r;
    return r.replace(/\//g, "\\");
  }
  g(vB, "fromPortablePath");
  function dn(r) {
    if (process.platform !== "win32")
      return r;
    r = r.replace(/\\/g, "/");
    let A, e;
    return (A = r.match(fp)) ? r = `/${A[1]}` : (e = r.match(wp)) && (r = `/unc/${e[1] ? ".dot/" : ""}${e[2]}`), r;
  }
  g(dn, "toPortablePath");
  function mp(r, A) {
    return r === aA.npath ? vB(A) : dn(A);
  }
  g(mp, "convertPath");
  aA.convertPath = mp;
  function yp(r) {
...
var Kn = j((wt) => {
  ...
  var xB = (fe(), te(ue)), mn = xB.__importDefault(require("fs")), Dp = xB.__importStar(Ai()), Kp = OA(), Uo = new Date(Dp.SAFE_TIME * 1e3),
  PB;
  (function(r) {
    r.Allow = "allow", r.ReadOnly = "readOnly";
  })(PB = wt.LinkStrategy || (wt.LinkStrategy = {}));
  async function Sp(r, A, e, t, i) {
    let o = r.pathUtils.normalize(A), s = e.pathUtils.normalize(t), I = [], E = [], { atime: B, mtime: h } = i.stableTime ? { atime: Uo, mtime: Uo } :
    ...
    await yn(I, E, u, r, o, e, s, { ...i, didParentExist: !0 });
    for (let f of I)
      await f();
  ...
  g(Sp, "copyPromise");
  wt.copyPromise = Sp;
  async function yn(r, A, e, t, i, o, s, I) {
    var E, B;
    let h = I.didParentExist ? await Fp(t, i) : null, u = await o.lstatPromise(s), { atime: f, mtime: p } = I.stableTime ? { atime: Uo, mtime: Uo } :
    u, m;
    switch (!0) {
      case u.isDirectory():
        m = await Np(r, A, e, t, i, h, o, s, u, I);
        break;
      case u.isFile():
        m = await Mp(r, A, e, t, i, h, o, s, u, I);
        break;
      case u.isSymbolicLink():
        m = await Rp(r, A, e, t, i, h, o, s, u, I);
        break;
      default:
  ...
  g(Fp, "maybeLStat");
  async function Np(r, A, e, t, i, o, s, I, E, B) {
    ...
    if (B.stableSort)
      for (let p of u.sort())
        await yn(r, A, e, t, t.pathUtils.join(i, p), s, s.pathUtils.join(I, p), f) && (h = !0);
    else
      (await Promise.all(u.map(async (m) => {
        await yn(r, A, e, t, t.pathUtils.join(i, m), s, s.pathUtils.join(I, m), f);
      }))).some((m) => m) && (h = !0);
    return h;
  }
  g(Np, "copyFolder");
  var pn = /* @__PURE__ */ new WeakMap();
  function Dn(r, A, e, t, i) {
    return async () => {
      await r.linkPromise(e, A), i === PB.ReadOnly && (t.mode &= -147, await r.chmodPromise(A, t.mode));
    };
  }
  g(Dn, "makeLinkOperation");
  function kp(r, A, e, t, i) {
    let o = pn.get(r);
    return typeof o > "u" ? async () => {
      try {
        await r.copyFilePromise(e, A, mn.default.constants.COPYFILE_FICLONE_FORCE), pn.set(r, !0);
      } catch (s) {
        if (s.code === "ENOSYS" || s.code === "ENOTSUP")
          pn.set(r, !1), await Dn(r, A, e, t, i)();
        else
          throw s;
      }
    } : o ? async () => r.copyFilePromise(e, A, mn.default.constants.COPYFILE_FICLONE_FORCE) : Dn(r, A, e, t, i);
  }
  g(kp, "makeCloneLinkOperation");
  async function Mp(r, A, e, t, i, o, s, I, E, B) {
    var h;
    if (o !== null)
      if (B.overwrite)
        r.push(async () => t.removePromise(i)), o = null;
        ...
        return !1;
    let u = (h = B.linkStrategy) !== null && h !== void 0 ? h : null, f = t === s ? u !== null ? kp(t, i, I, E, u) : async () => t.copyFilePromise(
    I, i, mn.default.constants.COPYFILE_FICLONE) : u !== null ? Dn(t, i, I, E, u) : async () => t.writeFilePromise(i, await s.readFilePromise(
    I));
    return r.push(async () => f()), !0;
  }
  g(Mp, "copyFile");
  async function Rp(r, A, e, t, i, o, s, I, E, B) {
    if (o !== null)
      if (B.overwrite)
        r.push(async () => t.removePromise(i)), o = null;
      else
...
var Fn = j((tr) => {
  ...
  var Hp = (fe(), te(ue)), jp = Hp.__importStar(ei()), Go = class {
    static {
      g(this, "CustomDir");
    }
    constructor(A, e, t = {}) {
...
var rt = j((tt) => {
  ...
  var zp = require("os"), Wp = Kn(), OB = OA(), Jo = class {
    static {
      g(this, "FakeFS");
    }
    constructor(A) {
    ...
    async copyPromise(A, e, { baseFs: t = this, overwrite: i = !0, stableSort: o = !1, stableTime: s = !1, linkStrategy: I = null } = {}) {
      return await (0, Wp.copyPromise)(this, A, t, e, { overwrite: i, stableSort: o, stableTime: s, linkStrategy: I });
    }
    copySync(A, e, { baseFs: t = this, overwrite: i = !0 } = {}) {
      ...
      if (o.isDirectory()) {
        ...
        if (!s || i) {
          ...
          this.symlinkSync((0, OB.convertPath)(this.pathUtils, E), A);
        }
      } else
...
`;
  ...
  g(kn, "normalizeLineEndings");
  tt.normalizeLineEndings = kn;
});
...
var it = j((vo) => {
  ...
  vo.NodeFS = void 0;
  var Vp = (fe(), te(ue)), Zp = Vp.__importDefault(require("fs")), $p = rt(), _B = ei(), L = OA(), Mn = class extends $p.BasePortableFakeFS {
    static {
      g(this, "NodeFS");
    }
    constructor(A = Zp.default) {
    ...
    async lutimesPromiseImpl(A, e, t) {
      ...
      if (typeof i > "u")
        throw (0, _B.ENOSYS)("unavailable Node binding", `lutimes '${A}'`);
...
var TB = j((ne) => {
  ...
  var Am = (fe(), te(ue)), em = require("events"), xo = Am.__importStar(Lo()), rr;
  (function(r) {
    r.Change = "change", r.Stop = "stop";
  })(rr = ne.Event || (ne.Event = {}));
  var ir;
  (function(r) {
    r.Ready = "ready", r.Running = "running", r.Stopped = "stopped";
  })(ir = ne.Status || (ne.Status = {}));
  function Rn(r, A) {
    if (r !== A)
  ...
  g(Rn, "assertStatus");
  ne.assertStatus = Rn;
  var bn = class r extends em.EventEmitter {
    static {
    ...
    start() {
      Rn(this.status, ir.Ready), this.status = ir.Running, this.startTimeout = setTimeout(() => {
        this.startTimeout = null, this.fakeFs.existsSync(this.path) || this.emit(rr.Change, this.lastStats, this.lastStats);
      }, 3);
    }
    stop() {
      Rn(this.status, ir.Running), this.status = ir.Stopped, this.startTimeout !== null && (clearTimeout(this.startTimeout), this.startTimeout =
    ...
    stat() {
      try {
        ...
        let e = this.bigint ? new xo.BigIntStatsEntry() : new xo.StatEntry();
        return xo.clearStats(e);
      }
    }
    /**
    ...
    makeInterval(A) {
      let e = setInterval(() => {
        ...
        xo.areStatsEqual(t, i) || (this.lastStats = t, this.emit(rr.Change, t, i));
      }, A.interval);
...
var Ln = j((ot) => {
  ...
  var tm = TB(), Po = /* @__PURE__ */ new WeakMap();
  function rm(r, A, e, t) {
    let i, o, s, I;
    switch (typeof e) {
      case "function":
    ...
    let E = Po.get(r);
    typeof E > "u" && Po.set(r, E = /* @__PURE__ */ new Map());
    let B = E.get(A);
    return typeof B > "u" && (B = tm.CustomStatWatcher.create(r, A, { bigint: i }), E.set(A, B)), B.registerChangeListener(I, { persistent: o,
    interval: s }), B;
  }
  g(rm, "watchFile");
  ot.watchFile = rm;
  ...
  g(im, "unwatchAllFiles");
  ot.unwatchAllFiles = im;
});
...
var _o = j((Oe) => {
  ...
  var Gn = (fe(), te(ue)), ti = require("fs"), jB = require("stream"), om = require("util"), qB = Gn.__importDefault(require("zlib")), gm = rt(),
  sm = it(), nm = Fn(), Yn = Ln(), Pe = Ai(), q = Gn.__importStar(ei()), nA = OA(), dt = Gn.__importStar(Lo());
  ...
  g(Oo, "makeEmptyArchive");
  Oe.makeEmptyArchive = Oo;
  var Un = class extends gm.BasePortableFakeFS {
    static {
      g(this, "ZipFS");
    }
    constructor(A, e) {
      ...
      libzip;
      let t = e;
      if (this.level = typeof t.level < "u" ? t.level : Oe.DEFAULT_COMPRESSION_LEVEL, A ?? (A = Oo()), typeof A == "string") {
        let { baseFs: s = new sm.NodeFS() } = t;
    ...
    getBufferAndClose() {
      ...
      if (this.entries.size === 0)
        return this.discardAndClose(), Oo();
      try {
    ...
    saveAndClose() {
      ...
      if (this.entries.size === 0)
        this.discardAndClose(), this.baseFs.writeFileSync(this.path, Oo(), { mode: A });
      else {
    ...
    opendirSync(A, e = {}) {
      ...
      return (0, nm.opendir)(this, t, o, { onClose: I });
    }
    ...
    createReadStream(A, { encoding: e } = {}) {
      ...
      let t = this.openSync(A, "r"), i = Object.assign(new jB.PassThrough({
        emitClose: !0,
        autoDestroy: !0,
    ...
    createWriteStream(A, { encoding: e } = {}) {
      ...
      if (A === null)
        throw new Error("Unimplemented");
      let t = [], i = this.openSync(A, "w"), o = Object.assign(new jB.PassThrough({
        autoDestroy: !0,
        emitClose: !0,
        destroy: /* @__PURE__ */ g((s, I) => {
          try {
    ...
    accessSync(A, e = ti.constants.F_OK) {
      let t = this.resolveFilename(`access '${A}'`, A);
      if (!this.entries.has(t) && !this.listings.has(t))
        throw q.ENOENT(`access '${A}'`);
      if (this.readOnly && e & ti.constants.W_OK)
        ...
        try {
          ...
          if (e.asyncDecompress)
            return new Promise((p, m) => {
              qB.default.inflateRaw(f, (D, U) => {
                D ? m(D) : (this.fileSources.set(A, U), p(U));
              });
            });
          {
            let p = qB.default.inflateRawSync(f);
    ...
    prepareCopyFile(A, e, t = 0) {
      ...
      if (t & ti.constants.COPYFILE_FICLONE_FORCE)
      ...
      if (t & (ti.constants.COPYFILE_EXCL | ti.constants.COPYFILE_FICLONE_FORCE) && typeof I < "u")
...
a", ...t }), this.writeFileSync(A, e, t);
    ...
    watchFile(A, e, t) {
      ...
      return (0, Yn.watchFile)(this, i, e, t);
    }
    unwatchFile(A, e) {
      let t = nA.ppath.resolve(nA.PortablePath.root, A);
      return (0, Yn.unwatchFile)(this, t, e);
    }
  };
  Oe.ZipFS = Un;
});
...
var _e = j((To) => {
  ...
  To.ProxiedFS = void 0;
  var Im = rt(), Jn = class extends Im.FakeFS {
    static {
      g(this, "ProxiedFS");
    }
    getExtractHint(A) {
...
var zB = j((Ho) => {
  ...
  Ho.AliasFS = void 0;
  var am = _e(), vn = class extends am.ProxiedFS {
    static {
      g(this, "AliasFS");
    }
...
var WB = j((jo) => {
  ...
  jo.CwdFS = void 0;
  var Em = it(), cm = _e(), xn = OA(), Pn = class extends cm.ProxiedFS {
    static {
      g(this, "CwdFS");
    }
    constructor(A, { baseFs: e = new Em.NodeFS() } = {}) {
      super(xn.ppath), this.target = this.pathUtils.normalize(A), this.baseFs = e;
    }
    getRealPath() {
      return this.pathUtils.resolve(this.baseFs.getRealPath(), this.target);
    }
    resolve(A) {
      return this.pathUtils.isAbsolute(A) ? xn.ppath.normalize(A) : this.baseFs.resolve(xn.ppath.join(this.target, A));
    }
    mapFromBase(A) {
      return A;
    }
...
var VB = j((zo) => {
  ...
  zo.JailFS = void 0;
  var Bm = it(), Qm = _e(), qo = OA(), XB = qo.PortablePath.root, On = class extends Qm.ProxiedFS {
    static {
      g(this, "JailFS");
    }
    constructor(A, { baseFs: e = new Bm.NodeFS() } = {}) {
      super(qo.ppath), this.target = this.pathUtils.resolve(qo.PortablePath.root, A), this.baseFs = e;
    }
    getRealPath() {
      return this.pathUtils.resolve(this.baseFs.getRealPath(), this.pathUtils.relative(qo.PortablePath.root, this.target));
    }
    getTarget() {
      return this.target;
    }
    ...
    mapToBase(A) {
      ...
      if (this.pathUtils.isAbsolute(A))
        return this.pathUtils.resolve(this.target, this.pathUtils.relative(XB, A));
      if (e.match(/^\.\.\/?/))
        throw new Error(`Resolving this path (${A}) would escape the jail`);
      return this.pathUtils.resolve(this.target, A);
    }
    mapFromBase(A) {
      return this.pathUtils.resolve(XB, this.pathUtils.relative(this.target, A));
    }
  };
  zo.JailFS = On;
});
...
var ZB = j((Wo) => {
  ...
  Wo.LazyFS = void 0;
  var hm = _e(), _n = class extends hm.ProxiedFS {
    static {
      g(this, "LazyFS");
    }
    constructor(A, e) {
...
var $B = j((Xo) => {
  ...
  Xo.NoFS = void 0;
  var lm = rt(), um = OA(), G = /* @__PURE__ */ g(() => Object.assign(new Error("ENOSYS: unsupported filesystem access"), { code: "ENOSYS" }),
  "makeError"), ri = class extends lm.FakeFS {
    static {
      g(this, "NoFS");
    }
    constructor() {
...
var AQ = j((Vo) => {
  ...
  Object.defineProperty(Vo, "__esModule", { value: !0 });
  Vo.PosixFS = void 0;
  var fm = _e(), Tn = OA(), Hn = class extends fm.ProxiedFS {
    static {
      g(this, "PosixFS");
    }
    constructor(A) {
      super(Tn.npath), this.baseFs = A;
    }
    mapFromBase(A) {
      return Tn.npath.fromPortablePath(A);
    }
    mapToBase(A) {
      return Tn.npath.toPortablePath(A);
    }
  };
  Vo.PosixFS = Hn;
});
...
var eQ = j((Zo) => {
  ...
  Object.defineProperty(Zo, "__esModule", { value: !0 });
  Zo.VirtualFS = void 0;
  var wm = it(), dm = _e(), we = OA(), pm = /^[0-9]+$/, jn = /^(\/(?:[^/]+\/)*?(?:\$\$virtual|__virtual__))((?:\/((?:[^/]+-)?[a-f0-9]+)(?:\/([^/]+))?)?((?:\/.*)?))$/,
  mm = /^([^/]+-)?[a-f0-9]+$/, qn = class r extends dm.ProxiedFS {
    static {
      g(this, "VirtualFS");
    }
    ...
    constructor({ baseFs: A = new wm.NodeFS() } = {}) {
...
var tQ = j((gt) => {
  ...
  var ym = (fe(), te(ue)), $o = require("fs"), Dm = rt(), Km = it(), Ag = _o(), eg = Ln(), qA = ym.__importStar(ei()), pt = OA(), zA = 4278190080,
  _A = 704643072, Sm = /* @__PURE__ */ g((r, A) => {
    let e = r.indexOf(A);
    if (e <= 0)
      return null;
    let t = e;
  ...
  gt.getArchivePart = Sm;
  var zn = class r extends Dm.BasePortableFakeFS {
    static {
      g(this, "ZipOpenFS");
    }
    ...
    saveAndClose() {
      if ((0, eg.unwatchAllFiles)(this), this.zipInstances)
    ...
    async copyFilePromise(A, e, t = 0) {
      let i = /* @__PURE__ */ g(async (o, s, I, E) => {
        if (t & $o.constants.COPYFILE_FICLONE_FORCE)
          throw Object.assign(new Error(`EXDEV: cross-device clone not permitted, copyfile '${s}' -> ${E}'`), { code: "EXDEV" });
        if (t & $o.constants.COPYFILE_EXCL && await this.existsPromise(s))
    ...
    copyFileSync(A, e, t = 0) {
      let i = /* @__PURE__ */ g((o, s, I, E) => {
        if (t & $o.constants.COPYFILE_FICLONE_FORCE)
          throw Object.assign(new Error(`EXDEV: cross-device clone not permitted, copyfile '${s}' -> ${E}'`), { code: "EXDEV" });
        if (t & $o.constants.COPYFILE_EXCL && this.existsSync(s))
          throw Object.assign(new Error(`EEXIST: file already exists, copyfile '${s}' -> '${E}'`), { code: "EEXIST" });
        let B;
        try {
          B = o.readFileSync(s);
    ...
    watchFile(A, e, t) {
      return this.makeCallSync(A, () => this.baseFs.watchFile(
        ...
        e,
        t
      ), () => (0, eg.watchFile)(this, A, e, t));
    }
    unwatchFile(A, e) {
      return this.makeCallSync(A, () => this.baseFs.unwatchFile(A, e), () => (0, eg.unwatchFile)(this, A, e));
    }
...
var iQ = j((tg) => {
  ...
  tg.NodePathFS = void 0;
  var rQ = require("url"), Fm = require("util"), Nm = _e(), km = OA(), Wn = class extends Nm.ProxiedFS {
    static {
      g(this, "NodePathFS");
    }
    constructor(A) {
      super(km.npath), this.baseFs = A;
    }
    mapFromBase(A) {
      return A;
    }
    mapToBase(A) {
      if (typeof A == "string")
        return A;
      if (A instanceof rQ.URL)
        return (0, rQ.fileURLToPath)(A);
...
https://github.com/yarnpkg/berry/issues/4942");
      ...
      throw new Error(`Unsupported path type: ${(0, Fm.inspect)(A)}`);
    }
  };
  tg.NodePathFS = Wn;
});
...
var CQ = j((og) => {
  ...
  var Mm = require("readline"), TA = Symbol("kBaseFs"), st = Symbol("kFd"), nt = Symbol("kClosePromise"), rg = Symbol("kCloseResolve"), ig = Symbol(
  "kCloseReject"), or = Symbol("kRefs"), de = Symbol("kRef"), pe = Symbol("kUnref"), Xn = class {
    static {
      g(this, "FileHandle");
    }
    constructor(A, e) {
      this[oQ] = 1, this[gQ] = void 0, this[sQ] = void 0, this[nQ] = void 0, this[TA] = e, this[st] = A;
    }
    get fd() {
      return this[st];
    }
    ...
    close() {
      ...
      if (this[or]--, this[or] === 0) {
        ...
        this[nt] = new Promise((A, e) => {
          ...
          this[nt] = void 0, this[ig] = void 0, this[rg] = void 0;
        });
      return this[nt];
    }
    [(oQ = or, gQ = nt, sQ = rg, nQ = ig, de)](A) {
      if (this[st] === -1) {
    ...
    [pe]() {
      if (this[or]--, this[or] === 0) {
        let A = this[st];
        this[st] = -1, this[TA].closePromise(A).then(this[rg], this[ig]);
      }
    }
  };
  og.FileHandle = Xn;
...
var cQ = j((gr) => {
  ...
  var ii = require("util"), Rm = iQ(), IQ = CQ(), bm = /* @__PURE__ */ new Set([
    "accessSync",
    "appendFileSync",
    "createReadStream",
    "createWriteStream",
  ...
  function EQ(r, A) {
    A = new Rm.NodePathFS(A);
    let e = /* @__PURE__ */ g((t, i, o) => {
      let s = t[i];
      t[i] = o, typeof s?.[ii.promisify.custom] < "u" && (o[ii.promisify.custom] = s[ii.promisify.custom]);
    }, "setupFn");
    {
      e(r, "exists", (t, ...i) => {
      ...
      if (typeof i < "u") {
        for (let o of aQ) {
          ...
          if (typeof i[s] > "u")
            continue;
          let I = A[o];
          typeof I > "u" || o !== "open" && e(i, s, (E, ...B) => E instanceof IQ.FileHandle ? E[s].apply(E, B) : I.call(A, E, ...B));
        }
        e(i, "open", async (...o) => {
          let s = await A.openPromise(...o);
          return new IQ.FileHandle(s, A);
        });
      }
    }
    r.read[ii.promisify.custom] = async (t, i, ...o) => ({ bytesRead: await A.readPromise(t, i, ...o), buffer: i }), r.write[ii.promisify.custom] =
...
var hQ = j((Ct) => {
  ...
  Ct.xfs = void 0;
  var Ym = (fe(), te(ue)), Um = Ym.__importDefault(require("os")), Gm = it(), oi = OA();
  function BQ(r) {
    let A = Math.ceil(Math.random() * 4294967296).toString(16).padStart(8, "0");
    return `${r}${A}`;
  }
  g(BQ, "getTempName");
  var me = /* @__PURE__ */ new Set(), Vn = null;
  function QQ() {
    if (Vn)
      return Vn;
    let r = oi.npath.toPortablePath(Um.default.tmpdir()), A = Ct.xfs.realpathSync(r);
  ...
  g(QQ, "initTmpEnv");
  Ct.xfs = Object.assign(new Gm.NodeFS(), {
    detachTemp(r) {
      me.delete(r);
    },
    mktempSync(r) {
      let { tmpdir: A, realTmpdir: e } = QQ();
      for (; ; ) {
        let t = BQ("xfs-");
        try {
          this.mkdirSync(oi.ppath.join(A, t));
        } catch (o) {
          if (o.code === "EEXIST")
            continue;
          throw o;
        }
        let i = oi.ppath.join(e, t);
    ...
    async mktempPromise(r) {
      ...
      for (; ; ) {
        let t = BQ("xfs-");
        try {
          await this.mkdirPromise(oi.ppath.join(A, t));
        } catch (o) {
          if (o.code === "EEXIST")
            continue;
          throw o;
...
var dQ = j((z) => {
  ...
  var lQ = (fe(), te(ue)), Jm = lQ.__importStar(Ai());
  z.constants = Jm;
  var vm = lQ.__importStar(Lo());
  z.statUtils = vm;
  var xm = Kn();
...
function cy(r, A, e) {
  ...
  function E(f) {
    f.value instanceof gi ? Promise.resolve(f.value.v).then(B, h) : u(o[0][2], f);
  }
  function B(f) {
    I("next", f);
  }
...
function By(r) {
  ...
  function t(i, o) {
    A[i] = r[i] ? function(s) {
      return (e = !e) ? { value: gi(r[i](s)), done: i === "return" } : o ? o(s) : s;
    } : o;
  }
}
function Qy(r) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var A = r[Symbol.asyncIterator], e;
  return A ? A.call(r) : (r = typeof eC == "function" ? eC(r) : r[Symbol.iterator](), e = {}, t("next"), t("throw"), t("return"), e[Symbol.asyncIterator] =
  function() {
    return this;
  }, e);
  function t(o) {
...
var $n, AC, yQ = wC(() => {
  ...
  g(ty, "__extends");
  AC = /* @__PURE__ */ g(function() {
    return AC = Object.assign || /* @__PURE__ */ g(function(A) {
      for (var e, t = 1, i = arguments.length; t < i; t++) {
        e = arguments[t];
        for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (A[o] = e[o]);
      }
      return A;
    }, "__assign"), AC.apply(this, arguments);
  }, "__assign");
  g(ry, "__rest");
  g(iy, "__decorate");
  g(oy, "__param");
  ...
  g(Ey, "__spreadArrays");
  g(gi, "__await");
  g(cy, "__asyncGenerator");
  g(By, "__asyncDelegator");
  g(Qy, "__asyncValues");
  g(hy, "__makeTemplateObject");
  g(ly, "__importStar");
  g(uy, "__importDefault");
  g(fy, "__classPrivateFieldGet");
  g(wy, "__classPrivateFieldSet");
});

// ../node_modules/@yarnpkg/libzip/lib/libzipSync.js
var KQ = j((gg, rC) => {
  var DQ = Object.assign({}, require("fs")), tC = function() {
    ...
    return typeof __filename < "u" && (r = r || __filename), function(A) {
      ...
      u && (h ? f = require("path").dirname(f) + "/" : f = __dirname + "/", m = /* @__PURE__ */ g(function(C, a) {
        var Q = lC(C);
        return Q ? a ? Q : Q.toString() : (U || (U = DQ), R || (R = require("path")), C = R.normalize(C), U.readFileSync(C, a ? null : "utf8"));
      ...
      function S(n, C, a, Q, l) {
        ...
        if (Q)
          for (var O = 0; O < Q.length; O++) {
            var eA = w[a[O]];
            eA ? (v === 0 && (v = Lh()), k[O] = eA(Q[O])) : k[O] = Q[O];
          }
        var W = y.apply(null, k);
        return W = d(W), v !== 0 && Yh(v), W;
      }
      g(S, "ccall");
      function kA(n, C, a, Q) {
        a = a || [];
      ...
      var Er = e.INITIAL_MEMORY || 16777216, Eg, sC = [], nC = [], CC = [], zQ = !1;
      function WQ() {
        if (e.preRun)
      ...
      g(WQ, "preRun");
      function XQ() {
        zQ = !0, !e.noFSInit && !c.init.initialized && c.init(), qe.init(), Qg(nC);
      }
      g(XQ, "initRuntime");
      function VQ() {
        if (e.postRun)
      ...
      g(Ah, "addOnPostRun");
      var Et = 0, cg = null, cr = null;
      function Py(n) {
        return n;
      }
      g(Py, "getUniqueRunDependency");
      function IC(n) {
        Et++, e.monitorRunDependencies && e.monitorRunDependencies(Et);
      }
      g(IC, "addRunDependency");
      function Bg(n) {
        if (Et--, e.monitorRunDependencies && e.monitorRunDependencies(Et), Et == 0 && (cg !== null && (clearInterval(cg), cg = null), cr)) {
          var C = cr;
          cr = null, C();
        }
      }
      g(Bg, "removeRunDependency"), e.preloadedImages = {}, e.preloadedAudios = {};
      function dA(n) {
      ...
      g(dA, "abort");
      var aC = "data:application/octet-stream;base64,";
      function EC(n) {
        return n.startsWith(aC);
      }
      g(EC, "isDataURI");
      var Br = "data:application/octet-stream;base64,AGFzbQEAAAABlAInYAF/AX9gA39/fwF/YAF/AGACf38Bf2ACf38AYAV/f39/fwF/YAR/f39/AX9gA39/fwBgBH9\
...
w90ClLKdvV0GoqnTfoFhkA0rHxDxTrq9fGAQVseNtKIarDKS/Q/DpUIE5VxZSN/////////////////////8=";
 ...
 generating HTML (but not JS)";
      ...
      function th(n, C) {
        var a, Q, l;
        try {
          l = eh(n), Q = new WebAssembly.Module(l), a = new WebAssembly.Instance(Q, C);
        } catch (d) {
          var w = d.toString();
...
OWTH to allow any size memory (and also make sure not to set INITIAL_MEMORY at runtime to something smaller than it was at compile time)."
      ...
      g(th, "instantiateSync");
      function rh() {
        var n = { a: kh };
        function C(l, w) {
          var d = l.exports;
          e.asm = d, F = e.asm.u, Kt(F.buffer), Eg = e.asm.pa, $Q(e.asm.v), Bg("wasm-instantiate");
        }
        if (g(C, "receiveInstance"), IC("wasm-instantiate"), e.instantiateWasm)
          try {
      ...
      function Qg(n) {
        for (; n.length > 0; ) {
          ...
          var a = C.func;
          typeof a == "number" ? C.arg === void 0 ? Eg.get(a)() : Eg.get(a)(C.arg) : a(C.arg === void 0 ? null : C.arg);
        }
      }
      g(Qg, "callRuntimeCallbacks");
      function Ii(n, C) {
        ...
        return N[C + 28 >> 2] = l, Ii.GMTString || (Ii.GMTString = He("GMT")), N[C + 40 >> 2] = Ii.GMTString, C;
      }
      g(Ii, "_gmtime_r");
      function ih(n, C) {
        return Ii(n, C);
...
`));
      ...
      function hg(n) {
        for (var C = V(n, 65536), a = uC(C); n < C; ) RA[a + n++] = 0;
        return a;
      }
      g(hg, "mmapAlloc");
      var $ = {
        ...
        node_ops: {
          ...
          readlink: /* @__PURE__ */ g(function(n) {
            var C = X.realPath(n);
            try {
              return C = AA.readlinkSync(C), C = QC.relative(
                QC.resolve(n.mount.opts.root),
                C
              ), C;
            } catch (a) {
              throw a.code ? new c.ErrnoError(X.convertNodeCode(a)) : a;
        ...
        msync: /* @__PURE__ */ g(function(n, C, a, Q, l) {
          return n.stream_ops ? Ft.msync(n, C, a, Q, l) : (l & 2 || c.write(n, C, 0, Q, a), 0);
        }, "msync"),
        ...
        writeFile: /* @__PURE__ */ g(function(n, C, a) {
          ...
          if (typeof C == "string") {
            var l = new Uint8Array(Dt(C) + 1), w = yA(C, l, 0, l.length);
...
ers. Use --embed-file or --preload-file in emcc on the main thread."
          ...
          if (m)
            try {
              n.contents = ug(m(n.url), !0), n.usedBytes = n.contents.length;
            } catch {
              throw new c.ErrnoError(29);
            }
          else
        ...
        createLazyFile: /* @__PURE__ */ g(function(n, C, a, Q, l) {
          ...
          if (g(w, "LazyUint8Array"), w.prototype.get = /* @__PURE__ */ g(function(W) {
            ...
            var _ = Number(W.getResponseHeader("Content-length")), tA, GA = (tA = W.getResponseHeader("Accept-Ranges")) && tA === "bytes", Ie = (tA =
            W.getResponseHeader("Content-Encoding")) && tA === "gzip", XA = 1024 * 1024;
            GA || (XA = _);
            var Qr = /* @__PURE__ */ g(function(ye, Nt) {
              if (ye > Nt)
                throw new Error(
                  "invalid range (" + ye + ", " + Nt + ") or no bytes requested!"
                );
              if (Nt > _ - 1)
                throw new Error(
              ...
              if (bA.open("GET", a, !1), _ !== XA && bA.setRequestHeader("Range", "bytes=" + ye + "-" + Nt), typeof Uint8Array < "u" && (bA.
              ...
              return bA.response !== void 0 ? new Uint8Array(bA.response || []) : ug(bA.responseText || "", !0);
            }, "doXHR"), JA = this;
            JA.setDataGetter(function(ye) {
              var Nt = ye * XA, bA = (ye + 1) * XA - 1;
              if (bA = Math.min(bA, _ - 1), typeof JA.chunks[ye] > "u" && (JA.chunks[ye] = Qr(Nt, bA)), typeof JA.chunks[ye] > "u")
          ...
          }), v.read = /* @__PURE__ */ g(function(W, _, tA, GA, Ie) {
            c.forceLoadFile(k);
            var XA = W.node.contents;
            if (Ie >= XA.length) return 0;
            var Qr = Math.min(XA.length - Ie, GA);
            if (XA.slice)
              for (var JA = 0; JA < Qr; JA++)
                _[tA + JA] = XA[Ie + JA];
            else
              for (var JA = 0; JA < Qr; JA++)
                _[tA + JA] = XA.get(Ie + JA);
            return Qr;
        ...
        createPreloadedFile: /* @__PURE__ */ g(function(n, C, a, Q, l, w, d, y, k, v) {
          ...
          function W(_) {
            ...
            e.preloadPlugins.forEach(function(Ie) {
              GA || Ie.canHandle(O) && (Ie.handle(_, O, tA, function() {
                d && d(), Bg(eA);
              }), GA = !0);
            }), GA || tA(_);
          }
          g(W, "processData"), IC(eA), typeof a == "string" ? Browser.asyncLoad(
            a,
            function(_) {
              W(_);
            },
        ...
        doReadlink: /* @__PURE__ */ g(function(n, C, a) {
          if (a <= 0) return -28;
          var Q = c.readlink(n), l = Math.min(a, Dt(Q)), w = RA[C + l];
      ...
      g(lh, "emscripten_realloc_buffer");
      function uh(n) {
        var C = Y.length;
        n = n >>> 0;
        var a = 2147483648;
      ...
      function lg() {
        ...
        l < Q ? (N[ci() >> 2] = v, N[ci() + 4 >> 2] = O) : (N[ci() >> 2] = O, N[ci() + 4 >> 2] = v);
      }
      g(lg, "_tzset");
      function Kh(n) {
        lg();
      ...
      g(Kh, "_timegm");
      var BC = /* @__PURE__ */ g(function(n, C, a, Q) {
      ...
      }, "FSNode"), ai = 365, Ei = 146;
      if (Object.defineProperties(BC.prototype, {
        read: {
          get: /* @__PURE__ */ g(function() {
            return (this.mode & ai) === ai;
          }, "get"),
          set: /* @__PURE__ */ g(function(n) {
            n ? this.mode |= ai : this.mode &= ~ai;
          }, "set")
        },
        write: {
          get: /* @__PURE__ */ g(function() {
      ...
      }), c.FSNode = BC, c.staticInit(), u) {
        var AA = DQ, QC = require("path");
        X.staticInit();
      }
      if (u) {
        var Sh = /* @__PURE__ */ g(function(n) {
          return function() {
            try {
        ...
        for (var hC in cC) c[hC] = Sh(cC[hC]);
      } else
        throw new Error(
          "NODERAWFS is currently only supported on Node.js environment."
        );
      function ug(n, C, a) {
        var Q = a > 0 ? a : Dt(n) + 1, l = new Array(Q), w = yA(
          n,
          l,
          0,
          l.length
      ...
      g(ug, "intArrayFromString");
      var Fh = typeof atob == "function" ? atob : function(n) {
      ...
      function Nh(n) {
        ...
        try {
          for (var a = Fh(n), Q = new Uint8Array(a.length), l = 0; l < a.length; ++l)
            Q[l] = a.charCodeAt(l);
          return Q;
        } catch {
      ...
      g(Nh, "intArrayFromBase64");
      function lC(n) {
        if (EC(n))
          return Nh(n.slice(aC.length));
      }
      g(lC, "tryParseAsDataURI");
      var kh = {
        s: ih,
        p: gh,
        e: nh,
        ...
        b: Dh,
        t: Kh
      }, H = rh(), Oy = e.___wasm_call_ctors = H.v, _y = e._zip_ext_count_symlinks = H.w, Ty = e._zip_file_get_external_attributes = H.x, Hy = e.
      _zipstruct_stat = H.y, jy = e._zipstruct_statS = H.z, qy = e._zipstruct_stat_name = H.A, zy = e._zipstruct_stat_index = H.B, Wy = e._zipstruct_stat_size =
      H.C, Xy = e._zipstruct_stat_mtime = H.D, Vy = e._zipstruct_stat_crc = H.E, Zy = e._zipstruct_error = H.F, $y = e._zipstruct_errorS = H.
      G, AD = e._zipstruct_error_code_zip = H.H, eD = e._zipstruct_stat_comp_size = H.I, tD = e._zipstruct_stat_comp_method = H.J, rD = e._zip_close =
      H.K, iD = e._zip_delete = H.L, oD = e._zip_dir_add = H.M, gD = e._zip_discard = H.N, sD = e._zip_error_init_with_code = H.O, nD = e._zip_get_error =
      H.P, CD = e._zip_file_get_error = H.Q, ID = e._zip_error_strerror = H.R, aD = e._zip_fclose = H.S, ED = e._zip_file_add = H.T, cD = e.
      _free = H.U, uC = e._malloc = H.V, Mh = e.___errno_location = H.W, BD = e._zip_source_error = H.X, QD = e._zip_source_seek = H.Y, hD = e.
      _zip_file_set_external_attributes = H.Z, lD = e._zip_file_set_mtime = H._, uD = e._zip_fopen = H.$, fD = e._zip_fopen_index = H.aa, wD = e.
      _zip_fread = H.ba, dD = e._zip_get_name = H.ca, pD = e._zip_get_num_entries = H.da, mD = e._zip_source_read = H.ea, yD = e._zip_name_locate =
      H.fa, DD = e._zip_open = H.ga, KD = e._zip_open_from_source = H.ha, SD = e._zip_set_file_compression = H.ia, FD = e._zip_source_buffer =
      H.ja, ND = e._zip_source_buffer_create = H.ka, kD = e._zip_source_close = H.la, MD = e._zip_source_free = H.ma, RD = e._zip_source_keep =
      H.na, bD = e._zip_source_open = H.oa, LD = e._zip_source_set_mtime = H.qa, YD = e._zip_source_tell = H.ra, UD = e._zip_stat = H.sa, GD = e.
      _zip_stat_index = H.ta, ci = e.__get_tzname = H.ua, Rh = e.__get_daylight = H.va, bh = e.__get_timezone = H.wa, Lh = e.stackSave = H.xa,
      Yh = e.stackRestore = H.ya, fC = e.stackAlloc = H.za;
      e.cwrap = kA, e.getValue = hA;
      var Bi;
      cr = /* @__PURE__ */ g(function n() {
        Bi || fg(), Bi || (cr = n);
      }, "runCaller");
      function fg(n) {
        if (n = n || I, Et > 0 || (WQ(), Et > 0))
          return;
        function C() {
          Bi || (Bi = !0, e.calledRun = !0, !cA && (XQ(), t(e), e.onRuntimeInitialized && e.onRuntimeInitialized(), VQ()));
        }
      ...
      if (g(fg, "run"), e.run = fg, e.preInit)
        for (typeof e.preInit == "function" && (e.preInit = [e.preInit]); e.preInit.length > 0; )
          e.preInit.pop()();
      return fg(), A;
    };
  }();
  typeof gg == "object" && typeof rC == "object" ? rC.exports = tC : typeof define == "function" && define.amd ? define([], function() {
    return tC;
  }) : typeof gg == "object" && (gg.createModule = tC);
});
...
var kQ = j((sr) => {
  ...
  var py = (yQ(), te(mQ)), my = py.__importDefault(KQ()), yy = FQ(), iC = null;
  function NQ() {
    return iC === null && (iC = (0, yy.makeInterface)((0, my.default)())), iC;
  }
  g(NQ, "getLibzipSync");
  sr.getLibzipSync = NQ;
  async function Dy() {
  ...
  g(Dy, "getLibzipPromise");
  sr.getLibzipPromise = Dy;
});
...
wg(xy, {
  ...
  codeLog: () => nw,
  commandLog: () => gw,
  commonGlobOptions: () => cf,
  createFileSystemCache: () => xi,
  createLogStream: () => he,
  extractProperFrameworkName: () => Qs,
  extractProperRendererNameFromFramework: () => hf,
  filterPresetsConfig: () => UI,
  findConfigFile: () => Hi,
  formatFileContent: () => Gy,
  frameworkPackages: () => ht,
  frameworkToRenderer: () => cs,
  getAutoRefs: () => Pa,
  getBuilderOptions: () => Bf,
  getChars: () => ks,
  getCoercedStorybookVersion: () => Yu,
  getConfigInfo: () => Ea,
  getDirectoryFromWorkingDir: () => fE,
  getEnvConfig: () => Uu,
  getFrameworkName: () => Bs,
  getInterpretedFile: () => ct,
  getInterpretedFileWithExt: () => pg,
  getPackageDetails: () => Qn,
  getPresets: () => xI,
  getPreviewBodyTemplate: () => Ry,
  getPreviewHeadTemplate: () => by,
  getProjectRoot: () => sf,
  getRefs: () => ff,
  getRendererName: () => Qf,
  getStoryId: () => vy,
  getStoryTitle: () => qQ,
  getStorybookConfiguration: () => is,
  getStorybookInfo: () => os,
  globToRegexp: () => Fs,
  interopRequireDefault: () => hi,
  interpolate: () => $f,
  isCorePackage: () => Gu,
  isPreservingSymlinks: () => My,
  loadAllPresets: () => nu,
  loadCustomPresets: () => _g,
  loadEnvs: () => Cf,
  loadMainConfig: () => Aw,
  loadManagerOrAddonsFile: () => ew,
  loadPreset: () => JI,
  loadPreviewOrConfigFile: () => tw,
  logConfig: () => Cw,
  nodePathsToArray: () => as,
  normalizeStories: () => Ew,
  normalizeStoriesEntry: () => wE,
  normalizeStoryPath: () => Es,
  paddedLog: () => sw,
  parseList: () => Lu,
  posix: () => gC,
  readTemplate: () => cw,
  ...
  rendererPackages: () => ji,
  resolveAddonName: () => GI,
  resolvePathInStorybookCache: () => ts,
  satisfies: () => Uy,
  serverRequire: () => kt,
  serverResolve: () => Mt,
  stringifyEnvs: () => If,
  stringifyProcessEnvs: () => af,
  stripAbsNodeModulesPath: () => qg,
  temporaryDirectory: () => Qa,
  temporaryFile: () => ha,
  validateConfigurationFiles: () => Lr,
  validateFrameworkName: () => Yy,
  versions: () => ze
});
module.exports = te(xy);
...
var Tt = require("node:path"), _t = require("@storybook/core/node-logger"), LI = require("@storybook/core/server-errors"), YI = J(HA(), 1);

// src/common/utils/interpret-files.ts
var dg = require("node:fs");
var Qi = /* @__PURE__ */ new Set([".js", ".jsx", ".ts", ".tsx", ".cts", ".mts", ".cjs", ".mjs"]);
function Ph() {
  return [...Array.from(Qi)];
}
g(Ph, "sortExtensions");
var mC = Ph();
function ct(r) {
  return mC.map((A) => r.endsWith(A) ? r : `${r}${A}`).find((A) => (0, dg.existsSync)(A));
}
g(ct, "getInterpretedFile");
function pg(r) {
  return mC.map((A) => ({ path: r.endsWith(A) ? r : `${r}${A}`, ext: A })).find((A) => (0, dg.existsSync)(A.path));
}
g(pg, "getInterpretedFileWithExt");
...
g(kt, "serverRequire");
function Mt(r) {
  let A = Array.isArray(r) ? r : [r], e = Oh(A);
  return e ? e.path : null;
}
g(Mt, "serverResolve");

// src/common/utils/load-custom-presets.ts
var Gi = require("node:path");

// src/common/utils/validate-configuration-files.ts
var Og = require("node:path"), yI = require("@storybook/core/node-logger"), DI = require("@storybook/core/server-errors");
...
var Xh = {
  ...
  "[:xdigit:]": ["A-Fa-f0-9", !1]
}, wr = /* @__PURE__ */ g((r) => r.replace(/[[\]\\-]/g, "\\$&"), "braceEscape"), Vh = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,
"\\$&"), "regexpEscape"), JC = /* @__PURE__ */ g((r) => r.join(""), "rangesToString"), vC = /* @__PURE__ */ g((r, A) => {
  let e = A;
  if (r.charAt(e) !== "[")
...
var Zh = /* @__PURE__ */ new Set(["!", "?", "+", "*", "@"]), xC = /* @__PURE__ */ g((r) => Zh.has(r), "isExtglobType"), $h = "(?!(?:^|/)\\.\\.\
?(?:$|/))", li = "(?!\\.)", Al = /* @__PURE__ */ new Set(["[", "."]), el = /* @__PURE__ */ new Set(["..", "."]), tl = new Set("().*{}+?[]^$\\\
!"), rl = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "regExpEscape"), Dg = "[^/]", PC = Dg + "*?", OC = Dg + "+\
?", Rt = class r {
  static {
    g(this, "AST");
  }
  ...
  toRegExpSource(A) {
    ...
    if (this.#A === this && this.#l(), !this.type) {
      ...
      if (this.isStart() && typeof this.#r[0] == "string" && !(this.#r.length === 1 && el.has(this.#r[0]))) {
        let m = Al, D = (
    ...
    let s = !t || A || e || !li ? "" : this.#B(!0);
    s === o && (s = ""), s && (o = `(?:${o})(?:${s})*?`);
    let I = "";
    if (this.type === "!" && this.#o)
      I = (this.isStart() && !e ? li : "") + OC;
    else {
      let E = this.type === "!" ? (
        // !() must match something,but !(x) can match ''
        "))" + (this.isStart() && !e && !A ? li : "") + PC + ")"
...
// ../node_modules/glob/node_modules/minimatch/dist/esm/index.js
var vA = /* @__PURE__ */ g((r, A, e = {}) => (fr(A), !e.nocomment && A.charAt(0) === "#" ? !1 : new VA(A, e).match(r)), "minimatch"), il = /^\*+([^+@!?\*\[\(]*)$/,
ol = /* @__PURE__ */ g((r) => (A) => !A.startsWith(".") && A.endsWith(r), "starDotExtTest"), gl = /* @__PURE__ */ g((r) => (A) => A.endsWith(
r), "starDotExtTestDot"), sl = /* @__PURE__ */ g((r) => (r = r.toLowerCase(), (A) => !A.startsWith(".") && A.toLowerCase().endsWith(r)), "st\
arDotExtTestNocase"), nl = /* @__PURE__ */ g((r) => (r = r.toLowerCase(), (A) => A.toLowerCase().endsWith(r)), "starDotExtTestNocaseDot"), Cl = /^\*+\.\*+$/,
Il = /* @__PURE__ */ g((r) => !r.startsWith(".") && r.includes("."), "starDotStarTest"), al = /* @__PURE__ */ g((r) => r !== "." && r !== ".\
." && r.includes("."), "starDotStarTestDot"), El = /^\.\*+$/, cl = /* @__PURE__ */ g((r) => r !== "." && r !== ".." && r.startsWith("."), "d\
otStarTest"), Bl = /^\*+$/, Ql = /* @__PURE__ */ g((r) => r.length !== 0 && !r.startsWith("."), "starTest"), hl = /* @__PURE__ */ g((r) => r.
length !== 0 && r !== "." && r !== "..", "starTestDot"), ll = /^\?+([^+@!?\*\[\(]*)?$/, ul = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = jC([r]);
  return A ? (A = A.toLowerCase(), (t) => e(t) && t.toLowerCase().endsWith(A)) : e;
}, "qmarksTestNocase"), fl = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = qC([r]);
  return A ? (A = A.toLowerCase(), (t) => e(t) && t.toLowerCase().endsWith(A)) : e;
}, "qmarksTestNocaseDot"), wl = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = qC([r]);
  return A ? (t) => e(t) && t.endsWith(A) : e;
}, "qmarksTestDot"), dl = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = jC([r]);
  return A ? (t) => e(t) && t.endsWith(A) : e;
}, "qmarksTest"), jC = /* @__PURE__ */ g(([r]) => {
  let A = r.length;
  return (e) => e.length === A && !e.startsWith(".");
}, "qmarksTestNoExt"), qC = /* @__PURE__ */ g(([r]) => {
  let A = r.length;
  return (e) => e.length === A && e !== "." && e !== "..";
}, "qmarksTestNoExtDot"), zC = typeof process == "object" && process ? typeof process.env == "object" && process.env && process.env.__MINIMATCH_TESTING_PLATFORM__ ||
process.platform : "posix", _C = {
  win32: { sep: "\\" },
  posix: { sep: "/" }
}, pl = zC === "win32" ? _C.win32.sep : _C.posix.sep;
vA.sep = pl;
var LA = Symbol("globstar **");
vA.GLOBSTAR = LA;
var ml = "[^/]", yl = ml + "*?", Dl = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?", Kl = "(?:(?!(?:\\/|^)\\.).)*?", Sl = /* @__PURE__ */ g((r, A = {}) => (e) => vA(
e, r, A), "filter");
vA.filter = Sl;
var re = /* @__PURE__ */ g((r, A = {}) => Object.assign({}, r, A), "ext"), Fl = /* @__PURE__ */ g((r) => {
...
vA.defaults = Fl;
var WC = /* @__PURE__ */ g((r, A = {}) => (fr(r), A.nobrace || !/\{(?:(?!\{).)*\}/.test(r) ? [r] : (0, HC.default)(r)), "braceExpand");
vA.braceExpand = WC;
var Nl = /* @__PURE__ */ g((r, A = {}) => new VA(r, A).makeRe(), "makeRe");
vA.makeRe = Nl;
var kl = /* @__PURE__ */ g((r, A, e = {}) => {
  let t = new VA(A, e);
  return r = r.filter((i) => t.match(i)), t.options.nonull && !r.length && r.push(A), r;
}, "match");
vA.match = kl;
var TC = /[?*]|[+@!]\(.*?\)|\[|\]/, Ml = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "regExpEscape"), VA = class {
  static {
    g(this, "Minimatch");
  }
  options;
  ...
  regexp;
  constructor(A, e = {}) {
    fr(A), e = e || {}, this.options = e, this.pattern = A, this.platform = e.platform || zC, this.isWindows = this.platform === "win32", this.
  ...
  make() {
    ...
    let i = this.globParts.map((o, s, I) => {
      if (this.isWindows && this.windowsNoMagicRoot) {
        let E = o[0] === "" && o[1] === "" && (o[2] === "?" || !TC.test(o[2])) && !TC.test(o[3]), B = /^[a-z]:/i.test(o[0]);
        if (E)
...
>>> no match, partial?`, A, f, e, p), f === E));
  ...
  braceExpand() {
    return WC(this.pattern, this.options);
  }
  parse(A) {
    fr(A);
    let e = this.options;
    ...
    if (A === "")
      return "";
    let t, i = null;
    (t = A.match(Bl)) ? i = e.dot ? hl : Ql : (t = A.match(il)) ? i = (e.nocase ? e.dot ? nl : sl : e.dot ? gl : ol)(t[1]) : (t = A.match(ll)) ?
    i = (e.nocase ? e.dot ? fl : ul : e.dot ? wl : dl)(t) : (t = A.match(Cl)) ? i = e.dot ? al : Il : (t = A.match(El)) && (i = cl);
  ...
  makeRe() {
    ...
    let e = this.options, t = e.noglobstar ? yl : e.dot ? Dl : Kl, i = new Set(e.nocase ? ["i"] : []), o = A.map((E) => {
      let B = E.map((h) => {
        if (h instanceof RegExp)
          for (let u of h.flags.split(""))
            i.add(u);
        return typeof h == "string" ? Ml(h) : h === LA ? LA : h._src;
      });
...
var fI = require("node:url");

// ../node_modules/lru-cache/dist/esm/index.js
var Lt = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, VC = /* @__PURE__ */ new Set(),
Kg = typeof process == "object" && process ? process : {}, ZC = /* @__PURE__ */ g((r, A, e, t) => {
  typeof Kg.emitWarning == "function" ? Kg.emitWarning(r, A, e, t) : console.error(`[${e}] ${A}: ${r}`);
}, "emitWarning"), ui = globalThis.AbortController, XC = globalThis.AbortSignal;
if (typeof ui > "u") {
  XC = class {
    static {
      g(this, "AbortSignal");
  ...
  let r = Kg.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1", A = /* @__PURE__ */ g(() => {
    r && (r = !1, ZC("AbortController is not defined. If using lru-cache in node 14, load an AbortController polyfill from the `node-abort-c\
...
var Rl = /* @__PURE__ */ g((r) => !VC.has(r), "shouldWarn"), pK = Symbol("type"), We = /* @__PURE__ */ g((r) => r && r === Math.floor(r) && r >
0 && isFinite(r), "isPosInt"), $C = /* @__PURE__ */ g((r) => We(r) ? r <= Math.pow(2, 8) ? Uint8Array : r <= Math.pow(2, 16) ? Uint16Array :
r <= Math.pow(2, 32) ? Uint32Array : r <= Number.MAX_SAFE_INTEGER ? Yt : null : null, "getUintArray"), Yt = class extends Array {
  ...
  constructor(A) {
    ...
    this.#l = new sA(e), this.#u = new sA(e), this.#B = 0, this.#c = 0, this.#m = Sg.create(e), this.#s = 0, this.#a = 0, typeof B == "funct\
ion" && (this.#t = B), typeof h == "function" ? (this.#r = h, this.#h = []) : (this.#r = void 0, this.#h = void 0), this.#d = !!this.#t, this.#Q =
    ...
    if (!this.ttlAutopurge && !this.#A && !this.#e) {
      ...
      Rl(P) && (VC.add(P), ZC("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCac\
heWarning", P, r));
    }
  }
  /**
  ...
  #N() {
    ...
    this.#w = A, this.#D = e, this.#R = (o, s, I = Lt.now()) => {
...
ict"), this.#Q && this.#h?.push([i, t, "evict"])), this.#b(e), A && (this.#C[e] = void 0, this.#o[e] = void 0, this.#m.push(e)), this.#s ===
  ...
  #I(A) {
    if (!this.#p)
      return !1;
    let e = A;
    return !!e && e instanceof Promise && e.hasOwnProperty("__staleWhileFetching") && e.__abortController instanceof ui;
  }
  async fetch(A, e = {}) {
    let {
      // get options
...
var Jt = require("node:path"), CI = require("node:url"), Se = require("fs"), Ol = J(require("node:fs"), 1), Ze = require("node:fs/promises");

// ../node_modules/minipass/dist/esm/index.js
var Di = require("node:events"), Lg = J(require("node:stream"), 1), iI = require("node:string_decoder");
var AI = typeof process == "object" && process ? process : {
  stdout: null,
  stderr: null
}, bl = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && (r instanceof Ve || r instanceof Lg.default || Ll(r) || Yl(r)), "isStream"),
Ll = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && r instanceof Di.EventEmitter && typeof r.pipe == "function" && // node core Writable streams have a pipe() method, but it throws
r.pipe !== Lg.default.Writable.prototype.pipe, "isReadable"), Yl = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && r instanceof Di.EventEmitter &&
typeof r.write == "function" && typeof r.end == "function", "isWritable"), Le = Symbol("EOF"), Ye = Symbol("maybeEmitEnd"), Xe = Symbol("emi\
ttedEnd"), fi = Symbol("emittingEnd"), pr = Symbol("emittedError"), wi = Symbol("closed"), eI = Symbol("read"), di = Symbol("flush"), tI = Symbol(
"flushChunk"), Ee = Symbol("encoding"), Ut = Symbol("decoder"), SA = Symbol("flowing"), mr = Symbol("paused"), Gt = Symbol("resume"), FA = Symbol(
"buffer"), xA = Symbol("pipes"), NA = Symbol("bufferLength"), Fg = Symbol("bufferPush"), pi = Symbol("bufferShift"), YA = Symbol("objectMode"),
fA = Symbol("destroyed"), Ng = Symbol("error"), kg = Symbol("emitData"), rI = Symbol("emitEnd"), Mg = Symbol("emitEnd2"), De = Symbol("async"),
Rg = Symbol("abort"), mi = Symbol("aborted"), yr = Symbol("signal"), Bt = Symbol("dataListeners"), ZA = Symbol("discarded"), Dr = /* @__PURE__ */ g(
(r) => Promise.resolve().then(r), "defer"), Ul = /* @__PURE__ */ g((r) => r(), "nodefer"), Gl = /* @__PURE__ */ g((r) => r === "end" || r ===
"finish" || r === "prefinish", "isEndish"), Jl = /* @__PURE__ */ g((r) => r instanceof ArrayBuffer || !!r && typeof r == "object" && r.constructor &&
r.constructor.name === "ArrayBuffer" && r.byteLength >= 0, "isArrayBufferLike"), vl = /* @__PURE__ */ g((r) => !Buffer.isBuffer(r) && ArrayBuffer.
isView(r), "isArrayBufferView"), yi = class {
  static {
    g(this, "Pipe");
  }
  src;
...
}, xl = /* @__PURE__ */ g((r) => !!r.objectMode, "isObjectModeOptions"), Pl = /* @__PURE__ */ g((r) => !r.objectMode && !!r.encoding && r.encoding !==
"buffer", "isEncodingOptions"), Ve = class extends Di.EventEmitter {
  static {
    g(this, "Minipass");
  }
  [SA] = !1;
  ...
  constructor(...A) {
    ...
    xl(e) ? (this[YA] = !0, this[Ee] = null) : Pl(e) ? (this[Ee] = e.encoding, this[YA] = !1) : (this[YA] = !1, this[Ee] = null), this[De] =
    !!e.async, this[Ut] = this[Ee] ? new iI.StringDecoder(this[Ee]) : null, e && e.debugExposeBuffer === !0 && Object.defineProperty(this, "\
buffer", { get: /* @__PURE__ */ g(() => this[FA], "get") }), e && e.debugExposePipes === !0 && Object.defineProperty(this, "pipes", { get: /* @__PURE__ */ g(
    () => this[xA], "get") });
    let { signal: t } = e;
    t && (this[yr] = t, t.aborted ? this[Rg]() : t.addEventListener("abort", () => this[Rg]()));
  }
  /**
  ...
  [Rg]() {
    this[mi] = !0, this.emit("abort", this[yr]?.reason), this.destroy(this[yr]?.reason);
  }
  /**
  ...
  write(A, e, t) {
    ...
    return this[YA] ? (this[SA] && this[NA] !== 0 && this[di](!0), this[SA] ? this.emit("data", A) : this[Fg](A), this[NA] !== 0 && this.emit(
    "readable"), t && i(t), this[SA]) : A.length ? (typeof A == "string" && // unless it is a string already ready for us to use
    !(e === this[Ee] && !this[Ut]?.lastNeed) && (A = Buffer.from(A, e)), Buffer.isBuffer(A) && this[Ee] && (A = this[Ut].write(A)), this[SA] &&
    this[NA] !== 0 && this[di](!0), this[SA] ? this.emit("data", A) : this[Fg](A), this[NA] !== 0 && this.emit("readable"), t && i(t), this[SA]) :
    (this[NA] !== 0 && this.emit("readable"), t && i(t), this[SA]);
  }
  /**
  ...
  read(A) {
    ...
    let e = this[eI](A || null, this[FA][0]);
    return this[Ye](), e;
  }
  [eI](A, e) {
    if (this[YA])
      ...
      let t = e;
      A === t.length || A === null ? this[pi]() : typeof t == "string" ? (this[FA][0] = t.slice(A), e = t.slice(0, A), this[NA] -= A) : (this[FA][0] =
    ...
    this.once("end", t), this[Le] = !0, this.writable = !1, (this[SA] || !this[mr]) && this[Ye](), this;
  }
  // don't let the internal resume be overwritten
  [Gt]() {
    this[fA] || (!this[Bt] && !this[xA].length && (this[ZA] = !0), this[mr] = !1, this[SA] = !0, this.emit("resume"), this[FA].length ? this[di]() :
  ...
  [di](A = !1) {
    do
      ;
    while (this[tI](this[pi]()) && this[FA].length);
  ...
  pipe(A, e) {
    ...
    this[ZA] = !1;
    let t = this[Xe];
    return e = e || {}, A === AI.stdout || A === AI.stderr ? e.end = !1 : e.end = e.end !== !1, e.proxyErrors = !!e.proxyErrors, t ? e.end &&
    A.end() : (this[xA].push(e.proxyErrors ? new bg(this, A, e) : new yi(this, A, e)), this[De] ? Dr(() => this[Gt]()) : this[Gt]()), A;
  }
  /**
  ...
  unpipe(A) {
    ...
    e && (this[xA].length === 1 ? (this[SA] && this[Bt] === 0 && (this[SA] = !1), this[xA] = []) : this[xA].splice(this[xA].indexOf(e), 1), e.
    unpipe());
  }
  /**
  ...
  on(A, e) {
    let t = super.on(A, e);
    if (A === "data")
      this[ZA] = !1, this[Bt]++, !this[xA].length && !this[SA] && this[Gt]();
    else if (A === "readable" && this[NA] !== 0)
      super.emit("readable");
    else if (Gl(A) && this[Xe])
      super.emit(A), this.removeAllListeners(A);
    else if (A === "error" && this[pr]) {
      let i = e;
      this[De] ? Dr(() => i.call(this, this[pr])) : i.call(this, this[pr]);
    }
    return t;
  }
  /**
  ...
  off(A, e) {
    let t = super.off(A, e);
    return A === "data" && (this[Bt] = this.listeners("data").length, this[Bt] === 0 && !this[ZA] && !this[xA].length && (this[SA] = !1)), t;
  }
  /**
  ...
  removeAllListeners(A) {
    ...
    return (A === "data" || A === void 0) && (this[Bt] = 0, !this[ZA] && !this[xA].length && (this[SA] = !1)), e;
  }
  /**
  ...
  [Ye]() {
    !this[fi] && !this[Xe] && !this[fA] && this[FA].length === 0 && this[Le] && (this[fi] = !0, this.emit("end"), this.emit("prefinish"), this.
    emit("finish"), this[wi] && this.emit("close"), this[fi] = !1);
  }
  /**
  ...
  emit(A, ...e) {
    ...
    if (A !== "error" && A !== "close" && A !== fA && this[fA])
      return !1;
    if (A === "data")
      return !this[YA] && !t ? !1 : this[De] ? (Dr(() => this[kg](t)), !0) : this[kg](t);
    if (A === "end")
      return this[rI]();
    if (A === "close") {
      if (this[wi] = !0, !this[Xe] && !this[fA])
        return !1;
      let o = super.emit("close");
      return this.removeAllListeners("close"), o;
    } else if (A === "error") {
      this[pr] = t, super.emit(Ng, t);
  ...
  [rI]() {
    return this[Xe] ? !1 : (this[Xe] = !0, this.readable = !1, this[De] ? (Dr(() => this[Mg]()), !0) : this[Mg]());
  }
  [Mg]() {
    if (this[Ut]) {
      let e = this[Ut].end();
  ...
  [Symbol.iterator]() {
    this[ZA] = !1;
    let A = !1, e = /* @__PURE__ */ g(() => (this.pause(), this.off(Ng, e), this.off(fA, e), this.off("end", e), A = !0, { done: !0, value: void 0 }),
    "stop"), t = /* @__PURE__ */ g(() => {
      if (A)
        return e();
      let i = this.read();
    ...
    return this.once("end", e), this.once(Ng, e), this.once(fA, e), {
      next: t,
      throw: e,
      return: e,
      [Symbol.iterator]() {
  ...
  destroy(A) {
    ...
    let e = this;
    return typeof e.close == "function" && !this[wi] && e.close(), A ? this.emit("error", A) : this.emit(fA), this;
  }
  /**
...
// ../node_modules/path-scurry/dist/esm/index.js
var _l = Se.realpathSync.native, Sr = {
  lstatSync: Se.lstatSync,
  readdir: Se.readdir,
  readdirSync: Se.readdirSync,
  readlinkSync: Se.readlinkSync,
  realpathSync: _l,
  promises: {
    lstat: Ze.lstat,
    readdir: Ze.readdir,
...
}, II = /* @__PURE__ */ g((r) => !r || r === Sr || r === Ol ? Sr : {
  ...Sr,
  ...r,
  promises: {
    ...Sr.promises,
...
}, "fsFromOption"), aI = /^\\\\\?\\([a-z]:)\\?$/i, Tl = /* @__PURE__ */ g((r) => r.replace(/\//g, "\\").replace(aI, "$1\\"), "uncToDrive"), Hl = /[\\\/]/,
oe = 0, EI = 1, cI = 2, Ke = 4, BI = 6, QI = 8, Qt = 10, hI = 12, ie = 15, Kr = ~ie, Yg = 16, oI = 32, Fr = 64, ce = 128, Ki = 256, Fi = 512,
gI = Fr | ce | Fi, jl = 1023, Ug = /* @__PURE__ */ g((r) => r.isFile() ? QI : r.isDirectory() ? Ke : r.isSymbolicLink() ? Qt : r.isCharacterDevice() ?
cI : r.isBlockDevice() ? BI : r.isSocket() ? hI : r.isFIFO() ? EI : oe, "entToType"), sI = /* @__PURE__ */ new Map(), Nr = /* @__PURE__ */ g(
(r) => {
  let A = sI.get(r);
  if (A)
    return A;
  ...
  return sI.set(r, e), e;
}, "normalize"), nI = /* @__PURE__ */ new Map(), Si = /* @__PURE__ */ g((r) => {
  let A = nI.get(r);
  if (A)
    return A;
  let e = Nr(r.toLowerCase());
  return nI.set(r, e), e;
}, "normalizeNocase"), Ni = class extends dr {
  static {
    g(this, "ResolveCache");
  }
  constructor() {
...
}, lI = Symbol("PathScurry setAsCwd"), UA = class {
  static {
    g(this, "PathBase");
  }
  /**
  ...
  constructor(A, e = oe, t, i, o, s, I) {
    this.name = A, this.#w = o ? Si(A) : Nr(A), this.#i = e & jl, this.nocase = o, this.roots = i, this.root = t || this, this.#R = s, this.#p =
    I.fullpath, this.#N = I.relative, this.#K = I.relativePosix, this.parent = I.parent, this.parent ? this.#A = this.parent.#A : this.#A = II(
    I.fs);
  }
  /**
  ...
  children() {
    ...
    return this.#R.set(this, e), this.#i &= ~Yg, e;
  }
  /**
  ...
  child(A, e) {
    ...
    let t = this.children(), i = this.nocase ? Si(A) : Nr(A);
    for (let E of t)
      if (E.#w === i)
        return E;
  ...
  canReadlink() {
    ...
    if (!this.parent)
      return !1;
    let A = this.#i & ie;
    return !(A !== oe && A !== Qt || this.#i & Ki || this.#i & ce);
  }
  /**
   ...
   */
  isNamed(A) {
    return this.nocase ? this.#w === Si(A) : this.#w === Nr(A);
  }
  /**
  ...
  #Y() {
    this.#i & ce || (this.#i = (this.#i | ce) & Kr, this.#S());
  }
  #S() {
    let A = this.children();
    A.provisional = 0;
  ...
  #U() {
    if (this.#i & Fr)
      return;
    let A = this.#i;
    (A & ie) === Ke && (A &= Kr), this.#i = A | Fr, this.#S();
  }
  #G(A = "") {
  ...
  #I(A = "") {
    let e = this.#i;
    e |= Ki, A === "ENOENT" && (e |= ce), (A === "EINVAL" || A === "UNKNOWN") && (e &= Kr), this.#i = e, A === "ENOTDIR" && this.parent && this.
    parent.#U();
  }
  #v(A, e) {
  ...
  #x(A, e) {
    let t = Ug(A), i = this.newChild(A.name, t, { parent: this }), o = i.#i & ie;
    return o !== Ke && o !== Qt && o !== oe && (i.#i |= Fr), e.unshift(i), e.provisional++, i;
  }
  #M(A, e) {
    for (let t = e.provisional; t < e.length; t++) {
      let i = e[t];
      if ((this.nocase ? Si(A.name) : Nr(A.name)) === i.#w)
        return this.#P(A, i, t, e);
    }
  }
  #P(A, e, t, i) {
    let o = e.name;
    return e.#i = e.#i & Kr | Ug(A), o !== A.name && (e.name = A.name), t !== i.provisional && (t === i.length - 1 ? i.pop() : i.splice(t, 1),
  ...
  #H(A) {
    ...
    let x = Ug(A);
    this.#i = this.#i & Kr | x | oI, x !== oe && x !== Ke && x !== Qt && (this.#i |= Fr);
  }
  #_ = [];
  #T = !1;
  #j(A) {
  ...
  shouldWalk(A, e) {
    return (this.#i & Ke) === Ke && !(this.#i & gI) && !A.has(this) && (!e || e(this));
  }
  /**
   ...
   */
  getRoot(A) {
    if (A = Tl(A.toUpperCase()), A === this.root.name)
      return this.root;
  ...
  sameRoot(A, e = this.root.name) {
    return A = A.toUpperCase().replace(/\//g, "\\").replace(aI, "$1\\"), A === e;
  }
}, Mi = class r extends UA {
  static {
    g(this, "PathPosix");
  }
  /**
  ...
  constructor(A = process.cwd(), e, t, { nocase: i, childrenCacheSize: o = 16 * 1024, fs: s = Sr } = {}) {
    this.#r = II(s), (A instanceof URL || A.startsWith("file://")) && (A = (0, CI.fileURLToPath)(A));
    let I = e.resolve(A);
    this.roots = /* @__PURE__ */ Object.create(null), this.rootPath = this.parseRootPath(I), this.#A = new Ni(), this.#e = new Ni(), this.#t =
    new Gg(o);
  ...
  *iterateSync(A = this.cwd, e = {}) {
  ...
  chdir(A = this.cwd) {
    let e = this.cwd;
    this.cwd = typeof A == "string" ? this.cwd.resolve(A) : A, this.cwd[lI](e);
  }
}, vt = class extends Ri {
  static {
   ...
   */
  newRoot(A) {
    return new ki(this.rootPath, Ke, void 0, this.roots, this.nocase, this.childrenCache(), { fs: A });
  }
  /**
   ...
   */
  newRoot(A) {
    return new Mi(this.rootPath, Ke, void 0, this.roots, this.nocase, this.childrenCache(), { fs: A });
  }
  /**
   * Return true if the provided path string is an absolute path
   */
...
}, NK = process.platform === "win32" ? ki : Mi, uI = process.platform === "win32" ? vt : process.platform === "darwin" ? kr : xt;

// ../node_modules/glob/dist/esm/pattern.js
var ql = /* @__PURE__ */ g((r) => r.length >= 1, "isPatternList"), zl = /* @__PURE__ */ g((r) => r.length >= 1, "isGlobList"), Pt = class r {
  static {
    g(this, "Pattern");
  }
  #A;
...
var Wl = typeof process == "object" && process && typeof process.platform == "string" ? process.platform : "linux", Ot = class {
  static {
    g(this, "Ignore");
  }
  relative;
  ...
  platform;
  mmopts;
  constructor(A, { nobrace: e, nocase: t, noext: i, noglobstar: o, platform: s = Wl }) {
  ...
  add(A) {
    ...
    for (let t = 0; t < e.set.length; t++) {
      ...
      for (; i[0] === "." && o[0] === "."; )
        i.shift(), o.shift();
      let s = new Pt(i, o, 0, this.platform), I = new VA(s.globString(), this.mmopts), E = o[o.length - 1] === "**", B = s.isAbsolute();
...
var Jg = class r {
  ...
  opts;
  constructor(A, e) {
    this.opts = A, this.follow = !!A.follow, this.dot = !!A.dot, this.hasWalkedCache = e ? e.copy() : new Jg();
  }
  processPatterns(A, e) {
    this.patterns = e;
    let t = e.map((i) => [A, i]);
...
var Xl = /* @__PURE__ */ g((r, A) => typeof r == "string" ? new Ot([r], A) : Array.isArray(r) ? new Ot(r, A) : r, "makeIgnore"), bi = class {
  static {
    g(this, "GlobUtil");
  }
  path;
...
// ../node_modules/glob/dist/esm/glob.js
var Vl = typeof process == "object" && process && typeof process.platform == "string" ? process.platform : "linux", Be = class {
  static {
    g(this, "Glob");
  }
  absolute;
  ...
  constructor(A, e) {
    ...
    dotRelative, this.nodir = !!e.nodir, this.mark = !!e.mark, e.cwd ? (e.cwd instanceof URL || e.cwd.startsWith("file://")) && (e.cwd = (0, fI.fileURLToPath)(
    ...
    if (this.pattern = A, this.platform = e.platform || Vl, this.opts = { ...e, platform: this.platform }, e.scurry) {
      if (this.scurry = e.scurry, e.nocase !== void 0 && e.nocase !== e.scurry.nocase)
        throw new Error("nocase option contradicts provided scurry option");
    } else {
      let E = e.platform === "win32" ? vt : e.platform === "darwin" ? kr : e.platform ? xt : uI;
...
g(Ui, "globIterateSync");
function mI(r, A = {}) {
  return new Be(r, A).iterate();
}
g(mI, "globIterate");
var Zl = Yi, $l = Object.assign(dI, { sync: Yi }), Au = Ui, eu = Object.assign(mI, {
  sync: Ui
}), tu = Object.assign(pI, {
  stream: Yi,
  iterate: Ui
...
var KI = J(HA(), 1);
async function Lr(r) {
  let A = `{${Array.from(Qi).join(",")}}`, e = await Li($e((0, Og.resolve)(r, `main${A}`))), [t] = e;
  if (e.length > 1 && yI.once.warn(KI.dedent`
      Multiple main files found in your configDir (${(0, Og.resolve)(r)}).
      Storybook will use the first one found and ignore the others. Please remove the extra files.
    `), !t)
    throw new DI.MainFileMissingError({ location: r });
}
g(Lr, "validateConfigurationFiles");

// src/common/utils/load-custom-presets.ts
function _g({ configDir: r }) {
  Lr(r);
  let A = kt((0, Gi.resolve)(r, "presets"));
  if (kt((0, Gi.resolve)(r, "main"))) {
    let t = Mt((0, Gi.resolve)(r, "main"));
    if (t)
      return [t];
  }
  return A || [];
}
g(_g, "loadCustomPresets");

// src/common/utils/safeResolve.ts
var kI = J(Hg(), 1);
var MI = /* @__PURE__ */ g((r, A) => {
  try {
    return (0, kI.default)(r, A);
  } catch {
    return;
  }
}, "safeResolveFrom"), jg = /* @__PURE__ */ g((r) => {
  try {
...
function iu(r) {
  return Ji.posix.normalize($e(r));
}
g(iu, "normalizePath");
function qg(r) {
  let A = r.split(`node_modules${Ji.sep}`);
  return iu(A[A.length - 1]);
}
g(qg, "stripAbsNodeModulesPath");

// src/common/presets.ts
var Yr = /* @__PURE__ */ g((r) => r != null && typeof r == "object" && Array.isArray(r) === !1, "isObject"), ou = /* @__PURE__ */ g((r) => typeof r ==
"function", "isFunction");
function UI(r) {
  return r.filter((A) => {
...
g(UI, "filterPresetsConfig");
function RI(r) {
  let { dir: A, name: e } = (0, Tt.parse)(r), t = (0, Tt.join)(A, `${e}.mjs`);
  return jg(t) ? t : r;
}
g(RI, "resolvePathToMjs");
function bI(r, A, e) {
  return ou(r) ? [...r({ ...e, ...A })] : Array.isArray(r) ? [...r] : [];
}
g(bI, "resolvePresetFunction");
var GI = /* @__PURE__ */ g((r, A, e) => {
  let t = A.startsWith("/") ? jg : MI.bind(null, r), i = t(A);
  if (i) {
    ...
    if (A.match(/\/(manager|register(-panel)?)(\.(js|mjs|ts|tsx|jsx))?$/))
      return {
        ...
        managerEntries: [RI((0, Tt.join)(f, p))]
      };
      ...
      ...B ? {
        previewAnnotations: [
          h ? {
            ...
            bare: B.includes("node_modules") ? qg(B) : B,
            absolute: h
          } : B
        ]
      } : {},
...
}, "resolveAddonName"), gu = /* @__PURE__ */ g(({ configDir: r }) => (A) => {
  let e = Yr(A) && A.options || void 0, t = Yr(A) ? A.name : A, i;
  try {
    i = GI(r, t, e);
  } catch {
    _t.logger.error(
...
g(su, "getContent");
async function JI(r, A, e) {
  let t = r.name ? r.name : r;
  try {
    let i = r.options ? r.options : {}, o = await su(r);
    if (typeof o == "function" && (o = o(e, i)), Array.isArray(o))
      return await vi(o, A + 1, e);
    if (Yr(o)) {
      ...
      let h = bI(
        ...
        i,
        e
      ).filter(B), u = bI(s, i, e).filter(
        B
      );
      return [
        ...await vi([...h], A + 1, e),
        ...await vi(
          [...u.map(gu(e))].filter(Boolean),
          A + 1,
          e
        ),
        {
    ...
    if (e?.isCritical)
      throw new LI.CriticalPresetLoadError({
        error: i,
        presetName: t
      });
...
async function vi(r, A, e) {
  return !r || !Array.isArray(r) || !r.length ? [] : (await Promise.all(
    r.map(async (t) => JI(t, A, e))
  )).reduce((t, i) => t.concat(i), []);
}
g(vi, "loadPresets");
function vI(r, A, e, t, i) {
  ...
  return r.length ? r.reduce((s, { preset: I, options: E }) => {
    ...
    if (typeof B == "function") {
      let h = B, u = {
        ...
        combinedOptions: {
          ...
          presetsList: r,
          presets: {
            apply: /* @__PURE__ */ g(async (f, p, m = {}) => vI(r, f, p, m, i), "apply")
          }
        }
      };
      return s.then(
    ...
    return s.then((h) => Array.isArray(h) && Array.isArray(B) ? [...h, ...B] : Yr(h) && Yr(B) ? { ...h, ...B } : B);
  }, o) : o;
}
g(vI, "applyPresets");
async function xI(r, A) {
  let e = await vi(r, 0, A);
  return {
    apply: /* @__PURE__ */ g(async (t, i, o = {}) => vI(e, t, i, o, A), "apply")
  };
}
g(xI, "getPresets");
async function nu(r) {
...
var Ur = require("node:crypto"), $A = require("node:fs"), Qe = require("node:fs/promises"), PI = require("node:os"), Ht = require("node:path");
var zg = class {
  static {
    g(this, "FileSystemCache");
  }
  constructor(A = {}) {
    this.prefix = (A.ns || A.prefix || "") + "-", this.hash_alg = A.hash_alg || "md5", this.cache_dir = A.basePath || (0, Ht.join)((0, PI.tmpdir)(),
...
g(xi, "createFileSystemCache");

// src/common/utils/resolve-path-in-sb-cache.ts
var es = require("node:path");

// ../node_modules/find-cache-dir/index.js
var ta = J(require("node:process"), 1), zt = J(require("node:path"), 1), vr = J(require("node:fs"), 1), ra = J(_I(), 1);

// ../node_modules/pkg-dir/index.js
var ZI = J(require("node:path"), 1);

// ../node_modules/pkg-dir/node_modules/find-up/index.js
var Jr = J(require("node:path"), 1), XI = require("node:url");

// ../node_modules/locate-path/index.js
var Vg = J(require("node:process"), 1), Zg = J(require("node:path"), 1), jt = J(require("node:fs"), 1), TI = require("node:url");
...
}, au = /* @__PURE__ */ g(async (r, A) => A(await r), "testElement"), Eu = /* @__PURE__ */ g(async (r) => {
  let A = await Promise.all(r);
  if (A[1] === !0)
    throw new Oi(A[0]);
  return !1;
}, "finder");
async function Xg(r, A, {
  concurrency: e = Number.POSITIVE_INFINITY,
  preserveOrder: t = !0
} = {}) {
  let i = Pi(e), o = [...r].map((I) => [I, i(au, I, A)]), s = Pi(t ? 1 : Number.POSITIVE_INFINITY);
  try {
    await Promise.all(o.map((I) => s(Eu, I)));
  } catch (I) {
    if (I instanceof Oi)
      return I.value;
    throw I;
...
function jI(r) {
  if (!Object.hasOwnProperty.call(HI, r))
    throw new Error(`Invalid type specified: ${r}`);
}
g(jI, "checkType");
var qI = /* @__PURE__ */ g((r, A) => A[HI[r]](), "matchType"), zI = /* @__PURE__ */ g((r) => r instanceof URL ? (0, TI.fileURLToPath)(r) : r,
"toPath");
async function _i(r, {
  cwd: A = Vg.default.cwd(),
  type: e = "file",
  allowSymlinks: t = !0,
  concurrency: i,
  preserveOrder: o
  ...
  jI(e), A = zI(A);
  let s = t ? jt.promises.stat : jt.promises.lstat;
  return Xg(r, async (I) => {
    try {
      let E = await s(Zg.default.resolve(A, I));
      return qI(e, E);
    } catch {
      return !1;
    }
...
function qt(r, {
  ...
  for (let o of r)
    try {
      let s = i(Zg.default.resolve(A, o), {
        throwIfNoEntry: !1
      });
      if (!s)
        continue;
...
var WI = J(require("node:fs"), 1);

// ../node_modules/pkg-dir/node_modules/find-up/index.js
var cu = /* @__PURE__ */ g((r) => r instanceof URL ? (0, XI.fileURLToPath)(r) : r, "toPath"), Bu = Symbol("findUpStop");
function Qu(r, A = {}) {
  let e = Jr.default.resolve(cu(A.cwd) || ""), { root: t } = Jr.default.parse(e), i = A.stopAt || t, o = A.limit || Number.POSITIVE_INFINITY,
  s = [r].flat(), I = /* @__PURE__ */ g((B) => {
    if (typeof r != "function")
      return qt(s, B);
    let h = r(B.cwd);
    return typeof h == "string" ? qt([h], B) : h;
  }, "runMatcher"), E = [];
  for (; ; ) {
    let B = I({ ...A, cwd: e });
    if (B === Bu || (B && E.push(Jr.default.resolve(e, B)), e === i || E.length >= o))
      break;
    e = Jr.default.dirname(e);
  }
  return E;
}
g(Qu, "findUpMultipleSync");
function VI(r, A = {}) {
  return Qu(r, { ...A, limit: 1 })[0];
}
g(VI, "findUpSync");

// ../node_modules/pkg-dir/index.js
function $I({ cwd: r } = {}) {
  let A = VI("package.json", { cwd: r });
  return A && ZI.default.dirname(A);
}
g($I, "packageDirectorySync");

// ../node_modules/find-cache-dir/index.js
var { env: $g, cwd: hu } = ta.default, Aa = /* @__PURE__ */ g((r) => {
  try {
...
function lu(r) {
  ...
  if (!(!Aa(A) && (vr.default.existsSync(A) || !Aa(zt.default.join(r)))))
    return A;
}
g(lu, "getNodeModuleDirectory");
function As(r = {}) {
  if ($g.CACHE_DIR && !["true", "false", "1", "0"].includes($g.CACHE_DIR))
    return ea(zt.default.join($g.CACHE_DIR, r.name), r);
  let { cwd: A = hu(), files: e } = r;
  if (e) {
    if (!Array.isArray(e))
      throw new TypeError(`Expected \`files\` option to be an array, got \`${typeof e}\`.`);
    A = (0, ra.default)(e.map((i) => zt.default.resolve(A, i)));
  }
  if (A = $I({ cwd: A }), !(!A || !lu(A)))
    return ea(zt.default.join(A, "node_modules", ".cache", r.name), r);
}
g(As, "findCacheDirectory");

// src/common/utils/resolve-path-in-sb-cache.ts
function ts(r, A = "default") {
  let e = As({ name: "storybook" });
  return e ||= (0, es.join)(process.cwd(), ".cache", "storybook"), (0, es.join)(e, A, r);
}
g(ts, "resolvePathInStorybookCache");

// src/common/utils/cache.ts
var uu = xi({
  basePath: ts("dev-server"),
  ns: "storybook"
  // Optional. A grouping namespace for items.
});

// src/common/utils/cli.ts
var qi = require("node:fs"), Fe = require("node:fs/promises"), ca = J(require("node:os"), 1), zi = require("node:path");

// ../node_modules/crypto-random-string/index.js
var ia = require("util"), Ti = J(require("crypto"), 1);
var oa = (0, ia.promisify)(Ti.default.randomBytes), fu = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-._~".split(""), wu = "\
0123456789".split(""), du = "CDEHKMPRTUWXY012458".split(""), pu = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghi\
jklmnopqrstuvwxyz{|}~".split(""), mu = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), yu = /* @__PURE__ */ g((r, A) => {
  let e = A.length, t = Math.floor(65536 / e) * e - 1, i = 2 * Math.ceil(1.1 * r), o = "", s = 0;
  for (; s < r; ) {
    let I = Ti.default.randomBytes(i), E = 0;
    for (; E < i && s < r; ) {
  ...
  return o;
}, "generateForCustomCharacters"), Du = /* @__PURE__ */ g(async (r, A) => {
  let e = A.length, t = Math.floor(65536 / e) * e - 1, i = 2 * Math.ceil(1.1 * r), o = "", s = 0;
  for (; s < r; ) {
    let I = await oa(i), E = 0;
    for (; E < i && s < r; ) {
      let B = I.readUInt16LE(E);
      E += 2, !(B > t) && (o += A[B % e], s++);
    }
  ...
  return o;
}, "generateForCustomCharactersAsync"), Ku = /* @__PURE__ */ g((r, A, e) => Ti.default.randomBytes(r).toString(A).slice(0, e), "generateRand\
omBytes"), Su = /* @__PURE__ */ g(async (r, A, e) => (await oa(r)).toString(A).slice(0, e), "generateRandomBytesAsync"), Fu = /* @__PURE__ */ new Set(
[
  void 0,
  "hex",
  "base64",
  ...
  "ascii-printable",
  "alphanumeric"
]), ga = /* @__PURE__ */ g((r, A) => ({ length: e, type: t, characters: i }) => {
...
var Ia = require("node:fs"), aa = require("node:path");
...
g(is, "getStorybookConfiguration");
...
}, Nu = ["@storybook/builder-webpack5", "@storybook/builder-vite"], Ca = console, ku = /* @__PURE__ */ g(({ dependencies: r, devDependencies: A,
peerDependencies: e }, t) => [
  Object.entries(r || {}).find(t),
  Object.entries(A || {}).find(t),
  Object.entries(e || {}).find(t)
], "findDependency"), Mu = /* @__PURE__ */ g((r) => {
  let [A, e, t] = ku(r, ([s]) => ji[s]), [i, o] = A || e || t || [];
  return A && e && A[0] === e[0] && Ca.warn(
...
}, "getRendererInfo"), Ru = ["ts", "js", "tsx", "jsx", "mjs", "cjs"], Hi = /* @__PURE__ */ g((r, A) => {
  let e = (0, aa.join)(A, r), t = Ru.find((i) => (0, Ia.existsSync)(`${e}.${i}`));
  return t ? `${e}.${t}` : null;
}, "findConfigFile"), Ea = /* @__PURE__ */ g((r, A) => {
  let e = A ?? ".storybook", t = r.scripts?.storybook;
  if (t && !A) {
    let i = is(t, "-c", "--config-dir");
    i && (e = i);
  }
  return {
    configDir: e,
    mainConfig: Hi("main", e),
    previewConfig: Hi("preview", e),
    managerConfig: Hi("manager", e)
  };
}, "getConfigInfo"), os = /* @__PURE__ */ g((r, A) => {
  let e = Mu(r), t = Ea(r, A);
  return {
    ...e,
    ...t
...
// src/common/utils/cli.ts
var bu = /* @__PURE__ */ g(() => (0, Fe.realpath)(ca.default.tmpdir()), "tempDir"), Ba = /* @__PURE__ */ g(async (r = "") => (0, zi.join)(await bu(),
r + rs()), "getPath");
async function Qa({ prefix: r = "" } = {}) {
  let A = await Ba(r);
  return (0, qi.mkdirSync)(A), A;
}
g(Qa, "temporaryDirectory");
async function ha({ name: r, extension: A } = {}) {
  if (r) {
    if (A != null)
      throw new Error("The `name` and `extension` options are mutually exclusive");
    return (0, zi.join)(await Qa(), r);
  }
  return await Ba() + (A == null ? "" : "." + A.replace(/^\./, ""));
}
g(ha, "temporaryFile");
function Lu(r) {
...
var he = /* @__PURE__ */ g(async (r = "storybook.log") => {
  let A = (0, zi.join)(process.cwd(), r), e = await ha({ name: r }), t = (0, qi.createWriteStream)(e, { encoding: "utf8" });
...
}, "createLogStream"), Gu = /* @__PURE__ */ g((r) => Object.keys(ze).includes(r), "isCorePackage");

// src/common/utils/check-addon-order.ts
var Wi = require("@storybook/core/node-logger");
var gs = /* @__PURE__ */ g((r) => (A) => {
  let e = A.name || A;
  return e && e.replaceAll(/(\\){1,2}/g, "/").includes(r);
}, "predicateFor"), Ju = /* @__PURE__ */ g((r, A, e) => {
  let t = r.findIndex(gs("@storybook/addon-essentials")), i = r.findIndex(gs(A.name)), o = r.findIndex(gs(e.name));
  return i === -1 && A.inEssentials && (i = t), o === -1 && e.inEssentials && (o = t), i !== -1 && o !== -1 && i <= o;
}, "isCorrectOrder"), vu = /* @__PURE__ */ g(async ({ before: r, after: A, configFile: e, getConfig: t }) => {
  try {
    let i = await t(e);
    if (!i?.addons) {
      Wi.logger.warn("Unable to find 'addons' config in main Storybook config");
      return;
    }
    if (!Ju(i.addons, r, A)) {
    ...
    Wi.logger.warn(`Unable to load config file: ${e}`);
  }
}, "checkAddonOrder");

// ../node_modules/lazy-universal-dotenv/lib/index.mjs
var Sa = J(require("fs"), 1), Fa = J(require("path"), 1), Na = J(ua(), 1), ka = J(ma(), 1), Ma = J(Ka(), 1);
var At = Fa.default.join(Na.default.get(), ".env");
function Ra({ nodeEnv: r, buildTarget: A } = {}) {
  ...
  return [
    ...
    if (Sa.default.existsSync(E)) {
      let B = ka.default.config({
        path: E
      });
      e = Object.assign({}, e, Ma.default.expand(B).parsed);
    }
...
var ba = require("node:url");
function xr(r) {
  return r instanceof URL ? (0, ba.fileURLToPath)(r) : r;
}
g(xr, "toPath");

// node_modules/path-exists/index.js
var La = J(require("node:fs"), 1);

// node_modules/find-up/index.js
var Ya = Symbol("findUpStop");
async function of(r, A = {}) {
  let e = le.default.resolve(xr(A.cwd) ?? ""), { root: t } = le.default.parse(e), i = le.default.resolve(e, xr(A.stopAt ?? t)), o = A.limit ??
  Number.POSITIVE_INFINITY, s = [r].flat(), I = /* @__PURE__ */ g(async (B) => {
    if (typeof r != "function")
      return _i(s, B);
    let h = await r(B.cwd);
    return typeof h == "string" ? _i([h], B) : h;
  }, "runMatcher"), E = [];
  for (; ; ) {
    let B = await I({ ...A, cwd: e });
    if (B === Ya || (B && E.push(le.default.resolve(e, B)), e === i || E.length >= o))
      break;
...
g(gf, "findUpMultipleSync");
async function Ne(r, A = {}) {
  return (await of(r, { ...A, limit: 1 }))[0];
}
g(Ne, "findUp");
function PA(r, A = {}) {
  return gf(r, { ...A, limit: 1 })[0];
}
g(PA, "findUpSync");
...
var sf = /* @__PURE__ */ g(() => {
  ...
  try {
    let A = PA(".git", { type: "directory" });
    A && (r = (0, Ge.join)(A, ".."));
  } catch {
  }
  try {
    let A = PA(".svn", { type: "directory" });
    A && (r = r || (0, Ge.join)(A, ".."));
  } catch {
  }
  try {
    let A = PA(".hg", { type: "directory" });
    A && (r = r || (0, Ge.join)(A, ".."));
  } catch {
  }
  try {
  ...
  try {
    let A = PA(".yarn", { type: "directory" });
    A && (r = r || (0, Ge.join)(A, ".."));
  } catch {
  }
  return r || process.cwd();
}, "getProjectRoot"), as = /* @__PURE__ */ g((r) => r.split(process.platform === "win32" ? ";" : ":").filter(Boolean).map((A) => (0, Ge.resolve)(
"./", A)), "nodePathsToArray"), nf = /^\.{1,2}([/\\]|$)/;
function Es(r) {
  return nf.test(r) ? r : `.${Ge.sep}${r}`;
}
g(Es, "normalizeStoryPath");
...
function Cf(r = {}) {
  ...
  let t = Object.entries(e).reduce(
    ...
    {}
  ), { stringified: i, raw: o } = Ra({ nodeEnv: e.NODE_ENV }), s = { ...e, ...o };
  return s.NODE_PATH = as(s.NODE_PATH || ""), {
    stringified: { ...t, ...i },
    raw: s
  };
}
g(Cf, "loadEnvs");
var If = /* @__PURE__ */ g((r) => Object.entries(r).reduce((A, [e, t]) => (A[e] = JSON.stringify(t), A), {}), "stringifyEnvs"), af = /* @__PURE__ */ g(
...
var Ef = /node_modules/, cf = /* @__PURE__ */ g((r) => Ef.test(r) ? {} : { ignore: ["**/node_modules/**"] }, "commonGlobOptions");
...
g(Bf, "getBuilderOptions");

// src/common/utils/get-framework-name.ts
var Ja = J(HA(), 1);

// src/common/utils/normalize-path.ts
var Ua = require("node:path");
function Ga(r) {
  return Ua.posix.normalize(r.replace(/\\/g, "/"));
}
g(Ga, "normalizePath");
...
async function Qf(r) {
  ...
  return !A || !A.renderer ? Bs(r) : A.renderer;
}
g(Qf, "getRendererName");
async function hf(r) {
  let A = Qs(r), e = ht[A];
  return e ? cs[e] : null;
}
g(hf, "extractProperRendererNameFromFramework");

// src/common/utils/get-storybook-refs.ts
var hs = require("node:fs/promises"), Vi = require("node:path"), va = require("@storybook/core/node-logger");
var xa = J(Hg(), 1);
var Pa = /* @__PURE__ */ g(async (r) => {
  let A = await Ne("package.json", { cwd: r.configDir });
  if (!A)
    return {};
  let e = (0, Vi.dirname)(A), { dependencies: t = [], devDependencies: i = [] } = JSON.parse(await (0, hs.readFile)(A, { encoding: "utf8" })) ||
  {}, o = Object.keys({ ...t, ...i });
  return (await Promise.all(
    o.map(async (I) => {
      try {
        let E = (0, xa.default)(e, (0, Vi.join)(I, "package.json")), { storybook: B, name: h, version: u } = JSON.parse(await (0, hs.readFile)(
        E, { encoding: "utf8" })) || {};
        if (B?.url)
        ...
        if (E.code === "ERR_PACKAGE_PATH_NOT_EXPORTED")
          return;
        va.logger.warn(`unable to find package.json for ${I}`);
        return;
      }
    })
...
}, "getAutoRefs"), lf = /* @__PURE__ */ g((r) => fetch(`${r}/iframe.html`).then(
  async ({ ok: A, status: e }) => {
    if (A) {
      if (e !== 200)
        return !1;
  ...
  () => !1
), "checkRef"), Oa = /* @__PURE__ */ g((r) => r.replace(/\/$/, ""), "stripTrailingSlash"), uf = /* @__PURE__ */ g((r) => {
...
async function ff(r) {
  if (r.test)
    return {};
  let A = await r.presets.apply("refs", await Pa(r));
  return Object.entries(A).forEach(([e, t]) => {
    ...
    A[e.toLowerCase()] = {
      ...t,
      id: e.toLowerCase(),
      title: t.title || uf(t.id || e),
      url: Oa(t.url)
    };
  }), await Promise.all(
    Object.entries(A).map(async ([e, t]) => {
      let i = await lf(t.url);
...
var $f = /* @__PURE__ */ g((r, A) => Object.entries(A).reduce((e, [t, i]) => {
  let o = i.replace(/\\/g, "/").replace(/\$/g, "$$$");
  return e.replace(new RegExp(`{{${t}}}`, "g"), o);
}, r), "interpolate");

// src/common/utils/load-main-config.ts
var CE = require("node:fs/promises"), _r = require("node:path"), to = require("@storybook/core/server-errors");
async function Aw({
  ...
  try {
    ...
    if (t.message.match(/Cannot use import statement outside a module/)) {
      let i = (0, _r.relative)(process.cwd(), e), o = t.stack?.match(new RegExp(`${i}:(\\d+):(\\d+)`))?.[1], s, I;
      if (o) {
        let h = (await (0, CE.readFile)(e, "utf-8")).split(`
`);
        s = parseInt(o, 10) - 1, I = h[s];
      }
      let E = new to.MainFileESMOnlyImportError({
        line: I,
        location: i,
        num: s
      });
    ...
    throw new to.MainFileEvaluationError({
...
var ro = require("node:path"), IE = require("@storybook/core/node-logger"), aE = J(HA(), 1);
function ew({ configDir: r }) {
  let A = ct((0, ro.resolve)(r, "addons")), e = ct((0, ro.resolve)(r, "manager"));
  if ((A || e) && IE.logger.info("=> Loading custom manager config"), A && e)
    throw new Error(aE.dedent`
      You have both a "addons.js" and a "manager.js", remove the "addons.js" file from your configDir (${(0, ro.resolve)(
      r,
      "addons"
    )})`);
  return e || A;
}
g(ew, "loadManagerOrAddonsFile");

// src/common/utils/load-preview-or-config-file.ts
var io = require("node:path"), EE = J(HA(), 1);
function tw({ configDir: r }) {
  let A = ct((0, io.resolve)(r, "config")), e = ct((0, io.resolve)(r, "preview"));
  if (A && e)
    throw new Error(EE.dedent`
      You have both a "config.js" and a "preview.js", remove the "config.js" file from your configDir (${(0, io.resolve)(
      r,
      "config"
    )})`);
  return e || A;
}
g(tw, "loadPreviewOrConfigFile");

// src/common/utils/log.ts
var ut = J(go(), 1);
var so = console, gw = /* @__PURE__ */ g((r) => (process.stdout.write(ut.default.cyan(" \u2022 ") + r), (A, e) => {
  if (A) {
...
function nw(r, A) {
  let e = 0, i = r.map((o) => (e = o.length > e ? o.length : e, o)).map((o) => {
    let s = e - o.length, I = o + ks(" ", s);
    return I = ks(" ", A || 2) + ut.default.inverse(` ${I} `), I;
  }).join(`
`);
  so.log(i);
}
...
var QE = J(go(), 1);
function Cw(r, A) {
  console.log(QE.default.cyan(String(r))), console.dir(A, { depth: null });
}
g(Cw, "logConfig");

// src/common/utils/normalize-stories.ts
var hE = require("node:fs"), ve = require("node:path"), lE = require("@storybook/core/server-errors"), uE = J(Ss(), 1);
var no = "", Iw = "**/*.@(mdx|stories.@(js|jsx|mjs|ts|tsx))", aw = /* @__PURE__ */ g((r, A) => {
  try {
    return (0, hE.lstatSync)((0, ve.resolve)(r, A)).isDirectory();
  } catch {
    return !1;
  }
}, "isDirectory"), fE = /* @__PURE__ */ g(({
  configDir: r,
  workingDir: A,
  directory: e
}) => {
  ...
  return Es(i);
}, "getDirectoryFromWorkingDir"), wE = /* @__PURE__ */ g((r, { configDir: A, workingDir: e, defaultFilesPattern: t = Iw }) => {
  let i;
  if (typeof r == "string") {
    let B = uE.scan(r);
    if (B.isGlob) {
...
}, "normalizeStoriesEntry"), Ew = /* @__PURE__ */ g((r, A) => {
  if (!r || Array.isArray(r) && r.length === 0)
    throw new lE.InvalidStoriesEntryError();
  return r.map((e) => wE(e, A));
}, "normalizeStories");

// src/common/utils/readTemplate.ts
var dE = require("node:fs/promises");
async function cw(r) {
  return (0, dE.readFile)(r, {
    encoding: "utf8"
  });
}
g(cw, "readTemplate");
...
var Cg = require("@storybook/core/csf-tools"), vQ = J(HA(), 1);

// src/common/js-package-manager/JsPackageManagerFactory.ts
var yt = require("node:path"), Ci = J(xs(), 1);

// src/common/js-package-manager/BUNProxy.ts
var Fo = require("node:fs"), hB = require("node:os"), lB = require("node:path"), uB = require("@storybook/core/node-logger"), fB = require("@storybook/core/server-errors");
var wB = J(require("semver/functions/sort.js"), 1), dB = J(HA(), 1);

// src/common/js-package-manager/JsPackageManager.ts
var $t = require("node:fs"), Ko = require("node:fs/promises"), So = require("node:path");

// node_modules/execa/index.js
var gB = require("node:buffer"), sB = J(require("node:path"), 1), yo = J(require("node:child_process"), 1), qr = J(require("node:process"), 1),
nB = J(xs(), 1);
...
g(Ps, "stripFinalNewline");

// node_modules/npm-run-path/index.js
var Tr = J(require("node:process"), 1), Zt = J(require("node:path"), 1), Cc = J(require("node:url"), 1);
...
function xw(r = {}) {
  let {
    ...
    path: e = Tr.default.env[Io()],
    execPath: t = Tr.default.execPath
  } = r, i, o = A instanceof URL ? Cc.default.fileURLToPath(A) : A, s = Zt.default.resolve(o), I = [];
  for (; i !== s; )
    I.push(Zt.default.join(s, "node_modules/.bin")), i = s, s = Zt.default.resolve(s, "..");
  return I.push(Zt.default.resolve(o, t, "..")), [...I, e].join(Zt.default.delimiter);
}
g(xw, "npmRunPath");
function Ic({ env: r = Tr.default.env, ...A } = {}) {
  r = { ...r };
  let e = Io({ env: r });
  return A.path = r[e], r[e] = xw(A), r;
}
g(Ic, "npmRunPathEnv");

// node_modules/mimic-fn/index.js
var Pw = /* @__PURE__ */ g((r, A, e, t) => {
  ...
  !Ow(i, o) && t || Object.defineProperty(r, e, o);
}, "copyProperty"), Ow = /* @__PURE__ */ g(function(r, A) {
...
}, "canCopyProperty"), _w = /* @__PURE__ */ g((r, A) => {
  let e = Object.getPrototypeOf(A);
  e !== Object.getPrototypeOf(r) && Object.setPrototypeOf(r, e);
}, "changePrototype"), Tw = /* @__PURE__ */ g((r, A) => `/* Wrapped ${r}*/
${A}`, "wrappedToString"), Hw = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), jw = Object.getOwnPropertyDescriptor(Function.
prototype.toString, "name"), qw = /* @__PURE__ */ g((r, A, e) => {
  let t = e === "" ? "" : `with ${e.trim()}() `, i = Tw.bind(null, t, A.toString());
  Object.defineProperty(i, "name", jw), Object.defineProperty(r, "toString", { ...Hw, value: i });
}, "changeToString");
function Os(r, A, { ignoreNonConfigurable: e = !1 } = {}) {
  let { name: t } = r;
  for (let i of Reflect.ownKeys(A))
    Pw(r, A, i, e);
  return _w(r, A), qw(r, A, t), r;
}
g(Os, "mimicFunction");

// node_modules/onetime/index.js
var ao = /* @__PURE__ */ new WeakMap(), ac = /* @__PURE__ */ g((r, A = {}) => {
  if (typeof r != "function")
...
var fc = J(require("node:process"), 1);
...
var cc = /* @__PURE__ */ g(() => {
  let r = _s - Bc + 1;
  return Array.from({ length: r }, zw);
}, "getRealtimeSignals"), zw = /* @__PURE__ */ g((r, A) => ({
  name: `SIGRT${A + 1}`,
  number: Bc + A,
  action: "terminate",
  description: "Application-specific signal (realtime)",
  standard: "posix"
}), "getRealtimeSignal"), Bc = 34, _s = 64;

// node_modules/human-signals/build/src/signals.js
var hc = require("node:os");
...
var Xw = /* @__PURE__ */ g(() => {
  let r = Ts();
  return Object.fromEntries(r.map(Vw));
}, "getSignalsByName"), Vw = /* @__PURE__ */ g(({
  name: r,
  number: A,
  description: e,
  supported: t,
  ...
  forced: o,
  standard: s
}) => [r, { name: r, number: A, description: e, supported: t, action: i, forced: o, standard: s }], "getSignalByName"), uc = Xw(), Zw = /* @__PURE__ */ g(
() => {
  let r = Ts(), A = _s + 1, e = Array.from(
    { length: A },
    (t, i) => $w(i, r)
  );
  return Object.assign({}, ...e);
}, "getSignalsByNumber"), $w = /* @__PURE__ */ g((r, A) => {
  let e = Ad(r, A);
  if (e === void 0)
    return {};
...
}, "getSignalByNumber"), Ad = /* @__PURE__ */ g((r, A) => {
  let e = A.find(({ name: t }) => lc.constants.signals[t] === r);
  return e !== void 0 ? e : A.find((t) => t.number === r);
}, "findSignalByNumber"), tM = Zw();

// node_modules/execa/lib/error.js
var ed = /* @__PURE__ */ g(({ timedOut: r, timeout: A, errorCode: e, signal: t, signalDescription: i, exitCode: o, isCanceled: s }) => r ? `\
...
o !== void 0 ? `failed with exit code ${o}` : "failed", "getErrorPrefix"), Hr = /* @__PURE__ */ g(({
  ...
  isCanceled: B,
  killed: h,
  parsed: { options: { timeout: u, cwd: f = fc.default.cwd() } }
}) => {
  o = o === null ? void 0 : o, i = i === null ? void 0 : i;
  let p = i === void 0 ? void 0 : uc[i].description, m = t && t.code, U = `Command ${ed({ timedOut: E, timeout: u, errorCode: m, signal: i, signalDescription: p,
...
var Eo = ["stdin", "stdout", "stderr"], td = /* @__PURE__ */ g((r) => Eo.some((A) => r[A] !== void 0), "hasAlias"), wc = /* @__PURE__ */ g((r) => {
  if (!r)
    return;
  let { stdio: A } = r;
  if (A === void 0)
    return Eo.map((t) => r[t]);
  if (td(r))
    throw new Error(`It's not possible to provide \`stdio\` in combination with one of ${Eo.map((t) => `\`${t}\``).join(", ")}`);
  if (typeof A == "string")
    return A;
  if (!Array.isArray(A))
    throw new TypeError(`Expected \`stdio\` to be of type \`string\` or \`Array\`, got \`${typeof A}\``);
  let e = Math.max(A.length, Eo.length);
  return Array.from({ length: e }, (t, i) => A[i]);
}, "normalizeStdio");

// node_modules/execa/lib/kill.js
var pc = J(require("node:os"), 1);
...
var co = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && typeof r.removeListener == "function" && typeof r.emit == "function" && typeof r.
reallyExit == "function" && typeof r.listeners == "function" && typeof r.kill == "function" && typeof r.pid == "number" && typeof r.on == "f\
unction", "processOk"), Hs = Symbol.for("signal-exit emitter"), js = globalThis, rd = Object.defineProperty.bind(Object), qs = class {
  static {
    g(this, "Emitter");
  }
  emitted = {
...
}), "signalExitWrap"), zs = class extends Bo {
  static {
  ...
  /* c8 ignore start */
  #A = Xs.platform === "win32" ? "SIGINT" : "SIGHUP";
  /* c8 ignore stop */
  #e = new qs();
  #t;
  #r;
  ...
  #a(A) {
    return co(this.#t) ? (this.#t.exitCode = A || 0, this.#e.emit("exit", this.#t.exitCode, null), this.#g.call(this.#t, this.#t.exitCode)) :
    0;
  }
  #n(A, ...e) {
    let t = this.#r;
   ...
   */
  unload: cM
} = id(co(Xs) ? new Ws(Xs) : new zs());

// node_modules/execa/lib/kill.js
var od = 1e3 * 5, mc = /* @__PURE__ */ g((r, A = "SIGTERM", e = {}) => {
  let t = r(A);
  return gd(r, A, e, t), t;
}, "spawnedKill"), gd = /* @__PURE__ */ g((r, A, e, t) => {
  if (!sd(A, e, t))
    return;
  let i = Cd(e), o = setTimeout(() => {
    r("SIGKILL");
  }, i);
  o.unref && o.unref();
}, "setKillTimeout"), sd = /* @__PURE__ */ g((r, { forceKillAfterTimeout: A }, e) => nd(r) && A !== !1 && e, "shouldForceKill"), nd = /* @__PURE__ */ g(
(r) => r === pc.default.constants.signals.SIGTERM || typeof r == "string" && r.toUpperCase() === "SIGTERM", "isSigterm"), Cd = /* @__PURE__ */ g(
({ forceKillAfterTimeout: r = !0 }) => {
  ...
  return r;
}, "getForceKillAfterTimeout"), yc = /* @__PURE__ */ g((r, A) => {
  r.kill() && (A.isCanceled = !0);
}, "spawnedCancel"), Id = /* @__PURE__ */ g((r, A, e) => {
  r.kill(A), e(Object.assign(new Error("Timed out"), { timedOut: !0, signal: A }));
}, "timeoutKill"), Dc = /* @__PURE__ */ g((r, { timeout: A, killSignal: e = "SIGTERM" }, t) => {
  if (A === 0 || A === void 0)
    return t;
...
}, "setupTimeout"), Kc = /* @__PURE__ */ g(({ timeout: r }) => {
...
}, "validateTimeout"), Sc = /* @__PURE__ */ g(async (r, { cleanup: A, detached: e }, t) => {
  if (!A || e)
    return t;
  let i = dc(() => {
    r.kill();
...
var Fc = require("node:fs"), Nc = require("node:child_process");
...
g(Qo, "isStream");
function Vs(r) {
  return Qo(r) && r.writable !== !1 && typeof r._write == "function" && typeof r._writableState == "object";
}
g(Vs, "isWritableStream");

// node_modules/execa/lib/pipe.js
var ad = /* @__PURE__ */ g((r) => r instanceof Nc.ChildProcess && typeof r.then == "function", "isExecaChildProcess"), Zs = /* @__PURE__ */ g(
(r, A, e) => {
  if (typeof e == "string")
    return r[A].pipe((0, Fc.createWriteStream)(e)), r;
  if (Vs(e))
    return r[A].pipe(e), r;
  if (!ad(e))
...
}, "pipeToTarget"), kc = /* @__PURE__ */ g((r) => {
  r.stdout !== null && (r.pipeStdout = Zs.bind(void 0, r, "stdout")), r.stderr !== null && (r.pipeStderr = Zs.bind(void 0, r, "stderr")), r.
  all !== void 0 && (r.pipeAll = Zs.bind(void 0, r, "all"));
}, "addPipeMethods");

// node_modules/execa/lib/stream.js
var po = require("node:fs"), Oc = require("node:timers/promises");

// node_modules/get-stream/source/contents.js
var jr = /* @__PURE__ */ g(async (r, { init: A, convertChunk: e, getSize: t, truncateChunk: i, addChunk: o, getFinalChunk: s, finalize: I }, {
maxBuffer: E = Number.POSITIVE_INFINITY } = {}) => {
  ...
  try {
    for await (let h of r) {
      let u = Bd(h), f = e[u](h, B);
      bc({ convertedChunk: f, state: B, getSize: t, truncateChunk: i, addChunk: o, maxBuffer: E });
    }
    return Ed({ state: B, convertChunk: e, getSize: t, truncateChunk: i, addChunk: o, getFinalChunk: s, maxBuffer: E }), I(B);
  } catch (h) {
    throw h.bufferedData = I(B), h;
  }
}, "getStreamContents"), Ed = /* @__PURE__ */ g(({ state: r, getSize: A, truncateChunk: e, addChunk: t, getFinalChunk: i, maxBuffer: o }) => {
  let s = i(r);
  s !== void 0 && bc({ convertedChunk: s, state: r, getSize: A, truncateChunk: e, addChunk: t, maxBuffer: o });
}, "appendFinalChunk"), bc = /* @__PURE__ */ g(({ convertedChunk: r, state: A, getSize: e, truncateChunk: t, addChunk: i, maxBuffer: o }) => {
  ...
  throw E !== void 0 && Mc(E, A, i, o), new ho();
}, "appendChunk"), Mc = /* @__PURE__ */ g((r, A, e, t) => {
  A.contents = e(r, A, t), A.length = t;
}, "addNewChunk"), cd = /* @__PURE__ */ g((r) => typeof r == "object" && r !== null && typeof r[Symbol.asyncIterator] == "function", "isAsyn\
cIterable"), Bd = /* @__PURE__ */ g((r) => {
  let A = typeof r;
  if (A === "string")
    return "string";
  if (A !== "object" || r === null)
  ...
  r.byteOffset) && Rc.call(r.buffer) === "[object ArrayBuffer]" ? "typedArray" : "others";
}, "getChunkType"), { toString: Rc } = Object.prototype, ho = class extends Error {
  static {
...
var $s = /* @__PURE__ */ g((r) => r, "identity"), An = /* @__PURE__ */ g(() => {
}, "noop"), en = /* @__PURE__ */ g(({ contents: r }) => r, "getContentsProp"), lo = /* @__PURE__ */ g((r) => {
  throw new Error(`Streams in object mode are not supported: ${String(r)}`);
}, "throwObjectStream"), uo = /* @__PURE__ */ g((r) => r.length, "getLengthProp");

// node_modules/get-stream/source/array-buffer.js
async function tn(r, A) {
  return jr(r, md, A);
}
g(tn, "getStreamAsArrayBuffer");
var Qd = /* @__PURE__ */ g(() => ({ contents: new ArrayBuffer(0) }), "initArrayBuffer"), hd = /* @__PURE__ */ g((r) => ld.encode(r), "useTex\
tEncoder"), ld = new TextEncoder(), Lc = /* @__PURE__ */ g((r) => new Uint8Array(r), "useUint8Array"), Yc = /* @__PURE__ */ g((r) => new Uint8Array(
r.buffer, r.byteOffset, r.byteLength), "useUint8ArrayWithOffset"), ud = /* @__PURE__ */ g((r, A) => r.slice(0, A), "truncateArrayBufferChunk"),
fd = /* @__PURE__ */ g((r, { contents: A, length: e }, t) => {
  let i = Jc() ? dd(A, t) : wd(A, t);
  return new Uint8Array(i).set(r, e), i;
}, "addArrayBufferChunk"), wd = /* @__PURE__ */ g((r, A) => {
  if (A <= r.byteLength)
    return r;
  let e = new ArrayBuffer(Gc(A));
  return new Uint8Array(e).set(new Uint8Array(r), 0), e;
}, "resizeArrayBufferSlow"), dd = /* @__PURE__ */ g((r, A) => {
  if (A <= r.maxByteLength)
    return r.resize(A), r;
  let e = new ArrayBuffer(A, { maxByteLength: Gc(A) });
  return new Uint8Array(e).set(new Uint8Array(r), 0), e;
}, "resizeArrayBuffer"), Gc = /* @__PURE__ */ g((r) => Uc ** Math.ceil(Math.log(r) / Math.log(Uc)), "getNewContentsLength"), Uc = 2, pd = /* @__PURE__ */ g(
({ contents: r, length: A }) => Jc() ? r : r.slice(0, A), "finalizeArrayBuffer"), Jc = /* @__PURE__ */ g(() => "resize" in ArrayBuffer.prototype,
...
async function fo(r, A) {
  if (!("Buffer" in globalThis))
    throw new Error("getStreamAsBuffer() is only supported in Node.js");
  try {
    return vc(await tn(r, A));
  } catch (e) {
    throw e.bufferedData !== void 0 && (e.bufferedData = vc(e.bufferedData)), e;
  }
}
g(fo, "getStreamAsBuffer");
var vc = /* @__PURE__ */ g((r) => globalThis.Buffer.from(r), "arrayBufferToNodeBuffer");

// node_modules/get-stream/source/string.js
async function rn(r, A) {
  return jr(r, Fd, A);
}
g(rn, "getStreamAsString");
var yd = /* @__PURE__ */ g(() => ({ contents: "", textDecoder: new TextDecoder() }), "initString"), wo = /* @__PURE__ */ g((r, { textDecoder: A }) => A.
decode(r, { stream: !0 }), "useTextDecoder"), Dd = /* @__PURE__ */ g((r, { contents: A }) => A + r, "addStringChunk"), Kd = /* @__PURE__ */ g(
(r, A) => r.slice(0, A), "truncateStringChunk"), Sd = /* @__PURE__ */ g(({ textDecoder: r }) => {
  let A = r.decode();
  return A === "" ? void 0 : A;
...
}, "validateInputOptions"), kd = /* @__PURE__ */ g(({ input: r, inputFile: A }) => typeof A != "string" ? r : (Tc(r), (0, po.readFileSync)(A)),
"getInputSync"), Hc = /* @__PURE__ */ g((r) => {
  let A = kd(r);
  if (Qo(A))
    throw new TypeError("The `input` option cannot be a stream in sync mode");
  return A;
}, "handleInputSync"), Md = /* @__PURE__ */ g(({ input: r, inputFile: A }) => typeof A != "string" ? r : (Tc(r), (0, po.createReadStream)(A)),
"getInput"), jc = /* @__PURE__ */ g((r, A) => {
  let e = Md(A);
  e !== void 0 && (Qo(e) ? e.pipe(r.stdin) : r.stdin.end(e));
}, "handleInput"), qc = /* @__PURE__ */ g((r, { all: A }) => {
  if (!A || !r.stdout && !r.stderr)
    return;
  let e = (0, _c.default)();
  return r.stdout && e.add(r.stdout), r.stderr && e.add(r.stderr), e;
}, "makeAllStream"), on = /* @__PURE__ */ g(async (r, A) => {
  if (!(!r || A === void 0)) {
    await (0, Oc.setTimeout)(0), r.destroy();
    try {
      return await A;
    } catch (e) {
...
}, "getBufferedData"), gn = /* @__PURE__ */ g((r, { encoding: A, buffer: e, maxBuffer: t }) => {
  if (!(!r || !e))
    return A === "utf8" || A === "utf-8" ? rn(r, { maxBuffer: t }) : A === null || A === "buffer" ? fo(r, { maxBuffer: t }) : Rd(r, t, A);
}, "getStreamPromise"), Rd = /* @__PURE__ */ g(async (r, A, e) => (await fo(r, { maxBuffer: A })).toString(e), "applyEncoding"), zc = /* @__PURE__ */ g(
async ({ stdout: r, stderr: A, all: e }, { encoding: t, buffer: i, maxBuffer: o }, s) => {
  let I = gn(r, { encoding: t, buffer: i, maxBuffer: o }), E = gn(A, { encoding: t, buffer: i, maxBuffer: o }), B = gn(e, { encoding: t, buffer: i,
  maxBuffer: o * 2 });
  try {
...
var bd = (async () => {
})().constructor.prototype, Ld = ["then", "catch", "finally"].map((r) => [
  r,
  Reflect.getOwnPropertyDescriptor(bd, r)
]), sn = /* @__PURE__ */ g((r, A) => {
  for (let [e, t] of Ld) {
    let i = typeof A == "function" ? (...o) => Reflect.apply(t.value, A(), o) : t.value.bind(A);
    Reflect.defineProperty(r, e, { ...t, value: i });
  }
}, "mergePromise"), Wc = /* @__PURE__ */ g((r) => new Promise((A, e) => {
  r.on("exit", (t, i) => {
...
var Zc = require("node:buffer"), $c = require("node:child_process");
var AB = /* @__PURE__ */ g((r, A = []) => Array.isArray(A) ? [r, ...A] : [r], "normalizeArgs"), Yd = /^[\w.-]+$/, Ud = /* @__PURE__ */ g((r) => typeof r !=
"string" || Yd.test(r) ? r : `"${r.replaceAll('"', '\\"')}"`, "escapeArg"), nn = /* @__PURE__ */ g((r, A) => AB(r, A).join(" "), "joinComman\
d"), Cn = /* @__PURE__ */ g((r, A) => AB(r, A).map((e) => Ud(e)).join(" "), "getEscapedCommand"), eB = / +/g, In = /* @__PURE__ */ g((r) => {
  let A = [];
  for (let e of r.trim().split(eB)) {
    let t = A.at(-1);
    t && t.endsWith("\\") ? A[A.length - 1] = `${t.slice(0, -1)} ${e}` : A.push(e);
  }
  return A;
}, "parseCommand"), Xc = /* @__PURE__ */ g((r) => {
  let A = typeof r;
  if (A === "string")
    return r;
  if (A === "number")
    return String(r);
  if (A === "object" && r !== null && !(r instanceof $c.ChildProcess) && "stdout" in r) {
    let e = typeof r.stdout;
    if (e === "string")
      return r.stdout;
    if (Zc.Buffer.isBuffer(r.stdout))
...
}, "parseExpression"), Vc = /* @__PURE__ */ g((r, A, e) => e || r.length === 0 || A.length === 0 ? [...r, ...A] : [
  ...r.slice(0, -1),
  `${r.at(-1)}${A[0]}`,
  ...A.slice(1)
], "concatTokens"), Gd = /* @__PURE__ */ g(({ templates: r, expressions: A, tokens: e, index: t, template: i }) => {
  let o = i ?? r.raw[t], s = o.split(eB).filter(Boolean), I = Vc(
    e,
    s,
    o.startsWith(" ")
  );
  if (t === A.length)
    return I;
  let E = A[t], B = Array.isArray(E) ? E.map((h) => Xc(h)) : [Xc(E)];
  return Vc(
    I,
    B,
    o.endsWith(" ")
  );
}, "parseTemplate"), an = /* @__PURE__ */ g((r, A) => {
  let e = [];
  for (let [t, i] of r.entries())
    e = Gd({ templates: r, expressions: A, tokens: e, index: t, template: i });
  return e;
}, "parseTemplates");

// node_modules/execa/lib/verbose.js
var tB = require("node:util"), rB = J(require("node:process"), 1);
var iB = (0, tB.debuglog)("execa").enabled, mo = /* @__PURE__ */ g((r, A) => String(r).padStart(A, "0"), "padField"), Jd = /* @__PURE__ */ g(
() => {
  let r = /* @__PURE__ */ new Date();
  return `${mo(r.getHours(), 2)}:${mo(r.getMinutes(), 2)}:${mo(r.getSeconds(), 2)}.${mo(r.getMilliseconds(), 3)}`;
}, "getTimestamp"), En = /* @__PURE__ */ g((r, { verbose: A }) => {
  A && rB.default.stderr.write(`[${Jd()}] ${r}
`);
}, "logCommand");

// node_modules/execa/index.js
var vd = 1e3 * 1e3 * 100, xd = /* @__PURE__ */ g(({ env: r, extendEnv: A, preferLocal: e, localDir: t, execPath: i }) => {
  let o = A ? { ...qr.default.env, ...r } : r;
  return e ? Ic({ env: o, cwd: t, execPath: i }) : o;
}, "getEnv"), CB = /* @__PURE__ */ g((r, A, e = {}) => {
  let t = nB.default._parse(r, A, e);
  return r = t.command, A = t.args, e = t.options, e = {
    ...
    verbose: iB,
    ...e
  }, e.env = xd(e), e.stdio = wc(e), qr.default.platform === "win32" && sB.default.basename(r, ".exe") === "cmd" && A.unshift("/q"), { file: r,
  args: A, options: e, parsed: t };
}, "handleArguments"), zr = /* @__PURE__ */ g((r, A, e) => typeof A != "string" && !gB.Buffer.isBuffer(A) ? e === void 0 ? void 0 : "" : r.stripFinalNewline ?
Ps(A) : A, "handleOutput");
function IB(r, A, e) {
  let t = CB(r, A, e), i = nn(r, A), o = Cn(r, A);
  En(o, t.options), Kc(t.options);
  let s;
  try {
    s = yo.default.spawn(t.file, t.args, t.options);
  } catch (p) {
    let m = new yo.default.ChildProcess(), D = Promise.reject(Hr({
      error: p,
      stdout: "",
      stderr: "",
      all: "",
  ...
  let I = Wc(s), E = Dc(s, t.options, I), B = Sc(s, t.options, E), h = { isCanceled: !1 };
  s.kill = mc.bind(null, s.kill.bind(s)), s.cancel = yc.bind(null, s, h);
  let f = Ec(/* @__PURE__ */ g(async () => {
    let [{ error: p, exitCode: m, signal: D, timedOut: U }, R, T, M] = await zc(s, t.options, B), x = zr(t.options, R), V = zr(t.options, T),
    gA = zr(t.options, M);
    if (p || m !== 0 || D !== null) {
      let sA = Hr({
        error: p,
  ...
  return jc(s, t.options), s.all = qc(s, t.options), kc(s), sn(s, f), s;
}
g(IB, "execa");
function aB(r, A, e) {
  let t = CB(r, A, e), i = nn(r, A), o = Cn(r, A);
  En(o, t.options);
  let s = Hc(t.options), I;
  try {
    I = yo.default.spawnSync(t.file, t.args, { ...t.options, input: s });
  } catch (h) {
    throw Hr({
      error: h,
      stdout: "",
  ...
  let E = zr(t.options, I.stdout, I.error), B = zr(t.options, I.stderr, I.error);
...
g(aB, "execaSync");
var Pd = /* @__PURE__ */ g(({ input: r, inputFile: A, stdio: e }) => r === void 0 && A === void 0 && e === void 0 ? { stdin: "inherit" } : {},
"normalizeScriptStdin"), oB = /* @__PURE__ */ g((r = {}) => ({
  preferLocal: !0,
  ...Pd(r),
  ...r
...
g(BB, "execaCommandSync");

// src/common/js-package-manager/JsPackageManager.ts
var Bn = J(go(), 1), Wr = require("semver");

// ../node_modules/tiny-invariant/dist/esm/tiny-invariant.js
var Od = process.env.NODE_ENV === "production", cn = "Invariant failed";
function Do(r, A) {
  if (!r) {
    if (Od)
      throw new Error(cn);
    var e = typeof A == "function" ? A() : A, t = e ? "".concat(cn, ": ").concat(e) : cn;
    throw new Error(t);
  }
}
g(Do, "invariant");
    ...
    for (; ; ) {
      try {
        ...
        if ((0, $t.existsSync)(t) || (0, $t.existsSync)(i))
          return !0;
        let o = require.resolve(`${A}/package.json`), s = (0, $t.readFileSync)(o, "utf8");
        if (JSON.parse(s).workspaces)
          return !0;
      } catch {
      }
      let e = (0, So.dirname)(A);
      if (e === A)
        break;
      A = e;
    }
...
`;
    await (0, Ko.writeFile)(this.packageJsonPath(), t, "utf8");
  }
  /**
...
An error occurred while installing dependencies:`), xe.log(i.message), new et(i);
  ...
  async removeDependencies(A, e) {
    ...
    if (t) {
      let { packageJson: i } = A;
      Do(i, "Missing packageJson."), e.forEach((o) => {
  ...
  getVersionedPackages(A) {
    return Promise.all(
      A.map(async (e) => {
        let [t, i] = Qn(e), o = await this.latestVersion(t, i), I = ze[t];
  ...
  async getVersion(A, e) {
    ...
    try {
      ...
      if (t)
        return xe.warn(`
     ${Bn.default.yellow(String(s))}`), t;
      throw xe.error(`
     ${Bn.default.red(String(s))}`), new et(s);
    }
...
var _d = /npm ERR! code (\w+)/, Td = {
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ne(
      (s) => {
        let I = (0, lB.join)(s, "node_modules", e, "package.json");
        return (0, Fo.existsSync)(I) ? I : void 0;
      },
      { cwd: t }
    );
  ...
  async findInstallations(e, { depth: t = 99 } = {}) {
    let i = /* @__PURE__ */ g(async ({ packageDepth: o }) => {
      let s = (0, hB.platform)() === "win32" ? "2>NUL" : "2>/dev/null";
      return this.executeCommand({
        command: "npm",
    ...
    try {
      ...
      try {
        ...
        uB.logger.warn("An issue occurred while trying to find dependencies metadata using npm.");
        return;
      }
    }
  }
  ...
  async runGetVersions(e, t) {
    ...
    try {
      ...
      throw new fB.FindPackageVersionsError({
        error: o,
        packageManager: "NPM",
        packageName: e
      });
  ...
  mapDependencies(e, t) {
    let i = {}, o = {}, s = {}, I = /* @__PURE__ */ g(([E, B]) => {
      ...
      o[E]?.includes(h.version) || (i[E] ? i[E].push(h) : i[E] = [h], o[E] = (0, wB.default)([...o[E] || [], h.version]), o[E].length > 1 &&
...
var No = require("node:fs"), pB = require("node:os"), mB = require("node:path"), yB = require("@storybook/core/node-logger"), DB = require("@storybook/core/server-errors");
var KB = J(require("semver/functions/sort.js"), 1), SB = J(HA(), 1);
var Hd = /npm (ERR!|error) (code|errno) (\w+)/i, jd = {
  E401: "Authentication failed or is required.",
  E403: "Access to the resource is forbidden.",
  E404: "Requested resource not found.",
  EACCES: "Permission issue.",
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ne(
      (s) => {
        ...
        return (0, No.existsSync)(I) ? I : void 0;
      },
      { cwd: t }
    );
    return i ? JSON.parse((0, No.readFileSync)(i, "utf-8")) : null;
  }
  getInstallArgs() {
    return this.installArgs || (this.installArgs = []), this.installArgs;
  }
  ...
  async findInstallations(e, { depth: t = 99 } = {}) {
    let i = /* @__PURE__ */ g(async ({ packageDepth: o }) => {
      let s = (0, pB.platform)() === "win32" ? "2>NUL" : "2>/dev/null";
      return this.executeCommand({
        command: "npm",
        args: ["ls", "--json", `--depth=${o}`, s],
        env: {
    ...
    try {
      ...
      try {
        ...
        yB.logger.warn("An issue occurred while trying to find dependencies metadata using npm.");
        return;
      }
    }
  }
  ...
  async runGetVersions(e, t) {
    ...
    try {
      ...
      throw new DB.FindPackageVersionsError({
        error: o,
        packageManager: "NPM",
        packageName: e
      });
  ...
  mapDependencies(e, t) {
    let i = {}, o = {}, s = {}, I = /* @__PURE__ */ g(([E, B]) => {
      ...
      o[E]?.includes(h.version) || (i[E] ? i[E].push(h) : i[E] = [h], o[E] = (0, KB.default)([...o[E] || [], h.version]), o[E].length > 1 &&
      (s[E] = o[E])), B.dependencies && Object.entries(B.dependencies).forEach(I);
    }, "recurse");
    return Object.entries(e.dependencies).forEach(I), {
      dependencies: i,
...
var er = require("node:fs"), hn = require("node:path"), FB = require("@storybook/core/server-errors");
var NB = J(HA(), 1);
var qd = /(ELIFECYCLE|ERR_PNPM_[A-Z_]+)\s+(.*)/i, Vr = class extends ee {
  constructor() {
    super(...arguments);
    this.type = "pnpm";
  }
  ...
  async getPackageJSON(e, t = this.cwd) {
    ...
    if (i)
      try {
        ...
        return JSON.parse(
          (0, er.readFileSync)((0, hn.join)(B.packageLocation, "package.json"), "utf-8")
        );
      } catch (s) {
    ...
    let o = await PA(
      (s) => {
        let I = (0, hn.join)(s, "node_modules", e, "package.json");
...
var Mo = require("node:fs"), kB = require("node:path"), MB = require("@storybook/core/server-errors");
var RB = J(HA(), 1);
...
// src/common/js-package-manager/Yarn1Proxy.ts
var zd = /^error\s(.*)$/gm, Zr = class extends ee {
  constructor() {
    super(...arguments);
    this.type = "yarn1";
  }
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ne(
      (o) => {
        let s = (0, kB.join)(o, "node_modules", e, "package.json");
        return (0, Mo.existsSync)(s) ? s : void 0;
      },
      { cwd: t }
    );
  ...
  mapDependencies(e, t) {
    if (e.type === "tree") {
      let { trees: i } = e.data, o = {}, s = {}, I = {}, E = /* @__PURE__ */ g((B) => {
        let { children: h } = B, { name: u, value: f } = ko(B.name);
...
var sg = require("node:fs"), oC = require("node:path"), RQ = require("@storybook/core/server-errors"), nr = J(dQ(), 1), bQ = J(kQ(), 1);
var LQ = J(HA(), 1);
var MQ = {
  YN0001: "EXCEPTION",
  ...
  async getPackageJSON(e, t = this.cwd) {
    ...
    if (i)
      try {
        let I = require(i), E = await I.resolveToUnqualified(e, t, {
          considerBuiltins: !1
        }), B = I.findPackageLocator(E), h = I.getPackageInformation(B), u = new nr.ZipOpenFS({
          libzip: (0, bQ.getLibzipSync)()
        }), f = new nr.VirtualFS({ baseFs: u }), p = new nr.PosixFS(f), m = (0, oC.join)(h.packageLocation, "package.json");
    ...
    let o = await Ne(
      (I) => {
        let E = (0, oC.join)(I, "node_modules", e, "package.json");
        return (0, sg.existsSync)(E) ? E : void 0;
      },
      { cwd: t }
    );
    return o ? JSON.parse((0, sg.readFileSync)(o, "utf-8")) : null;
  }
  getResolutions(e, t) {
    return {
      resolutions: {
  ...
  async runGetVersions(e, t) {
    ...
    try {
      ...
      throw new RQ.FindPackageVersionsError({
        error: s,
...
`), o = {}, s = {}, I = {};
    return i.forEach((E) => {
      if (!E || !t.some((u) => new RegExp(`${u.replace(/\*/g, ".*")}`).test(E)))
        return;
      let { name: B, value: h } = ko(E.replaceAll('"', ""));
...
// src/common/js-package-manager/JsPackageManagerFactory.ts
var YQ = "package-lock.json", UQ = "pnpm-lock.yaml", GQ = "yarn.lock", JQ = "bun.lockb", ni = class {
  static {
  ...
  static getPackageManager({ force: A } = {}, e) {
    ...
    })[0], o = i && (0, yt.basename)(i), s = Ky(e), I = Fy(e), E = Sy(e), B = Ny(e);
    if (B && (o === GQ || !s && !I))
      return B === 1 ? new Zr({ cwd: e }) : new si({ cwd: e });
    if (I && o === UQ)
      return new Vr({ cwd: e });
    if (s && o === YQ)
      return new Ar({ cwd: e });
...
async function ky(r, A = {}) {
  let { packageManager: e } = A, t = ni.getPackageManager({ force: e }, A.cwd), i = await t.retrievePackageJson(), { mainConfig: o, configDir: s,
  ...I } = os(i, A.configDir);
  if (typeof s > "u")
    ...
    `);
  if (!o) {
    ng.error("Unable to find storybook main.js config");
    return;
  }
  let E = await (0, Cg.readConfig)(o);
  ng.log(`Uninstalling ${r}`), await t.removeDependencies({ packageJson: i }, [r]), ng.log(`Removing '${r}' from main.js addons field.`);
  try {
    E.removeEntryFromArray(["addons"], r), await (0, Cg.writeConfig)(E);
  } catch {
    ng.warn(`Failed to remove '${r}' from main.js addons field.`);
  }
}
g(ky, "removeAddon");
...
g(My, "isPreservingSymlinks");

// src/common/utils/template.ts
var It = require("node:fs"), Cr = require("node:path");
var xQ = /* @__PURE__ */ g((r, A = {}) => Object.entries(A).reduce((e, [t, i]) => e.replace(new RegExp(`%${t}%`, "g"), i), r), "interpolate");
function Ry(r, A) {
...
tml`, "utf8"), i = (0, Cr.resolve)(r, "preview-body.html"), o = t;
  return (0, It.existsSync)(i) && (o = (0, It.readFileSync)(i, "utf8") + o), xQ(o, A);
}
g(Ry, "getPreviewBodyTemplate");
function by(r, A) {
...
tml`, "utf8"), i = (0, Cr.resolve)(r, "preview-head.html"), o = t;
  return (0, It.existsSync)(i) && (o += (0, It.readFileSync)(i, "utf8")), xQ(o, A);
}
g(by, "getPreviewHeadTemplate");

// src/common/utils/validate-config.ts
var OQ = require("node:path"), Ir = require("@storybook/core/server-errors");
var PQ = ["html", "preact", "react", "server", "svelte", "vue", "vue3", "web-components"], Ly = [...PQ, ...PQ.map((r) => `@storybook/${r}`)];
function Yy(r) {
  if (!r)
  ...
  if (!Object.keys(ht).includes(r))
    try {
      require.resolve((0, OQ.join)(r, "preset"));
    } catch {
      throw new Ir.CouldNotEvaluateFrameworkError({ frameworkName: r });
    }
}
g(Yy, "validateFrameworkName");
...
g(_Q, "getPrettier");
async function Gy(r, A) {
  try {
    let { resolveConfig: e, format: t } = await _Q(), i = await e(r);
...
g(Gy, "formatFileContent");
async function Jy(r, A) {
  let { resolveConfig: e, format: t } = await _Q(), i = await e(r, { editorconfig: !0 });
...
var TQ = require("node:path"), ag = require("@storybook/core/common"), ar = require("@storybook/csf"), HQ = require("@storybook/core/preview-api"),
jQ = J(HA(), 1);

// src/common/utils/posix.ts
var Ig = require("node:path");
var gC = /* @__PURE__ */ g((r, A = Ig.sep) => r.split(A).filter(Boolean).join(Ig.posix.sep), "posix");

// src/common/utils/get-story-id.ts
async function vy(r, A) {
  let e = await A.presets.apply("stories", [], A), t = qQ({
    ...r,
    stories: e,
  ...
  if (t === void 0)
    ...
    `);
  let i = (0, ar.storyNameFromExport)(r.exportedStoryName), o = (0, ar.toId)(t, i), s = (0, ar.sanitize)(t);
...
function qQ({
  ...
  let o = (0, ag.normalizeStories)(e, {
    configDir: A,
    workingDir: t
  }), s = (0, TQ.relative)(t, r), I = gC((0, ag.normalizeStoryPath)(s));
  return o.map((E) => (0, HQ.userOrAutoTitleFromSpecifier)(I, E, i)).filter(Boolean)[0];
}
g(qQ, "getStoryTitle");
