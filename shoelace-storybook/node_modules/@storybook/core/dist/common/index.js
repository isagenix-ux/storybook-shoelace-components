...
var EQ = Object.getOwnPropertyDescriptor;
var cQ = Object.getOwnPropertyNames;
var BQ = Object.getPrototypeOf, QQ = Object.prototype.hasOwnProperty;
...
var dn = (r, A) => () => (r && (A = r(r = 0)), A);
var j = (r, A) => () => (A || r((A = { exports: {} }).exports, A), A.exports), pn = (r, A) => {
  for (var e in A)
    zt(r, e, { get: A[e], enumerable: !0 });
}, mn = (r, A, e, t) => {
  if (A && typeof A == "object" || typeof A == "function")
    for (let i of cQ(A))
      !QQ.call(r, i) && i !== e && zt(r, i, { get: () => A[i], enumerable: !(t = EQ(A, i)) || t.enumerable });
  return r;
};
var IA = (r, A, e) => (e = r != null ? aQ(BQ(r)) : {}, mn(
  ...
  r
)), Ie = (r) => mn(zt({}, "__esModule", { value: !0 }), r);
...
var bn = j((IK, Rn) => {
  ...
  Rn.exports = kn;
  function kn(r, A, e) {
    r instanceof RegExp && (r = Nn(r, e)), A instanceof RegExp && (A = Nn(A, e));
    var t = Mn(r, A, e);
    return t && {
      start: t[0],
      end: t[1],
...
var Pn = j((EK, xn) => {
  var Ln = bn();
  xn.exports = wQ;
  var Yn = "\0SLASH" + Math.random() + "\0", Un = "\0OPEN" + Math.random() + "\0", bo = "\0CLOSE" + Math.random() + "\0", Gn = "\0COMMA" + Math.
  random() + "\0", Jn = "\0PERIOD" + Math.random() + "\0";
  function Ro(r) {
    return parseInt(r, 10) == r ? parseInt(r, 10) : r.charCodeAt(0);
  }
  g(Ro, "numeric");
  function uQ(r) {
    return r.split("\\\\").join(Yn).split("\\{").join(Un).split("\\}").join(bo).split("\\,").join(Gn).split("\\.").join(Jn);
  }
  g(uQ, "escapeBraces");
  function fQ(r) {
    return r.split(Yn).join("\\").split(Un).join("{").split(bo).join("}").split(Gn).join(",").split(Jn).join(".");
  }
  g(fQ, "unescapeBraces");
  function vn(r) {
    if (!r)
  ...
  g(vn, "parseCommaParts");
  function wQ(r) {
    return r ? (r.substr(0, 2) === "{}" && (r = "\\{\\}" + r.substr(2)), Zt(uQ(r), !0).map(fQ)) : [];
  }
  g(wQ, "expandTop");
  function dQ(r) {
    return "{" + r + "}";
  ...
  function Zt(r, A) {
    ...
    if (/\$$/.test(t.pre))
      ...
      indexOf(",") >= 0;
      if (!h && !u)
        return t.post.match(/,.*\}/) ? (r = t.pre + "{" + t.body + bo + t.post, Zt(r)) : [r];
      var f;
      if (h)
        f = t.body.split(/\.\./);
      else if (f = vn(t.body), f.length === 1 && (f = Zt(f[0], !1).map(dQ), f.length === 1))
        return o.map(function(lA) {
          return t.pre + f[0] + lA;
        });
      var p;
      if (h) {
        var m = Ro(f[0]), D = Ro(f[1]), U = Math.max(f[0].length, f[1].length), R = f.length == 3 ? Math.abs(Ro(f[2])) : 1, T = mQ, M = D < m;
        M && (R *= -1, T = yQ);
        var x = f.some(pQ);
        p = [];
...
var Ag = j((VS, $o) => {
  "use strict";
  var NC = J("path"), kC = J("module"), qh = J("fs"), MC = /* @__PURE__ */ g((r, A, e) => {
    if (typeof r != "string")
    ...
    let t = NC.join(r, "noop.js"), i = /* @__PURE__ */ g(() => kC._resolveFilename(A, {
      id: t,
      filename: t,
      paths: kC._nodeModulePaths(r)
    }), "resolveFileName");
    if (e)
      try {
        return i();
  ...
  $o.exports = (r, A) => MC(r, A);
  $o.exports.silent = (r, A) => MC(r, A, !0);
});

// ../node_modules/common-path-prefix/index.js
var qC = j((pF, jC) => {
  "use strict";
  var { sep: al } = J("path"), El = /* @__PURE__ */ g((r) => {
    for (let A of r) {
      let e = /(\/|\\)/.exec(A);
  ...
  jC.exports = /* @__PURE__ */ g(function(A, e = El(A)) {
    let [t = "", ...i] = A;
...
var mI = j((VN, be) => {
  var lg = J("fs"), ug = J("path"), Au = J("os"), eu = J("crypto"), tu = fI(), fg = tu.version, ru = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
  function iu(r) {
    let A = {}, e = r.toString();
    e = e.replace(/\r\n?/mg, `
`);
    let t;
    for (; (t = ru.exec(e)) != null; ) {
      let i = t[1], o = t[2] || "";
      o = o.trim();
      let s = o[0];
...
`), o = o.replace(/\\r/g, "\r")), A[i] = o;
  ...
  g(iu, "parse");
  function ou(r) {
    let A = pI(r), e = mA.configDotenv({ path: A });
    if (!e.parsed) {
      let s = new Error(`MISSING_DATA: Cannot parse ${A} for an unknown reason`);
      throw s.code = "MISSING_DATA", s;
    }
    let t = dI(r).split(","), i = t.length, o;
    for (let s = 0; s < i; s++)
      try {
        let I = t[s].trim(), E = nu(e, I);
  ...
  g(ou, "_parseVault");
  function gu(r) {
    console.log(`[dotenv@${fg}][INFO] ${r}`);
  }
  g(gu, "_log");
  function su(r) {
    console.log(`[dotenv@${fg}][WARN] ${r}`);
  }
  g(su, "_warn");
  function hi(r) {
    console.log(`[dotenv@${fg}][DEBUG] ${r}`);
  }
  g(hi, "_debug");
  function dI(r) {
...
t?environment=development");
  ...
  function pI(r) {
    ...
    if (r && r.path && r.path.length > 0)
      if (Array.isArray(r.path))
        for (let e of r.path)
          lg.existsSync(e) && (A = e.endsWith(".vault") ? e : `${e}.vault`);
      else
        A = r.path.endsWith(".vault") ? r.path : `${r.path}.vault`;
    else
      A = ug.resolve(process.cwd(), ".env.vault");
    return lg.existsSync(A) ? A : null;
  }
  g(pI, "_vaultPath");
  function wI(r) {
    return r[0] === "~" ? ug.join(Au.homedir(), r.slice(1)) : r;
  }
  g(wI, "_resolveHome");
  function Cu(r) {
  ...
  g(Cu, "_configVault");
  function Iu(r) {
    let A = ug.resolve(process.cwd(), ".env"), e = "utf8", t = !!(r && r.debug);
    r && r.encoding ? e = r.encoding : t && hi("No encoding is specified. UTF-8 is used by default");
    let i = [A];
    if (r && r.path)
      if (!Array.isArray(r.path))
        i = [wI(r.path)];
    ...
    for (let E of i)
      try {
        let B = mA.parse(lg.readFileSync(E, { encoding: e }));
        mA.populate(s, B, r);
      } catch (B) {
        t && hi(`Failed to load ${E} ${B.message}`), o = B;
      }
    let I = process.env;
  ...
  function au(r) {
    ...
    let A = pI(r);
    return A ? mA._configVault(r) : (su(`You set DOTENV_KEY but you are missing a .env.vault file at ${A}. Did you forget to build it?`), mA.
    configDotenv(r));
  }
  g(au, "config");
  function Eu(r, A) {
    ...
    t = t.subarray(12, -16);
    try {
      let s = eu.createDecipheriv("aes-256-gcm", e, i);
...
e data";
  ...
  function cu(r, A, e = {}) {
    ...
    for (let o of Object.keys(A))
      Object.prototype.hasOwnProperty.call(r, o) ? (i === !0 && (r[o] = A[o]), t && hi(i === !0 ? `"${o}" is already defined and WAS overwri\
...
var KI = j(($N, DI) => {
  ...
  g(hu, "expand");
  DI.exports.expand = hu;
});

// ../node_modules/picomatch/lib/constants.js
var wr = j((nM, jI) => {
  "use strict";
  var bu = J("path"), Se = "\\\\/", OI = `[^${Se}]`, Le = "\\.", Lu = "\\+", Yu = "\\?", ui = "\\/", Uu = "(?=.)", _I = "[^/]", wg = `(?:${ui}\
|$)`, TI = `(?:^|${ui})`, dg = `${Le}{1,2}${wg}`, Gu = `(?!${Le})`, Ju = `(?!${TI}${dg})`, vu = `(?!${Le}{0,1}${wg})`, xu = `(?!${dg})`, Pu = `\
[^.${ui}]`, Ou = `${_I}*?`, HI = {
    DOT_LITERAL: Le,
    PLUS_LITERAL: Lu,
    QMARK_LITERAL: Yu,
    ...
    QMARK: OI,
    STAR: `${OI}*?`,
    DOTS_SLASH: `${Le}{1,2}(?:[${Se}]|$)`,
    NO_DOT: `(?!${Le})`,
    NO_DOTS: `(?!(?:^|[${Se}])${Le}{1,2}(?:[${Se}]|$))`,
    NO_DOT_SLASH: `(?!${Le}{0,1}(?:[${Se}]|$))`,
    NO_DOTS_SLASH: `(?!${Le}{1,2}(?:[${Se}]|$))`,
    QMARK_NO_DOT: `[^.${Se}]`,
    START_ANCHOR: `(?:^|[${Se}])`,
    END_ANCHOR: `(?:[${Se}]|$)`
  }, Tu = {
...
var fi = j((qA) => {
  "use strict";
  var Hu = J("path"), ju = process.platform === "win32", {
    REGEX_BACKSLASH: qu,
    REGEX_REMOVE_BACKSLASH: zu,
    REGEX_SPECIAL_CHARS: Wu,
    REGEX_SPECIAL_CHARS_GLOBAL: Xu
  } = wr();
  qA.isObject = (r) => r !== null && typeof r == "object" && !Array.isArray(r);
  qA.hasRegexChars = (r) => Wu.test(r);
  qA.isRegexChar = (r) => r.length === 1 && qA.hasRegexChars(r);
  qA.escapeRegex = (r) => r.replace(Xu, "\\$1");
  qA.toPosixSlashes = (r) => r.replace(qu, "/");
  qA.removeBackslashes = (r) => r.replace(zu, (A) => A === "\\" ? "" : A);
  qA.supportsLookbehinds = () => {
    let r = process.version.slice(1).split(".").map(Number);
    return r.length === 3 && r[0] >= 9 || r[0] === 8 && r[1] >= 10;
  };
  qA.isWindows = (r) => r && typeof r.windows == "boolean" ? r.windows : ju === !0 || Hu.sep === "\\";
  qA.escapeLast = (r, A, e) => {
...
var Aa = j((IM, $I) => {
  ...
  var qI = fi(), {
    ...
    CHAR_DOT: mg,
    /* . */
    CHAR_EXCLAMATION_MARK: yg,
    /* ! */
    CHAR_FORWARD_SLASH: ZI,
    /* / */
    CHAR_LEFT_CURLY_BRACE: Dg,
    /* { */
    CHAR_LEFT_PARENTHESES: Kg,
    /* ( */
    CHAR_LEFT_SQUARE_BRACKET: $u,
    /* [ */
    CHAR_PLUS: Af,
    /* + */
    CHAR_QUESTION_MARK: zI,
    /* ? */
    CHAR_RIGHT_CURLY_BRACE: ef,
    /* } */
    CHAR_RIGHT_PARENTHESES: WI,
    /* ) */
    CHAR_RIGHT_SQUARE_BRACKET: tf
    /* ] */
  } = wr(), XI = /* @__PURE__ */ g((r) => r === ZI || r === dr, "isPathSeparator"), VI = /* @__PURE__ */ g((r) => {
    r.isPrefix !== !0 && (r.depth = r.isGlobstar ? 1 / 0 : 1);
  }, "depth"), rf = /* @__PURE__ */ g((r, A) => {
    ...
    for (; B < t; ) {
      ...
      let MA;
      if (P === dr) {
        T = Z.backslashes = !0, P = BA(), P === Dg && (R = !0);
        continue;
      }
      if (R === !0 || P === Dg) {
        for (gA++; lA() !== !0 && (P = BA()); ) {
      ...
      if (e.noext !== !0 && (P === Af || P === Vu || P === pg || P === zI || P === yg) === !0 && F() === Kg) {
        if (m = Z.isGlob = !0, D = Z.isExtglob = !0, V = !0, P === yg && B === h && (x = !0), i === !0) {
          for (; lA() !== !0 && (P = BA()); ) {
            if (P === dr) {
      ...
      if (P === pg) {
        if (sA === pg && (U = Z.isGlobstar = !0), m = Z.isGlob = !0, V = !0, i === !0)
          continue;
        break;
      }
      if (P === zI) {
    ...
    "", K = E) : QA = E, QA && QA !== "" && QA !== "/" && QA !== E && XI(QA.charCodeAt(QA.length - 1)) && (QA = QA.slice(0, -1)), e.unescape ===
    !0 && (K && (K = qI.removeBackslashes(K)), QA && T === !0 && (QA = qI.removeBackslashes(QA)));
    let S = {
      prefix: ne,
      input: r,
      start: h,
    ...
    if (e.tokens === !0 && (S.maxDepth = 0, XI(P) || s.push(Z), S.tokens = s), e.parts === !0 || e.tokens === !0) {
      let MA;
      for (let oA = 0; oA < o.length; oA++) {
        let RA = MA ? MA + 1 : h, XA = o[oA], DA = r.slice(RA, XA);
        e.tokens && (oA === 0 && h !== 0 ? (s[oA].isPrefix = !0, s[oA].value = ne) : s[oA].value = DA, VI(s[oA]), S.maxDepth += s[oA].depth),
        (oA !== 0 || DA !== "") && I.push(DA), MA = XA;
      }
      if (MA && MA + 1 < r.length) {
        let oA = r.slice(MA + 1);
        I.push(oA), e.tokens && (s[s.length - 1].value = oA, VI(s[s.length - 1]), S.maxDepth += s[s.length - 1].depth);
      }
...
var ra = j((EM, ta) => {
  ...
  var wi = wr(), Ae = fi(), {
    MAX_LENGTH: di,
    POSIX_REGEX_SOURCE: of,
    REGEX_NON_SPECIAL_CHARS: gf,
    REGEX_SPECIAL_CHARS_BACKREF: sf,
    REPLACEMENTS: ea
  } = wi, nf = /* @__PURE__ */ g((r, A) => {
    ...
    return e;
  }, "expandRange"), bt = /* @__PURE__ */ g((r, A) => `Missing ${r}: "${A}" - use "\\\\${A}" to match literal characters`, "syntaxError"), Sg = /* @__PURE__ */ g(
  (r, A) => {
    if (typeof r != "string")
      throw new TypeError("Expected a string");
    r = ea[r] || r;
    let e = { ...A }, t = typeof e.maxLength == "number" ? Math.min(di, e.maxLength) : di, i = r.length;
    if (i > t)
      throw new SyntaxError(`Input length: ${i}, exceeds maximum allowed length: ${t}`);
    let o = { type: "bos", value: "", output: e.prepend || "" }, s = [o], I = e.capture ? "" : "?:", E = Ae.isWindows(A), B = wi.globChars(E),
    h = wi.extglobChars(B), {
      DOT_LITERAL: u,
      PLUS_LITERAL: f,
      SLASH_LITERAL: p,
    ...
    let BA = [], QA = [], ne = [], K = o, S, MA = /* @__PURE__ */ g(() => F.index === i - 1, "eos"), oA = F.peek = (Y = 1) => r[F.index + Y],
    RA = F.advance = () => r[++F.index] || "", XA = /* @__PURE__ */ g(() => r.slice(F.index + 1), "remaining"), DA = /* @__PURE__ */ g((Y = "", aA = 0) => {
      ...
      if (K.type === "globstar") {
        ...
        "paren");
        Y.type !== "slash" && Y.type !== "paren" && !aA && !b && (F.output = F.output.slice(0, -K.output.length), K.type = "star", K.value =
        "*", K.output = lA, F.output += K.output);
      }
      if (BA.length && Y.type !== "paren" && (BA[BA.length - 1].inner += Y.value), (Y.value || Y.output) && tt(Y), K && K.type === "text" &&
      Y.type === "text") {
        K.value += Y.value, K.output = (K.output || "") + Y.value;
        return;
      }
      Y.prev = K, s.push(Y), K = Y;
      ...
      if (Y.type === "negate") {
        ...
        `)$))${N}`), Y.inner.includes("*") && (b = XA()) && /^\.[^\\/.]+$/.test(b)) {
          let hA = Sg(b, { ...A, fastpaths: !1 }).output;
          aA = Y.close = `)${hA})${N})`;
        }
        Y.prev.type === "bos" && (F.negatedExtglob = !0);
      }
      rA({ type: "paren", extglob: !0, value: S, output: aA }), Fe("parens");
    }, "extglobClose");
    if (e.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(r)) {
      let Y = !1, aA = r.replace(sf, (b, N, hA, KA, uA, ht) => KA === "\\" ? (Y = !0, b) : KA === "?" ? N ? N + KA + (uA ? M.repeat(uA.length) :
      "") : ht === 0 ? Z + (uA ? M.repeat(uA.length) : "") : M.repeat(hA.length) : KA === "." ? u.repeat(hA.length) : KA === "*" ? N ? N + KA +
      (uA ? lA : "") : lA : N ? b : `\\${b}`);
...
\\" : "")), aA === r && e.contains === !0 ? (F.output = r, F) : (F.output = Ae.wrapOutput(aA, F, A), F);
    ...
    for (; !MA(); ) {
      ...
      if (S === "\\") {
        ...
        let N = /^\\+/.exec(XA()), hA = 0;
        if (N && N[0].length > 2 && (hA = N[0].length, F.index += hA, hA % 2 !== 0 && (S += "\\")), e.unescape === !0 ? S = RA() : S += RA(),
        F.brackets === 0) {
      ...
      if (F.brackets > 0 && (S !== "]" || K.value === "[" || K.value === "[^")) {
        if (e.posix !== !1 && S === ":") {
          ...
          if (b.includes("[") && (K.posix = !0, b.includes(":"))) {
            let N = K.value.lastIndexOf("["), hA = K.value.slice(0, N), KA = K.value.slice(N + 2), uA = of[KA];
            if (uA) {
              K.value = hA + uA, F.backtrack = !0, RA(), !o.output && s.indexOf(K) === 1 && (o.output = m);
              continue;
            }
          }
        }
      ...
      if (S === "(") {
        xe("parens"), rA({ type: "paren", value: S });
        continue;
      }
      if (S === ")") {
        ...
        rA({ type: "paren", value: S, output: F.parens ? ")" : "\\)" }), Fe("parens");
        continue;
      }
      if (S === "[") {
      ...
      if (S === "]") {
        ...
        Ae.hasRegexChars(b))
          continue;
        let N = Ae.escapeRegex(K.value);
        if (F.output = F.output.slice(0, -K.value.length), e.literalBrackets === !0) {
          F.output += N, K.value = N;
          continue;
        }
        K.value = `(${I}${N}|${K.value})`, F.output += K.value;
        continue;
      }
      if (S === "{" && e.nobrace !== !0) {
        xe("braces");
      ...
      if (S === "}") {
        ...
        if (b.dots === !0) {
          ...
          for (let uA = hA.length - 1; uA >= 0 && (s.pop(), hA[uA].type !== "brace"); uA--)
            hA[uA].type !== "dots" && KA.unshift(hA[uA].value);
          N = nf(KA, e), F.backtrack = !0;
        }
        if (b.comma !== !0 && b.dots !== !0) {
          let hA = F.output.slice(0, b.outputIndex), KA = F.tokens.slice(b.tokensIndex);
          b.value = b.output = "\\{", S = N = "\\}", F.output = hA;
          for (let uA of KA)
            F.output += uA.output || uA.value;
        }
        rA({ type: "brace", value: S, output: N }), Fe("braces"), QA.pop();
        continue;
      }
      if (S === "|") {
        BA.length > 0 && BA[BA.length - 1].conditions++, rA({ type: "text", value: S });
        continue;
      }
      if (S === ",") {
        let b = S, N = QA[QA.length - 1];
        N && ne[ne.length - 1] === "braces" && (N.comma = !0, b = "|"), rA({ type: "comma", value: S, output: b });
        continue;
      }
      if (S === "/") {
        if (K.type === "dot" && F.index === F.start + 1) {
          F.start = F.index + 1, F.consumed = "", F.output = "", s.pop(), K = o;
          continue;
        }
      ...
      if (S === "?") {
        ...
        if (K && K.type === "paren") {
          ...
          (K.value === "(" && !/[!=<:]/.test(N) || N === "<" && !/<([!=]|\w+>)/.test(XA())) && (hA = `\\${S}`), rA({ type: "text", value: S,
          output: hA });
          continue;
        }
      ...
      if (K && (K.type === "globstar" || K.star === !0)) {
        K.type = "star", K.star = !0, K.value += S, K.output = lA, F.backtrack = !0, F.globstar = !0, DA(S);
        continue;
      }
      let Y = XA();
      ...
      if (K.type === "star") {
        ...
        let b = K.prev, N = b.prev, hA = b.type === "slash" || b.type === "bos", KA = N && (N.type === "star" || N.type === "globstar");
        ...
        if (b.type === "bos" && MA()) {
          K.type = "globstar", K.value += S, K.output = sA(e), F.output = K.output, F.globstar = !0, DA(S);
          continue;
        }
        if (b.type === "slash" && b.prev.type !== "bos" && !KA && MA()) {
          F.output = F.output.slice(0, -(b.output + K.output).length), b.output = `(?:${b.output}`, K.type = "globstar", K.output = sA(e) + (e.
          strictSlashes ? ")" : "|$)"), K.value += S, F.globstar = !0, F.output += b.output + K.output, DA(S);
          continue;
        }
...
|${p}${Tt})`, K.value += S, F.output += b.output + K.output, F.globstar = !0, DA(S + RA()), rA({ type: "slash", value: "/", output: "" });
          continue;
        }
        if (b.type === "bos" && Y[0] === "/") {
          K.type = "globstar", K.value += S, K.output = `(?:^|${p}|${sA(e)}${p})`, F.output = K.output, F.globstar = !0, DA(S + RA()), rA({ type: "\
slash", value: "/", output: "" });
          continue;
        }
      ...
      let aA = { type: "star", value: S, output: lA };
      if (e.bash === !0) {
        aA.output = ".*?", (K.type === "bos" || K.type === "slash") && (aA.output = P + aA.output), rA(aA);
        continue;
      }
      ...
      (F.output += T, K.output += T) : (F.output += P, K.output += P), oA() !== "*" && (F.output += m, K.output += m)), rA(aA);
    }
    for (; F.brackets > 0; ) {
  ...
  Sg.fastpaths = (r, A) => {
    ...
    let o = Ae.isWindows(A), {
      ...
      STAR: p,
      START_ANCHOR: m
    } = wi.globChars(o), D = e.dot ? u : h, U = e.dot ? f : h, R = e.capture ? "" : "?:", T = { negated: !1, prefix: "" }, M = e.bash === !0 ?
    ".*?" : p;
    e.capture && (M = `(${M})`);
...
var oa = j((BM, ia) => {
  "use strict";
  var Cf = J("path"), If = Aa(), Fg = ra(), Ng = fi(), af = wr(), Ef = /* @__PURE__ */ g((r) => r && typeof r == "object" && !Array.isArray(
  r), "isObject"), dA = /* @__PURE__ */ g((r, A, e = !1) => {
    ...
    let t = Ef(r) && r.tokens && r.input;
    if (r === "" || typeof r != "string" && !t)
      throw new TypeError("Expected pattern to be a non-empty string");
    let i = A || {}, o = Ng.isWindows(A), s = t ? dA.compileRe(r, A) : dA.makeRe(r, A, !1, !0), I = s.state;
    delete s.state;
...
ion" && i.onIgnore(D), D.isMatch = !1, u ? D : !1) : (typeof i.onMatch == "function" && i.onMatch(D), u ? D : !0);
  ...
  dA.test = (r, A, e, { glob: t, posix: i } = {}) => {
    ...
    let o = e || {}, s = o.format || (i ? Ng.toPosixSlashes : null), I = r === t, E = I && s ? s(r) : r;
  ...
  dA.matchBase = (r, A, e, t = Ng.isWindows(e)) => (A instanceof RegExp ? A : dA.makeRe(A, e)).test(Cf.basename(r));
  dA.isMatch = (r, A, e) => dA(A, e)(r);
  dA.parse = (r, A) => Array.isArray(r) ? r.map((e) => dA.parse(e, A)) : Fg(r, { ...A, fastpaths: !1 });
  dA.scan = (r, A) => If(r, A);
  ...
  dA.makeRe = (r, A = {}, e = !1, t = !1) => {
    ...
    return A.fastpaths !== !1 && (r[0] === "." || r[0] === "*") && (i.output = Fg.fastpaths(r, A)), i.output || (i = Fg(r, A)), dA.compileRe(
    i, A, e, t);
  };
  dA.toRegex = (r, A) => {
    try {
...
var mi = j((_M, bg) => {
  var Ea = process.argv || [], pi = process.env, uf = !("NO_COLOR" in pi || Ea.includes("--no-color")) && ("FORCE_COLOR" in pi || Ea.includes(
  "--color") || process.platform === "win32" || J != null && J("tty").isatty(1) && pi.TERM !== "dumb" || "CI" in pi), ff = /* @__PURE__ */ g(
  (r, A, e = r) => (t) => {
    let i = "" + t, o = i.indexOf(A, r.length);
    return ~o ? r + wf(i, A, e, o) + A : r + i + A;
  }, "formatter"), wf = /* @__PURE__ */ g((r, A, e, t) => {
    let i = "", o = 0;
    do
      i += r.substring(o, t) + e, o = t + A.length, t = r.indexOf(A, o);
    while (~t);
    return i + r.substring(o);
  }, "replaceClose"), ca = /* @__PURE__ */ g((r = uf) => {
    let A = r ? ff : () => String;
    return {
      isColorSupported: r,
...
var pa = j((ER, da) => {
  ...
  g(Mf, "checkPathExt");
  function fa(r, A, e) {
    return !r.isSymbolicLink() && !r.isFile() ? !1 : Mf(A, e);
  }
  g(fa, "checkStat");
  function wa(r, A, e) {
    ua.stat(r, function(t, i) {
      e(t, t ? !1 : fa(i, r, A));
    });
  }
  g(wa, "isexe");
  function Rf(r, A) {
    return fa(ua.statSync(r), r, A);
  }
  g(Rf, "sync");
});
...
var Sa = j((BR, Ka) => {
  ...
  var ma = J("fs");
  function ya(r, A, e) {
    ma.stat(r, function(t, i) {
      e(t, t ? !1 : Da(i, A));
    });
  }
  g(ya, "isexe");
  function bf(r, A) {
    return Da(ma.statSync(r), A);
  }
  g(bf, "sync");
  function Da(r, A) {
    return r.isFile() && Lf(r, A);
  }
  g(Da, "checkStat");
  function Lf(r, A) {
...
var Na = j((lR, Fa) => {
  var hR = J("fs"), Ki;
  process.platform === "win32" || global.TESTING_WINDOWS ? Ki = pa() : Ki = Sa();
  Fa.exports = Lg;
  Lg.sync = Yf;
  function Lg(r, A, e) {
...
var Ua = j((fR, Ya) => {
  var Lt = process.platform === "win32" || process.env.OSTYPE === "cygwin" || process.env.OSTYPE === "msys", ka = J("path"), Uf = Lt ? ";" :
  ":", Ma = Na(), Ra = /* @__PURE__ */ g((r) => Object.assign(new Error(`not found: ${r}`), { code: "ENOENT" }), "getNotFoundError"), ba = /* @__PURE__ */ g(
  (r, A) => {
    let e = A.colon || Uf, t = r.match(/\//) || Lt && r.match(/\\/) ? [""] : [
  ...
  }, "getPathInfo"), La = /* @__PURE__ */ g((r, A, e) => {
    typeof A == "function" && (e = A, A = {}), A || (A = {});
    let { pathEnv: t, pathExt: i, pathExtExe: o } = ba(r, A), s = [], I = /* @__PURE__ */ g((B) => new Promise((h, u) => {
      if (B === t.length)
        return A.all && s.length ? h(s) : u(Ra(r));
      let f = t[B], p = /^".*"$/.test(f) ? f.slice(1, -1) : f, m = ka.join(p, r), D = !p && /^\.[\\\/]/.test(r) ? r.slice(0, 2) + m : m;
      h(E(D, B, 0));
    }), "step"), E = /* @__PURE__ */ g((B, h, u) => new Promise((f, p) => {
      if (u === i.length)
        return f(I(h + 1));
      let m = i[u];
      Ma(B + m, { pathExt: o }, (D, U) => {
        if (!D && U)
          if (A.all)
            s.push(B + m);
          else
  ...
  }, "which"), Gf = /* @__PURE__ */ g((r, A) => {
    A = A || {};
    let { pathEnv: e, pathExt: t, pathExtExe: i } = ba(r, A), o = [];
    for (let s = 0; s < e.length; s++) {
      let I = e[s], E = /^".*"$/.test(I) ? I.slice(1, -1) : I, B = ka.join(E, r), h = !E && /^\.[\\\/]/.test(r) ? r.slice(0, 2) + B : B;
      for (let u = 0; u < t.length; u++) {
        let f = h + t[u];
        try {
          if (Ma.sync(f, { pathExt: i }))
            if (A.all)
              o.push(f);
            else
              return f;
...
var Ja = j((dR, Yg) => {
  ...
  Yg.exports = Ga;
  Yg.exports.default = Ga;
});

// ../node_modules/cross-spawn/lib/util/resolveCommand.js
var Oa = j((mR, Pa) => {
  "use strict";
  var va = J("path"), Jf = Ua(), vf = Ja();
  function xa(r, A) {
    ...
    try {
      s = Jf.sync(r.command, {
        path: e[vf({ env: e })],
        pathExt: A ? va.delimiter : void 0
      });
    } catch {
    } finally {
      o && process.chdir(t);
    }
    return s && (s = va.resolve(i ? r.options.cwd : "", s)), s;
  }
  g(xa, "resolveCommandAttempt");
  function xf(r) {
    return xa(r) || xa(r, !0);
  }
  g(xf, "resolveCommand");
...
var _a = j((DR, Gg) => {
  ...
  var Ug = /([()\][%!^"`<>&|;, *?])/g;
  function Pf(r) {
    return r = r.replace(Ug, "^$1"), r;
  }
  g(Pf, "escapeCommand");
  function Of(r, A) {
    return r = `${r}`, r = r.replace(/(\\*)"/g, '$1$1\\"'), r = r.replace(/(\\*)$/, "$1$1"), r = `"${r}"`, r = r.replace(Ug, "^$1"), A && (r =
    r.replace(Ug, "^$1")), r;
  }
  g(Of, "escapeArgument");
  Gg.exports.command = Pf;
  Gg.exports.argument = Of;
});
...
var Wa = j((NR, za) => {
  ...
  function Hf(r) {
    ...
    try {
      t = Jg.openSync(r, "r"), Jg.readSync(t, e, 0, 150, 0), Jg.closeSync(t);
    } catch {
    }
...
var $a = j((MR, Za) => {
  "use strict";
  var jf = J("path"), Xa = Oa(), Va = _a(), qf = Wa(), zf = process.platform === "win32", Wf = /\.(?:com|exe)$/i, Xf = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;
  function Vf(r) {
    r.file = Xa(r);
    let A = r.file && qf(r.file);
    return A ? (r.args.unshift(r.file), r.command = A, Xa(r)) : r.file;
  }
  g(Vf, "detectShebang");
  function Zf(r) {
    if (!zf)
      return r;
    let A = Vf(r), e = !Wf.test(A);
    if (r.options.forceShell || e) {
      let t = Xf.test(A);
      r.command = jf.normalize(r.command), r.command = Va.command(r.command), r.args = r.args.map((o) => Va.argument(o, t));
...
var tE = j((bR, eE) => {
  ...
  g(Aw, "hookChildProcess");
  function AE(r, A) {
    return vg && r === 1 && !A.file ? xg(A.original, "spawn") : null;
  }
  g(AE, "verifyENOENT");
  function ew(r, A) {
    return vg && r === 1 && !A.file ? xg(A.original, "spawnSync") : null;
  }
  g(ew, "verifyENOENTSync");
  eE.exports = {
    hookChildProcess: Aw,
    verifyENOENT: AE,
    verifyENOENTSync: ew,
...
var _g = j((YR, Yt) => {
  "use strict";
  var rE = J("child_process"), Pg = $a(), Og = tE();
  function iE(r, A, e) {
    let t = Pg(r, A, e), i = rE.spawn(t.command, t.args, t.options);
    return Og.hookChildProcess(i, t), i;
  }
  g(iE, "spawn");
  function tw(r, A, e) {
    let t = Pg(r, A, e), i = rE.spawnSync(t.command, t.args, t.options);
    return i.error = i.error || Og.verifyENOENTSync(i.status, t), i;
  }
  g(tw, "spawnSync");
  Yt.exports = iE;
  Yt.exports.spawn = iE;
  Yt.exports.sync = tw;
  Yt.exports._parse = Pg;
  Yt.exports._enoent = Og;
});

// ../node_modules/merge-stream/index.js
var kE = j((sb, NE) => {
  "use strict";
  var { PassThrough: $w } = J("stream");
  NE.exports = function() {
    var r = [], A = new $w({ objectMode: !0 });
...
function Ip(r, A, e) {
  ...
  function E(f) {
    f.value instanceof Nr ? Promise.resolve(f.value.v).then(B, h) : u(o[0][2], f);
  }
  function B(f) {
    I("next", f);
  }
...
function ap(r) {
  ...
  function t(i, o) {
    A[i] = r[i] ? function(s) {
      return (e = !e) ? { value: Nr(r[i](s)), done: i === "return" } : o ? o(s) : s;
    } : o;
  }
}
function Ep(r) {
  ...
  return A ? A.call(r) : (r = typeof ds == "function" ? ds(r) : r[Symbol.iterator](), e = {}, t("next"), t("throw"), t("return"), e[Symbol.asyncIterator] =
  function() {
    return this;
  }, e);
  function t(o) {
...
var fs, ws, he = dn(() => {
  fs = /* @__PURE__ */ g(function(r, A) {
    return fs = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
      e.__proto__ = t;
    } || function(e, t) {
  ...
  g($d, "__extends");
  ws = /* @__PURE__ */ g(function() {
    return ws = Object.assign || /* @__PURE__ */ g(function(A) {
      for (var e, t = 1, i = arguments.length; t < i; t++) {
        e = arguments[t];
        for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (A[o] = e[o]);
      }
      return A;
    }, "__assign"), ws.apply(this, arguments);
  }, "__assign");
  g(Ap, "__rest");
  g(ep, "__decorate");
  g(tp, "__param");
  ...
  g(Cp, "__spreadArrays");
  g(Nr, "__await");
  g(Ip, "__asyncGenerator");
  g(ap, "__asyncDelegator");
  g(Ep, "__asyncValues");
  g(cp, "__makeTemplateObject");
  g(Bp, "__importStar");
  g(Qp, "__importDefault");
  g(hp, "__classPrivateFieldGet");
  g(lp, "__classPrivateFieldSet");
});
...
var Hi = j((fA) => {
  ...
  var up = (he(), Ie(Qe)), nc = up.__importStar(J("util")), yA = kr();
  ...
  fA.BigIntStatsEntry = Ti;
  function Cc() {
    return new _i();
  }
  g(Cc, "makeDefaultStats");
  fA.makeDefaultStats = Cc;
  function fp() {
    return Ic(Cc());
  }
  g(fp, "makeEmptyStats");
  fA.makeEmptyStats = fp;
  function Ic(r) {
    for (let A in r)
      if (Object.prototype.hasOwnProperty.call(r, A)) {
        let e = r[A];
        typeof e == "number" ? r[A] = 0 : typeof e == "bigint" ? r[A] = BigInt(0) : nc.types.isDate(e) && (r[A] = /* @__PURE__ */ new Date(0));
      }
    return r;
  }
  g(Ic, "clearStats");
  ...
  function wp(r) {
    ...
    for (let e in r)
      if (Object.prototype.hasOwnProperty.call(r, e)) {
        let t = r[e];
        typeof t == "number" ? A[e] = BigInt(t) : nc.types.isDate(t) && (A[e] = new Date(t));
      }
  ...
  g(wp, "convertToBigIntStats");
  fA.convertToBigIntStats = wp;
  function dp(r, A) {
...
var _A = j((EA) => {
  ...
  var pp = (he(), Ie(Qe)), ji = pp.__importDefault(J("path")), ac;
  (function(r) {
  ...
  EA.npath = Object.create(ji.default);
  EA.ppath = Object.create(ji.default.posix);
  EA.npath.cwd = () => process.cwd();
  EA.ppath.cwd = () => ms(process.cwd());
  EA.ppath.resolve = (...r) => r.length > 0 && EA.ppath.isAbsolute(r[0]) ? ji.default.posix.resolve(...r) : ji.default.posix.resolve(EA.ppath.
  cwd(), ...r);
  var Ec = /* @__PURE__ */ g(function(r, A, e) {
    return A = r.normalize(A), e = r.normalize(e), A === e ? "." : (A.endsWith(r.sep) || (A = A + r.sep), e.startsWith(A) ? e.slice(A.length) :
    null);
  }, "contains");
  EA.npath.fromPortablePath = cc;
  EA.npath.toPortablePath = ms;
  EA.npath.contains = (r, A) => Ec(EA.npath, r, A);
  EA.ppath.contains = (r, A) => Ec(EA.ppath, r, A);
  var mp = /^([a-zA-Z]:.*)$/, yp = /^\/\/(\.\/)?(.*)$/, Dp = /^\/([a-zA-Z]:.*)$/, Kp = /^\/unc\/(\.dot\/)?(.*)$/;
  function cc(r) {
  ...
  g(cc, "fromPortablePath");
  function ms(r) {
    if (process.platform !== "win32")
      return r;
    r = r.replace(/\\/g, "/");
    let A, e;
    return (A = r.match(mp)) ? r = `/${A[1]}` : (e = r.match(yp)) && (r = `/unc/${e[1] ? ".dot/" : ""}${e[2]}`), r;
  }
  g(ms, "toPortablePath");
  function Sp(r, A) {
    return r === EA.npath ? cc(A) : ms(A);
  }
  g(Sp, "convertPath");
  EA.convertPath = Sp;
  function Fp(r) {
...
var Fs = j((at) => {
  ...
  var Bc = (he(), Ie(Qe)), Ds = Bc.__importDefault(J("fs")), Np = Bc.__importStar(kr()), kp = _A(), qi = new Date(Np.SAFE_TIME * 1e3), Qc;
  (function(r) {
    r.Allow = "allow", r.ReadOnly = "readOnly";
  })(Qc = at.LinkStrategy || (at.LinkStrategy = {}));
  async function Mp(r, A, e, t, i) {
    let o = r.pathUtils.normalize(A), s = e.pathUtils.normalize(t), I = [], E = [], { atime: B, mtime: h } = i.stableTime ? { atime: qi, mtime: qi } :
  ...
  async function Ks(r, A, e, t, i, o, s, I) {
    var E, B;
    let h = I.didParentExist ? await Rp(t, i) : null, u = await o.lstatPromise(s), { atime: f, mtime: p } = I.stableTime ? { atime: qi, mtime: qi } :
    u, m;
    switch (!0) {
      case u.isDirectory():
        m = await bp(r, A, e, t, i, h, o, s, u, I);
        break;
      case u.isFile():
        m = await Yp(r, A, e, t, i, h, o, s, u, I);
        break;
      case u.isSymbolicLink():
        m = await Up(r, A, e, t, i, h, o, s, u, I);
        break;
      default:
  ...
  g(Rp, "maybeLStat");
  async function bp(r, A, e, t, i, o, s, I, E, B) {
  ...
  function Ss(r, A, e, t, i) {
    return async () => {
      await r.linkPromise(e, A), i === Qc.ReadOnly && (t.mode &= -147, await r.chmodPromise(A, t.mode));
    };
  }
  g(Ss, "makeLinkOperation");
  function Lp(r, A, e, t, i) {
    let o = ys.get(r);
    return typeof o > "u" ? async () => {
      try {
        await r.copyFilePromise(e, A, Ds.default.constants.COPYFILE_FICLONE_FORCE), ys.set(r, !0);
      } catch (s) {
        if (s.code === "ENOSYS" || s.code === "ENOTSUP")
          ys.set(r, !1), await Ss(r, A, e, t, i)();
        else
          throw s;
      }
    } : o ? async () => r.copyFilePromise(e, A, Ds.default.constants.COPYFILE_FICLONE_FORCE) : Ss(r, A, e, t, i);
  }
  g(Lp, "makeCloneLinkOperation");
  async function Yp(r, A, e, t, i, o, s, I, E, B) {
    var h;
    if (o !== null)
      if (B.overwrite)
        r.push(async () => t.removePromise(i)), o = null;
        ...
        return !1;
    let u = (h = B.linkStrategy) !== null && h !== void 0 ? h : null, f = t === s ? u !== null ? Lp(t, i, I, E, u) : async () => t.copyFilePromise(
    I, i, Ds.default.constants.COPYFILE_FICLONE) : u !== null ? Ss(t, i, I, E, u) : async () => t.writeFilePromise(i, await s.readFilePromise(
    I));
    return r.push(async () => f()), !0;
  }
  g(Yp, "copyFile");
  async function Up(r, A, e, t, i, o, s, I, E, B) {
    if (o !== null)
      if (B.overwrite)
        r.push(async () => t.removePromise(i)), o = null;
      else
        return !1;
    return r.push(async () => {
      await t.symlinkPromise((0, kp.convertPath)(t.pathUtils, await s.readlinkPromise(I)), i);
    }), !0;
  }
  g(Up, "copySymlink");
});
...
var ks = j((Gt) => {
  ...
  var Wp = (he(), Ie(Qe)), Xp = Wp.__importStar(Mr()), zi = class {
    static {
      g(this, "CustomDir");
    }
    constructor(A, e, t = {}) {
...
var We = j((ze) => {
  ...
  var Zp = J("os"), $p = Fs(), hc = _A(), Wi = class {
    static {
      g(this, "FakeFS");
    }
    constructor(A) {
    ...
    async copyPromise(A, e, { baseFs: t = this, overwrite: i = !0, stableSort: o = !1, stableTime: s = !1, linkStrategy: I = null } = {}) {
      return await (0, $p.copyPromise)(this, A, t, e, { overwrite: i, stableSort: o, stableTime: s, linkStrategy: I });
    }
    copySync(A, e, { baseFs: t = this, overwrite: i = !0 } = {}) {
      ...
      if (o.isDirectory()) {
        ...
        if (!s || i) {
          ...
          this.symlinkSync((0, hc.convertPath)(this.pathUtils, E), A);
        }
      } else
...
`;
  ...
  g(Rs, "normalizeLineEndings");
  ze.normalizeLineEndings = Rs;
});
...
var Xe = j((Xi) => {
  ...
  Xi.NodeFS = void 0;
  var em = (he(), Ie(Qe)), tm = em.__importDefault(J("fs")), rm = We(), lc = Mr(), L = _A(), bs = class extends rm.BasePortableFakeFS {
    static {
      g(this, "NodeFS");
    }
    constructor(A = tm.default) {
    ...
    async lutimesPromiseImpl(A, e, t) {
      ...
      if (typeof i > "u")
        throw (0, lc.ENOSYS)("unavailable Node binding", `lutimes '${A}'`);
...
var uc = j((se) => {
  ...
  var im = (he(), Ie(Qe)), om = J("events"), Vi = im.__importStar(Hi()), Jt;
  (function(r) {
  ...
  g(Ls, "assertStatus");
  se.assertStatus = Ls;
  var Ys = class r extends om.EventEmitter {
    static {
    ...
    start() {
      Ls(this.status, vt.Ready), this.status = vt.Running, this.startTimeout = setTimeout(() => {
        this.startTimeout = null, this.fakeFs.existsSync(this.path) || this.emit(Jt.Change, this.lastStats, this.lastStats);
      }, 3);
    }
    stop() {
      Ls(this.status, vt.Running), this.status = vt.Stopped, this.startTimeout !== null && (clearTimeout(this.startTimeout), this.startTimeout =
    ...
    stat() {
      try {
        ...
        let e = this.bigint ? new Vi.BigIntStatsEntry() : new Vi.StatEntry();
        return Vi.clearStats(e);
      }
    }
    /**
    ...
    makeInterval(A) {
      let e = setInterval(() => {
        ...
        Vi.areStatsEqual(t, i) || (this.lastStats = t, this.emit(Jt.Change, t, i));
      }, A.interval);
...
var Us = j((Ve) => {
  ...
  var gm = uc(), Zi = /* @__PURE__ */ new WeakMap();
  function sm(r, A, e, t) {
    let i, o, s, I;
    switch (typeof e) {
      case "function":
    ...
    let E = Zi.get(r);
    typeof E > "u" && Zi.set(r, E = /* @__PURE__ */ new Map());
    let B = E.get(A);
    return typeof B > "u" && (B = gm.CustomStatWatcher.create(r, A, { bigint: i }), E.set(A, B)), B.registerChangeListener(I, { persistent: o,
    interval: s }), B;
  }
  g(sm, "watchFile");
  Ve.watchFile = sm;
  ...
  g(nm, "unwatchAllFiles");
  Ve.unwatchAllFiles = nm;
});
...
var Ao = j((Ge) => {
  ...
  var vs = (he(), Ie(Qe)), Rr = J("fs"), wc = J("stream"), Cm = J("util"), dc = vs.__importDefault(J("zlib")), Im = We(), am = Xe(), Em = ks(),
  Gs = Us(), Ue = kr(), q = vs.__importStar(Mr()), nA = _A(), Et = vs.__importStar(Hi());
  ...
  g($i, "makeEmptyArchive");
  Ge.makeEmptyArchive = $i;
  var Js = class extends Im.BasePortableFakeFS {
    static {
      g(this, "ZipFS");
    }
    constructor(A, e) {
      ...
      libzip;
      let t = e;
      if (this.level = typeof t.level < "u" ? t.level : Ge.DEFAULT_COMPRESSION_LEVEL, A ?? (A = $i()), typeof A == "string") {
        let { baseFs: s = new am.NodeFS() } = t;
    ...
    saveAndClose() {
      ...
      if (this.entries.size === 0)
        this.discardAndClose(), this.baseFs.writeFileSync(this.path, $i(), { mode: A });
      else {
    ...
    opendirSync(A, e = {}) {
      ...
      return (0, Em.opendir)(this, t, o, { onClose: I });
    }
    ...
    createReadStream(A, { encoding: e } = {}) {
      ...
      let t = this.openSync(A, "r"), i = Object.assign(new wc.PassThrough({
        emitClose: !0,
        autoDestroy: !0,
    ...
    createWriteStream(A, { encoding: e } = {}) {
      ...
      if (A === null)
        throw new Error("Unimplemented");
      let t = [], i = this.openSync(A, "w"), o = Object.assign(new wc.PassThrough({
        autoDestroy: !0,
        emitClose: !0,
        destroy: /* @__PURE__ */ g((s, I) => {
          try {
    ...
    accessSync(A, e = Rr.constants.F_OK) {
      let t = this.resolveFilename(`access '${A}'`, A);
      if (!this.entries.has(t) && !this.listings.has(t))
        throw q.ENOENT(`access '${A}'`);
      if (this.readOnly && e & Rr.constants.W_OK)
        ...
        try {
          ...
          if (e.asyncDecompress)
            return new Promise((p, m) => {
              dc.default.inflateRaw(f, (D, U) => {
                D ? m(D) : (this.fileSources.set(A, U), p(U));
              });
            });
          {
            let p = dc.default.inflateRawSync(f);
    ...
    prepareCopyFile(A, e, t = 0) {
      ...
      if (t & Rr.constants.COPYFILE_FICLONE_FORCE)
      ...
      if (t & (Rr.constants.COPYFILE_EXCL | Rr.constants.COPYFILE_FICLONE_FORCE) && typeof I < "u")
...
a", ...t }), this.writeFileSync(A, e, t);
    ...
    utimesImpl(A, e) {
      ...
      if (t === void 0)
        throw new Error("Unreachable");
      if (this.libzip.file.setMtime(this.zip, t, 0, cm(e), 0) === -1)
        throw this.makeLibzipError(this.libzip.getError(this.zip));
    }
    async mkdirPromise(A, e) {
    ...
    watchFile(A, e, t) {
      ...
      return (0, Gs.watchFile)(this, i, e, t);
    }
    unwatchFile(A, e) {
      let t = nA.ppath.resolve(nA.PortablePath.root, A);
      return (0, Gs.unwatchFile)(this, t, e);
    }
  };
  Ge.ZipFS = Js;
});
...
var Je = j((eo) => {
  ...
  eo.ProxiedFS = void 0;
  var Bm = We(), xs = class extends Bm.FakeFS {
    static {
      g(this, "ProxiedFS");
    }
    getExtractHint(A) {
...
var pc = j((to) => {
  ...
  to.AliasFS = void 0;
  var Qm = Je(), Ps = class extends Qm.ProxiedFS {
    static {
      g(this, "AliasFS");
    }
...
var mc = j((ro) => {
  ...
  ro.CwdFS = void 0;
  var hm = Xe(), lm = Je(), Os = _A(), _s = class extends lm.ProxiedFS {
    static {
      g(this, "CwdFS");
    }
    constructor(A, { baseFs: e = new hm.NodeFS() } = {}) {
      super(Os.ppath), this.target = this.pathUtils.normalize(A), this.baseFs = e;
    }
    getRealPath() {
      return this.pathUtils.resolve(this.baseFs.getRealPath(), this.target);
    }
    resolve(A) {
      return this.pathUtils.isAbsolute(A) ? Os.ppath.normalize(A) : this.baseFs.resolve(Os.ppath.join(this.target, A));
    }
    mapFromBase(A) {
      return A;
    }
...
var Dc = j((oo) => {
  ...
  oo.JailFS = void 0;
  var um = Xe(), fm = Je(), io = _A(), yc = io.PortablePath.root, Ts = class extends fm.ProxiedFS {
    static {
      g(this, "JailFS");
    }
    constructor(A, { baseFs: e = new um.NodeFS() } = {}) {
      super(io.ppath), this.target = this.pathUtils.resolve(io.PortablePath.root, A), this.baseFs = e;
    }
    getRealPath() {
      return this.pathUtils.resolve(this.baseFs.getRealPath(), this.pathUtils.relative(io.PortablePath.root, this.target));
    }
    getTarget() {
      return this.target;
    }
    ...
    mapToBase(A) {
      ...
      if (this.pathUtils.isAbsolute(A))
        return this.pathUtils.resolve(this.target, this.pathUtils.relative(yc, A));
      if (e.match(/^\.\.\/?/))
        throw new Error(`Resolving this path (${A}) would escape the jail`);
      return this.pathUtils.resolve(this.target, A);
    }
    mapFromBase(A) {
      return this.pathUtils.resolve(yc, this.pathUtils.relative(this.target, A));
    }
  };
  oo.JailFS = Ts;
});
...
var Kc = j((go) => {
  ...
  go.LazyFS = void 0;
  var wm = Je(), Hs = class extends wm.ProxiedFS {
    static {
      g(this, "LazyFS");
    }
    constructor(A, e) {
...
var Sc = j((so) => {
  ...
  so.NoFS = void 0;
  var dm = We(), pm = _A(), G = /* @__PURE__ */ g(() => Object.assign(new Error("ENOSYS: unsupported filesystem access"), { code: "ENOSYS" }),
  "makeError"), br = class extends dm.FakeFS {
    static {
      g(this, "NoFS");
    }
    constructor() {
...
var Fc = j((no) => {
  ...
  no.PosixFS = void 0;
  var mm = Je(), js = _A(), qs = class extends mm.ProxiedFS {
    static {
      g(this, "PosixFS");
    }
    constructor(A) {
      super(js.npath), this.baseFs = A;
    }
    mapFromBase(A) {
      return js.npath.fromPortablePath(A);
    }
    mapToBase(A) {
      return js.npath.toPortablePath(A);
    }
  };
  no.PosixFS = qs;
});
...
var Nc = j((Co) => {
  ...
  Co.VirtualFS = void 0;
  var ym = Xe(), Dm = Je(), le = _A(), Km = /^[0-9]+$/, zs = /^(\/(?:[^/]+\/)*?(?:\$\$virtual|__virtual__))((?:\/((?:[^/]+-)?[a-f0-9]+)(?:\/([^/]+))?)?((?:\/.*)?))$/,
  Sm = /^([^/]+-)?[a-f0-9]+$/, Ws = class r extends Dm.ProxiedFS {
    static {
      g(this, "VirtualFS");
    }
    static makeVirtualPath(A, e, t) {
      ...
      if (!le.ppath.basename(e).match(Sm))
    ...
    constructor({ baseFs: A = new ym.NodeFS() } = {}) {
...
var kc = j((Ze) => {
  ...
  var Fm = (he(), Ie(Qe)), Io = J("fs"), Nm = We(), km = Xe(), ao = Ao(), Eo = Us(), zA = Fm.__importStar(Mr()), ct = _A(), WA = 4278190080,
  TA = 704643072, Mm = /* @__PURE__ */ g((r, A) => {
    let e = r.indexOf(A);
    if (e <= 0)
      return null;
    let t = e;
  ...
  Ze.getArchivePart = Mm;
  var Xs = class r extends Nm.BasePortableFakeFS {
    static {
      g(this, "ZipOpenFS");
    }
    ...
    constructor({ libzip: A, baseFs: e = new km.NodeFS(), filter: t = null, maxOpenFiles: i = 1 / 0, readOnlyArchives: o = !1, useCache: s = !0,
    ...
    saveAndClose() {
      if ((0, Eo.unwatchAllFiles)(this), this.zipInstances)
    ...
    async copyFilePromise(A, e, t = 0) {
      let i = /* @__PURE__ */ g(async (o, s, I, E) => {
        if (t & Io.constants.COPYFILE_FICLONE_FORCE)
          throw Object.assign(new Error(`EXDEV: cross-device clone not permitted, copyfile '${s}' -> ${E}'`), { code: "EXDEV" });
        if (t & Io.constants.COPYFILE_EXCL && await this.existsPromise(s))
    ...
    copyFileSync(A, e, t = 0) {
      let i = /* @__PURE__ */ g((o, s, I, E) => {
        if (t & Io.constants.COPYFILE_FICLONE_FORCE)
          throw Object.assign(new Error(`EXDEV: cross-device clone not permitted, copyfile '${s}' -> ${E}'`), { code: "EXDEV" });
        if (t & Io.constants.COPYFILE_EXCL && this.existsSync(s))
          throw Object.assign(new Error(`EEXIST: file already exists, copyfile '${s}' -> '${E}'`), { code: "EEXIST" });
        let B;
        try {
          B = o.readFileSync(s);
    ...
    watchFile(A, e, t) {
      return this.makeCallSync(A, () => this.baseFs.watchFile(
        ...
        e,
        t
      ), () => (0, Eo.watchFile)(this, A, e, t));
    }
    unwatchFile(A, e) {
      return this.makeCallSync(A, () => this.baseFs.unwatchFile(A, e), () => (0, Eo.unwatchFile)(this, A, e));
    }
...
var Rc = j((co) => {
  ...
  var Mc = J("url"), Rm = J("util"), bm = Je(), Lm = _A(), Vs = class extends bm.ProxiedFS {
    static {
      g(this, "NodePathFS");
    }
    constructor(A) {
      super(Lm.npath), this.baseFs = A;
    }
    mapFromBase(A) {
      return A;
    }
    mapToBase(A) {
      if (typeof A == "string")
        return A;
      if (A instanceof Mc.URL)
        return (0, Mc.fileURLToPath)(A);
...
https://github.com/yarnpkg/berry/issues/4942");
      ...
      throw new Error(`Unsupported path type: ${(0, Rm.inspect)(A)}`);
    }
  };
  co.NodePathFS = Vs;
});
...
var Gc = j((ho) => {
  ...
  ho.FileHandle = void 0;
  var Ym = J("readline"), HA = Symbol("kBaseFs"), $e = Symbol("kFd"), At = Symbol("kClosePromise"), Bo = Symbol("kCloseResolve"), Qo = Symbol(
  "kCloseReject"), xt = Symbol("kRefs"), ue = Symbol("kRef"), fe = Symbol("kUnref"), Zs = class {
    static {
      g(this, "FileHandle");
    }
    constructor(A, e) {
      this[bc] = 1, this[Lc] = void 0, this[Yc] = void 0, this[Uc] = void 0, this[HA] = e, this[$e] = A;
    }
    get fd() {
      return this[$e];
    }
    ...
    close() {
      ...
      if (this[xt]--, this[xt] === 0) {
        ...
        this[At] = new Promise((A, e) => {
          ...
          this[At] = void 0, this[Qo] = void 0, this[Bo] = void 0;
        });
      return this[At];
    }
    [(bc = xt, Lc = At, Yc = Bo, Uc = Qo, ue)](A) {
      if (this[$e] === -1) {
    ...
    [fe]() {
      if (this[xt]--, this[xt] === 0) {
        let A = this[$e];
        this[$e] = -1, this[HA].closePromise(A).then(this[Bo], this[Qo]);
      }
    }
  };
  ho.FileHandle = Zs;
...
var Pc = j((Pt) => {
  ...
  var Lr = J("util"), Um = Rc(), Jc = Gc(), Gm = /* @__PURE__ */ new Set([
    "accessSync",
    "appendFileSync",
    "createReadStream",
    "createWriteStream",
  ...
  function xc(r, A) {
    A = new Um.NodePathFS(A);
    let e = /* @__PURE__ */ g((t, i, o) => {
      let s = t[i];
      t[i] = o, typeof s?.[Lr.promisify.custom] < "u" && (o[Lr.promisify.custom] = s[Lr.promisify.custom]);
    }, "setupFn");
    {
      e(r, "exists", (t, ...i) => {
      ...
      if (typeof i < "u") {
        for (let o of vc) {
          ...
          if (typeof i[s] > "u")
            continue;
          let I = A[o];
          typeof I > "u" || o !== "open" && e(i, s, (E, ...B) => E instanceof Jc.FileHandle ? E[s].apply(E, B) : I.call(A, E, ...B));
        }
        e(i, "open", async (...o) => {
          let s = await A.openPromise(...o);
          return new Jc.FileHandle(s, A);
        });
      }
    }
    r.read[Lr.promisify.custom] = async (t, i, ...o) => ({ bytesRead: await A.readPromise(t, i, ...o), buffer: i }), r.write[Lr.promisify.custom] =
...
var Tc = j((et) => {
  ...
  et.xfs = void 0;
  var vm = (he(), Ie(Qe)), xm = vm.__importDefault(J("os")), Pm = Xe(), Yr = _A();
  function Oc(r) {
    let A = Math.ceil(Math.random() * 4294967296).toString(16).padStart(8, "0");
    return `${r}${A}`;
  }
  g(Oc, "getTempName");
  var we = /* @__PURE__ */ new Set(), $s = null;
  function _c() {
    if ($s)
      return $s;
    let r = Yr.npath.toPortablePath(xm.default.tmpdir()), A = et.xfs.realpathSync(r);
  ...
  g(_c, "initTmpEnv");
  et.xfs = Object.assign(new Pm.NodeFS(), {
    detachTemp(r) {
      we.delete(r);
    },
    mktempSync(r) {
      let { tmpdir: A, realTmpdir: e } = _c();
      for (; ; ) {
        let t = Oc("xfs-");
        try {
...
var Wc = j((z) => {
  ...
  var Hc = (he(), Ie(Qe)), Om = Hc.__importStar(kr());
  z.constants = Om;
  var _m = Hc.__importStar(Hi());
  z.statUtils = _m;
  var Tm = Fs();
  Object.defineProperty(z, "LinkStrategy", { enumerable: !0, get: /* @__PURE__ */ g(function() {
    return Tm.LinkStrategy;
  }, "get") });
  var jc = ks();
...
function ly(r, A, e) {
  ...
  function E(f) {
    f.value instanceof Ur ? Promise.resolve(f.value.v).then(B, h) : u(o[0][2], f);
  }
  function B(f) {
    I("next", f);
  }
...
function uy(r) {
  ...
  function t(i, o) {
    A[i] = r[i] ? function(s) {
      return (e = !e) ? { value: Ur(r[i](s)), done: i === "return" } : o ? o(s) : s;
    } : o;
  }
}
function fy(r) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var A = r[Symbol.asyncIterator], e;
  return A ? A.call(r) : (r = typeof rn == "function" ? rn(r) : r[Symbol.iterator](), e = {}, t("next"), t("throw"), t("return"), e[Symbol.asyncIterator] =
  function() {
    return this;
  }, e);
  function t(o) {
...
var en, tn, Zc = dn(() => {
  ...
  g(gy, "__extends");
  tn = /* @__PURE__ */ g(function() {
    return tn = Object.assign || /* @__PURE__ */ g(function(A) {
      for (var e, t = 1, i = arguments.length; t < i; t++) {
        e = arguments[t];
        for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (A[o] = e[o]);
      }
      return A;
    }, "__assign"), tn.apply(this, arguments);
  }, "__assign");
  g(sy, "__rest");
  g(ny, "__decorate");
  g(Cy, "__param");
  ...
  g(hy, "__spreadArrays");
  g(Ur, "__await");
  g(ly, "__asyncGenerator");
  g(uy, "__asyncDelegator");
  g(fy, "__asyncValues");
  g(wy, "__makeTemplateObject");
  g(dy, "__importStar");
  g(py, "__importDefault");
  g(my, "__classPrivateFieldGet");
  g(yy, "__classPrivateFieldSet");
});

// ../node_modules/@yarnpkg/libzip/lib/libzipSync.js
var AB = j((lo, gn) => {
  var $c = Object.assign({}, J("fs")), on = function() {
    ...
    return typeof __filename < "u" && (r = r || __filename), function(A) {
      ...
      u && (h ? f = J("path").dirname(f) + "/" : f = __dirname + "/", m = /* @__PURE__ */ g(function(C, a) {
        var Q = un(C);
        return Q ? a ? Q : Q.toString() : (U || (U = $c), R || (R = J("path")), C = R.normalize(C), U.readFileSync(C, a ? null : "utf8"));
      ...
      function S(n, C, a, Q, l) {
        ...
        if (Q)
          for (var O = 0; O < Q.length; O++) {
            var eA = w[a[O]];
            eA ? (v === 0 && (v = CQ()), k[O] = eA(Q[O])) : k[O] = Q[O];
          }
        var W = y.apply(null, k);
        return W = d(W), v !== 0 && IQ(v), W;
      }
      g(S, "ccall");
      function MA(n, C, a, Q) {
        a = a || [];
        ...
        return w && l && !Q ? K(n) : function() {
          return S(n, C, a, arguments, Q);
        };
      }
      g(MA, "cwrap");
      ...
      g(rA, "alignUp");
      var Pe, bA, Y, aA, b, N, hA, KA, uA;
      function ht(n) {
        Pe = n, e.HEAP8 = bA = new Int8Array(n), e.HEAP16 = aA = new Int16Array(n), e.HEAP32 = N = new Int32Array(n), e.HEAPU8 = Y = new Uint8Array(
        n), e.HEAPU16 = b = new Uint16Array(n), e.HEAPU32 = hA = new Uint32Array(n), e.HEAPF32 = KA = new Float32Array(n), e.HEAPF64 = uA = new Float64Array(
        n);
      }
      g(ht, "updateGlobalBufferAndViews");
      var Tt = e.INITIAL_MEMORY || 16777216, po, nn = [], Cn = [], In = [], mB = !1;
      function yB() {
        if (e.preRun)
      ...
      g(yB, "preRun");
      function DB() {
        mB = !0, !e.noFSInit && !c.init.initialized && c.init(), Oe.init(), Do(Cn);
      }
      g(DB, "initRuntime");
      function KB() {
        if (e.postRun)
      ...
      g(NB, "addOnPostRun");
      var rt = 0, mo = null, Ht = null;
      function rD(n) {
        return n;
      }
      g(rD, "getUniqueRunDependency");
      function an(n) {
        rt++, e.monitorRunDependencies && e.monitorRunDependencies(rt);
      }
      g(an, "addRunDependency");
      function yo(n) {
        if (rt--, e.monitorRunDependencies && e.monitorRunDependencies(rt), rt == 0 && (mo !== null && (clearInterval(mo), mo = null), Ht)) {
          var C = Ht;
          Ht = null, C();
        }
      }
      g(yo, "removeRunDependency"), e.preloadedImages = {}, e.preloadedAudios = {};
      function pA(n) {
...
w90ClLKdvV0GoqnTfoFhkA0rHxDxTrq9fGAQVseNtKIarDKS/Q/DpUIE5VxZSN/////////////////////8=";
 ...
 generating HTML (but not JS)";
      ...
      function MB(n, C) {
        var a, Q, l;
        try {
          l = kB(n), Q = new WebAssembly.Module(l), a = new WebAssembly.Instance(Q, C);
        } catch (d) {
          var w = d.toString();
...
OWTH to allow any size memory (and also make sure not to set INITIAL_MEMORY at runtime to something smaller than it was at compile time)."
      ...
      g(MB, "instantiateSync");
      function RB() {
        var n = { a: oQ };
        function C(l, w) {
          var d = l.exports;
          e.asm = d, F = e.asm.u, ht(F.buffer), po = e.asm.pa, FB(e.asm.v), yo("wasm-instantiate");
        }
        if (g(C, "receiveInstance"), an("wasm-instantiate"), e.instantiateWasm)
          try {
      ...
      function Do(n) {
        for (; n.length > 0; ) {
          ...
          var a = C.func;
          typeof a == "number" ? C.arg === void 0 ? po.get(a)() : po.get(a)(C.arg) : a(C.arg === void 0 ? null : C.arg);
        }
      }
      g(Do, "callRuntimeCallbacks");
      function vr(n, C) {
        ...
        return N[C + 28 >> 2] = l, vr.GMTString || (vr.GMTString = xe("GMT")), N[C + 40 >> 2] = vr.GMTString, C;
      }
      g(vr, "_gmtime_r");
      function bB(n, C) {
        return vr(n, C);
...
`));
      ...
      function Ko(n) {
        for (var C = V(n, 65536), a = fn(C); n < C; ) bA[a + n++] = 0;
        return a;
      }
      g(Ko, "mmapAlloc");
      var $ = {
        ...
        node_ops: {
          ...
          readlink: /* @__PURE__ */ g(function(n) {
            var C = X.realPath(n);
            try {
              return C = AA.readlinkSync(C), C = hn.relative(
                hn.resolve(n.mount.opts.root),
                C
              ), C;
            } catch (a) {
              throw a.code ? new c.ErrnoError(X.convertNodeCode(a)) : a;
...
ers. Use --embed-file or --preload-file in emcc on the main thread."
          ...
          if (m)
            try {
              n.contents = Fo(m(n.url), !0), n.usedBytes = n.contents.length;
            } catch {
              throw new c.ErrnoError(29);
            }
          else
        ...
        createLazyFile: /* @__PURE__ */ g(function(n, C, a, Q, l) {
          ...
          if (g(w, "LazyUint8Array"), w.prototype.get = /* @__PURE__ */ g(function(W) {
            ...
            var _ = Number(W.getResponseHeader("Content-length")), tA, JA = (tA = W.getResponseHeader("Accept-Ranges")) && tA === "bytes", Ce = (tA =
            W.getResponseHeader("Content-Encoding")) && tA === "gzip", VA = 1024 * 1024;
            JA || (VA = _);
            var qt = /* @__PURE__ */ g(function(de, ft) {
              if (de > ft)
                throw new Error(
              ...
              return LA.response !== void 0 ? new Uint8Array(LA.response || []) : Fo(LA.responseText || "", !0);
            }, "doXHR"), vA = this;
            vA.setDataGetter(function(de) {
              var ft = de * VA, LA = (de + 1) * VA - 1;
              if (LA = Math.min(LA, _ - 1), typeof vA.chunks[de] > "u" && (vA.chunks[de] = qt(ft, LA)), typeof vA.chunks[de] > "u")
          ...
          }), v.read = /* @__PURE__ */ g(function(W, _, tA, JA, Ce) {
            c.forceLoadFile(k);
            var VA = W.node.contents;
            if (Ce >= VA.length) return 0;
            var qt = Math.min(VA.length - Ce, JA);
            if (VA.slice)
              for (var vA = 0; vA < qt; vA++)
                _[tA + vA] = VA[Ce + vA];
            else
              for (var vA = 0; vA < qt; vA++)
                _[tA + vA] = VA.get(Ce + vA);
            return qt;
        ...
        createPreloadedFile: /* @__PURE__ */ g(function(n, C, a, Q, l, w, d, y, k, v) {
          ...
          function W(_) {
            ...
            e.preloadPlugins.forEach(function(Ce) {
              JA || Ce.canHandle(O) && (Ce.handle(_, O, tA, function() {
                d && d(), yo(eA);
              }), JA = !0);
            }), JA || tA(_);
          }
          g(W, "processData"), an(eA), typeof a == "string" ? Browser.asyncLoad(
            a,
            function(_) {
              W(_);
            },
      ...
      g(jB, "emscripten_realloc_buffer");
      function qB(n) {
        var C = Y.length;
        n = n >>> 0;
        var a = 2147483648;
      ...
      function So() {
        ...
        l < Q ? (N[Or() >> 2] = v, N[Or() + 4 >> 2] = O) : (N[Or() >> 2] = O, N[Or() + 4 >> 2] = v);
      }
      g(So, "_tzset");
      function eQ(n) {
        So();
      ...
      g(eQ, "_timegm");
      var Qn = /* @__PURE__ */ g(function(n, C, a, Q) {
      ...
      }, "FSNode"), xr = 365, Pr = 146;
      if (Object.defineProperties(Qn.prototype, {
        read: {
          get: /* @__PURE__ */ g(function() {
            return (this.mode & xr) === xr;
          }, "get"),
          set: /* @__PURE__ */ g(function(n) {
            n ? this.mode |= xr : this.mode &= ~xr;
          }, "set")
        },
        write: {
          get: /* @__PURE__ */ g(function() {
      ...
      }), c.FSNode = Qn, c.staticInit(), u) {
        var AA = $c, hn = J("path");
        X.staticInit();
      }
      if (u) {
        var tQ = /* @__PURE__ */ g(function(n) {
          return function() {
            try {
        ...
        for (var ln in Bn) c[ln] = tQ(Bn[ln]);
      } else
        throw new Error(
      ...
      g(Fo, "intArrayFromString");
      var rQ = typeof atob == "function" ? atob : function(n) {
      ...
      function iQ(n) {
        ...
        try {
          for (var a = rQ(n), Q = new Uint8Array(a.length), l = 0; l < a.length; ++l)
            Q[l] = a.charCodeAt(l);
          return Q;
        } catch {
      ...
      function un(n) {
        if (cn(n))
          return iQ(n.slice(En.length));
      }
      g(un, "tryParseAsDataURI");
      var oQ = {
        s: bB,
        p: YB,
        e: GB,
        ...
        b: AQ,
        t: eQ
      }, H = RB(), iD = e.___wasm_call_ctors = H.v, oD = e._zip_ext_count_symlinks = H.w, gD = e._zip_file_get_external_attributes = H.x, sD = e.
      _zipstruct_stat = H.y, nD = e._zipstruct_statS = H.z, CD = e._zipstruct_stat_name = H.A, ID = e._zipstruct_stat_index = H.B, aD = e._zipstruct_stat_size =
      H.C, ED = e._zipstruct_stat_mtime = H.D, cD = e._zipstruct_stat_crc = H.E, BD = e._zipstruct_error = H.F, QD = e._zipstruct_errorS = H.
      G, hD = e._zipstruct_error_code_zip = H.H, lD = e._zipstruct_stat_comp_size = H.I, uD = e._zipstruct_stat_comp_method = H.J, fD = e._zip_close =
      H.K, wD = e._zip_delete = H.L, dD = e._zip_dir_add = H.M, pD = e._zip_discard = H.N, mD = e._zip_error_init_with_code = H.O, yD = e._zip_get_error =
      H.P, DD = e._zip_file_get_error = H.Q, KD = e._zip_error_strerror = H.R, SD = e._zip_fclose = H.S, FD = e._zip_file_add = H.T, ND = e.
      _free = H.U, fn = e._malloc = H.V, gQ = e.___errno_location = H.W, kD = e._zip_source_error = H.X, MD = e._zip_source_seek = H.Y, RD = e.
      _zip_file_set_external_attributes = H.Z, bD = e._zip_file_set_mtime = H._, LD = e._zip_fopen = H.$, YD = e._zip_fopen_index = H.aa, UD = e.
      _zip_fread = H.ba, GD = e._zip_get_name = H.ca, JD = e._zip_get_num_entries = H.da, vD = e._zip_source_read = H.ea, xD = e._zip_name_locate =
      H.fa, PD = e._zip_open = H.ga, OD = e._zip_open_from_source = H.ha, _D = e._zip_set_file_compression = H.ia, TD = e._zip_source_buffer =
      H.ja, HD = e._zip_source_buffer_create = H.ka, jD = e._zip_source_close = H.la, qD = e._zip_source_free = H.ma, zD = e._zip_source_keep =
      H.na, WD = e._zip_source_open = H.oa, XD = e._zip_source_set_mtime = H.qa, VD = e._zip_source_tell = H.ra, ZD = e._zip_stat = H.sa, $D = e.
      _zip_stat_index = H.ta, Or = e.__get_tzname = H.ua, sQ = e.__get_daylight = H.va, nQ = e.__get_timezone = H.wa, CQ = e.stackSave = H.xa,
      IQ = e.stackRestore = H.ya, wn = e.stackAlloc = H.za;
      e.cwrap = MA, e.getValue = lA;
      var _r;
      Ht = /* @__PURE__ */ g(function n() {
        _r || No(), _r || (Ht = n);
      }, "runCaller");
      function No(n) {
        if (n = n || I, rt > 0 || (yB(), rt > 0))
          return;
        function C() {
          _r || (_r = !0, e.calledRun = !0, !BA && (DB(), t(e), e.onRuntimeInitialized && e.onRuntimeInitialized(), KB()));
        }
      ...
      if (g(No, "run"), e.run = No, e.preInit)
        for (typeof e.preInit == "function" && (e.preInit = [e.preInit]); e.preInit.length > 0; )
          e.preInit.pop()();
      return No(), A;
    };
  }();
  typeof lo == "object" && typeof gn == "object" ? gn.exports = on : typeof define == "function" && define.amd ? define([], function() {
    return on;
  }) : typeof lo == "object" && (lo.createModule = on);
});
...
var iB = j((Ot) => {
  ...
  var Ky = (Zc(), Ie(Vc)), Sy = Ky.__importDefault(AB()), Fy = tB(), sn = null;
  function rB() {
    return sn === null && (sn = (0, Fy.makeInterface)((0, Sy.default)())), sn;
  }
  g(rB, "getLibzipSync");
  Ot.getLibzipSync = rB;
  async function Ny() {
  ...
  g(Ny, "getLibzipPromise");
  Ot.getLibzipPromise = Ny;
});
...
var it = {
  ...
  "@storybook/addon-backgrounds": "8.5.7",
  "@storybook/addon-controls": "8.5.7",
  "@storybook/addon-docs": "8.5.7",
  "@storybook/addon-essentials": "8.5.7",
  "@storybook/addon-mdx-gfm": "8.5.7",
  "@storybook/addon-highlight": "8.5.7",
  "@storybook/addon-interactions": "8.5.7",
  "@storybook/addon-jest": "8.5.7",
  "@storybook/addon-links": "8.5.7",
  "@storybook/addon-measure": "8.5.7",
  "@storybook/addon-onboarding": "8.5.7",
  "@storybook/addon-outline": "8.5.7",
  "@storybook/addon-storysource": "8.5.7",
  "@storybook/experimental-addon-test": "8.5.7",
  "@storybook/addon-themes": "8.5.7",
  "@storybook/addon-toolbars": "8.5.7",
  "@storybook/addon-viewport": "8.5.7",
  "@storybook/builder-vite": "8.5.7",
  "@storybook/builder-webpack5": "8.5.7",
  "@storybook/core": "8.5.7",
  "@storybook/builder-manager": "8.5.7",
  "@storybook/channels": "8.5.7",
  "@storybook/client-logger": "8.5.7",
  "@storybook/components": "8.5.7",
  "@storybook/core-common": "8.5.7",
  "@storybook/core-events": "8.5.7",
  "@storybook/core-server": "8.5.7",
  "@storybook/csf-tools": "8.5.7",
  "@storybook/docs-tools": "8.5.7",
  "@storybook/manager": "8.5.7",
  "@storybook/manager-api": "8.5.7",
  "@storybook/node-logger": "8.5.7",
  "@storybook/preview": "8.5.7",
  "@storybook/preview-api": "8.5.7",
  "@storybook/router": "8.5.7",
  "@storybook/telemetry": "8.5.7",
  "@storybook/theming": "8.5.7",
  "@storybook/types": "8.5.7",
  "@storybook/angular": "8.5.7",
  "@storybook/ember": "8.5.7",
  "@storybook/experimental-nextjs-vite": "8.5.7",
  "@storybook/html-vite": "8.5.7",
  "@storybook/html-webpack5": "8.5.7",
  "@storybook/nextjs": "8.5.7",
  "@storybook/preact-vite": "8.5.7",
  "@storybook/preact-webpack5": "8.5.7",
  "@storybook/react-native-web-vite": "8.5.7",
  "@storybook/react-vite": "8.5.7",
  "@storybook/react-webpack5": "8.5.7",
  "@storybook/server-webpack5": "8.5.7",
  "@storybook/svelte-vite": "8.5.7",
  "@storybook/svelte-webpack5": "8.5.7",
  "@storybook/sveltekit": "8.5.7",
  "@storybook/vue3-vite": "8.5.7",
  "@storybook/vue3-webpack5": "8.5.7",
  "@storybook/web-components-vite": "8.5.7",
  "@storybook/web-components-webpack5": "8.5.7",
  "@storybook/blocks": "8.5.7",
  storybook: "8.5.7",
  sb: "8.5.7",
  "@storybook/cli": "8.5.7",
  "@storybook/codemod": "8.5.7",
  "@storybook/core-webpack": "8.5.7",
  "create-storybook": "8.5.7",
  "@storybook/csf-plugin": "8.5.7",
  "@storybook/instrumenter": "8.5.7",
  "@storybook/react-dom-shim": "8.5.7",
  "@storybook/source-loader": "8.5.7",
  "@storybook/test": "8.5.7",
  "@storybook/preset-create-react-app": "8.5.7",
  "@storybook/preset-html-webpack": "8.5.7",
  "@storybook/preset-preact-webpack": "8.5.7",
  "@storybook/preset-react-webpack": "8.5.7",
  "@storybook/preset-server-webpack": "8.5.7",
  "@storybook/preset-svelte-webpack": "8.5.7",
  "@storybook/preset-vue3-webpack": "8.5.7",
  "@storybook/html": "8.5.7",
  "@storybook/preact": "8.5.7",
  "@storybook/react": "8.5.7",
  "@storybook/server": "8.5.7",
  "@storybook/svelte": "8.5.7",
...
var vC = IA(jA(), 1);
import { join as GC, parse as JC } from "node:path";
import { logger as Br } from "@storybook/core/node-logger";
import { CriticalPresetLoadError as Vh } from "@storybook/core/server-errors";

// src/common/utils/interpret-files.ts
import { existsSync as Dn } from "node:fs";
var ko = /* @__PURE__ */ new Set([".js", ".jsx", ".ts", ".tsx", ".cts", ".mts", ".cjs", ".mjs"]);
function hQ() {
  return [...Array.from(ko)];
}
g(hQ, "sortExtensions");
var Kn = hQ();
function wt(r) {
  return Kn.map((A) => r.endsWith(A) ? r : `${r}${A}`).find((A) => Dn(A));
}
g(wt, "getInterpretedFile");
function Sn(r) {
  return Kn.map((A) => ({ path: r.endsWith(A) ? r : `${r}${A}`, ext: A })).find((A) => Dn(A.path));
}
g(Sn, "getInterpretedFileWithExt");
...
g(Xt, "serverRequire");
function Vt(r) {
  let A = Array.isArray(r) ? r : [r], e = lQ(A);
  return e ? e.path : null;
}
g(Vt, "serverResolve");

// src/common/utils/load-custom-presets.ts
import { resolve as Zo } from "node:path";

// src/common/utils/validate-configuration-files.ts
import { resolve as KC } from "node:path";
import { once as Hh } from "@storybook/core/node-logger";
import { MainFileMissingError as jh } from "@storybook/core/server-errors";
...
var DQ = {
  ...
  "[:xdigit:]": ["A-Fa-f0-9", !1]
}, Ar = /* @__PURE__ */ g((r) => r.replace(/[[\]\\-]/g, "\\$&"), "braceEscape"), KQ = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,
"\\$&"), "regexpEscape"), On = /* @__PURE__ */ g((r) => r.join(""), "rangesToString"), _n = /* @__PURE__ */ g((r, A) => {
  let e = A;
  if (r.charAt(e) !== "[")
  ...
  A: for (; o < r.length; ) {
    ...
    if (D === "[" && !E) {
      for (let [U, [R, T, M]] of Object.entries(DQ))
        if (r.startsWith(U, o)) {
          if (u)
...
var SQ = /* @__PURE__ */ new Set(["!", "?", "+", "*", "@"]), Tn = /* @__PURE__ */ g((r) => SQ.has(r), "isExtglobType"), FQ = "(?!(?:^|/)\\.\\.\
?(?:$|/))", Tr = "(?!\\.)", NQ = /* @__PURE__ */ new Set(["[", "."]), kQ = /* @__PURE__ */ new Set(["..", "."]), MQ = new Set("().*{}+?[]^$\\\
!"), RQ = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "regExpEscape"), Lo = "[^/]", Hn = Lo + "*?", jn = Lo + "+\
?", dt = class r {
  static {
    g(this, "AST");
  }
  ...
  toRegExpSource(A) {
    ...
    if (this.#A === this && this.#l(), !this.type) {
      ...
      if (this.isStart() && typeof this.#r[0] == "string" && !(this.#r.length === 1 && kQ.has(this.#r[0]))) {
        let m = NQ, D = (
    ...
    let s = !t || A || e || !Tr ? "" : this.#B(!0);
    s === o && (s = ""), s && (o = `(?:${o})(?:${s})*?`);
    let I = "";
    if (this.type === "!" && this.#o)
      I = (this.isStart() && !e ? Tr : "") + jn;
    else {
      let E = this.type === "!" ? (
        // !() must match something,but !(x) can match ''
        "))" + (this.isStart() && !e && !A ? Tr : "") + Hn + ")"
...
// ../node_modules/glob/node_modules/minimatch/dist/esm/index.js
var xA = /* @__PURE__ */ g((r, A, e = {}) => ($t(A), !e.nocomment && A.charAt(0) === "#" ? !1 : new ZA(A, e).match(r)), "minimatch"), bQ = /^\*+([^+@!?\*\[\(]*)$/,
LQ = /* @__PURE__ */ g((r) => (A) => !A.startsWith(".") && A.endsWith(r), "starDotExtTest"), YQ = /* @__PURE__ */ g((r) => (A) => A.endsWith(
r), "starDotExtTestDot"), UQ = /* @__PURE__ */ g((r) => (r = r.toLowerCase(), (A) => !A.startsWith(".") && A.toLowerCase().endsWith(r)), "st\
arDotExtTestNocase"), GQ = /* @__PURE__ */ g((r) => (r = r.toLowerCase(), (A) => A.toLowerCase().endsWith(r)), "starDotExtTestNocaseDot"), JQ = /^\*+\.\*+$/,
vQ = /* @__PURE__ */ g((r) => !r.startsWith(".") && r.includes("."), "starDotStarTest"), xQ = /* @__PURE__ */ g((r) => r !== "." && r !== ".\
." && r.includes("."), "starDotStarTestDot"), PQ = /^\.\*+$/, OQ = /* @__PURE__ */ g((r) => r !== "." && r !== ".." && r.startsWith("."), "d\
otStarTest"), _Q = /^\*+$/, TQ = /* @__PURE__ */ g((r) => r.length !== 0 && !r.startsWith("."), "starTest"), HQ = /* @__PURE__ */ g((r) => r.
length !== 0 && r !== "." && r !== "..", "starTestDot"), jQ = /^\?+([^+@!?\*\[\(]*)?$/, qQ = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = Xn([r]);
  return A ? (A = A.toLowerCase(), (t) => e(t) && t.toLowerCase().endsWith(A)) : e;
}, "qmarksTestNocase"), zQ = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = Vn([r]);
  return A ? (A = A.toLowerCase(), (t) => e(t) && t.toLowerCase().endsWith(A)) : e;
}, "qmarksTestNocaseDot"), WQ = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = Vn([r]);
  return A ? (t) => e(t) && t.endsWith(A) : e;
}, "qmarksTestDot"), XQ = /* @__PURE__ */ g(([r, A = ""]) => {
  let e = Xn([r]);
  return A ? (t) => e(t) && t.endsWith(A) : e;
}, "qmarksTest"), Xn = /* @__PURE__ */ g(([r]) => {
  let A = r.length;
  return (e) => e.length === A && !e.startsWith(".");
}, "qmarksTestNoExt"), Vn = /* @__PURE__ */ g(([r]) => {
  let A = r.length;
  return (e) => e.length === A && e !== "." && e !== "..";
}, "qmarksTestNoExtDot"), Zn = typeof process == "object" && process ? typeof process.env == "object" && process.env && process.env.__MINIMATCH_TESTING_PLATFORM__ ||
process.platform : "posix", qn = {
  win32: { sep: "\\" },
  posix: { sep: "/" }
}, VQ = Zn === "win32" ? qn.win32.sep : qn.posix.sep;
xA.sep = VQ;
var YA = Symbol("globstar **");
xA.GLOBSTAR = YA;
var ZQ = "[^/]", $Q = ZQ + "*?", Ah = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?", eh = "(?:(?!(?:\\/|^)\\.).)*?", th = /* @__PURE__ */ g((r, A = {}) => (e) => xA(
e, r, A), "filter");
xA.filter = th;
var ee = /* @__PURE__ */ g((r, A = {}) => Object.assign({}, r, A), "ext"), rh = /* @__PURE__ */ g((r) => {
...
xA.defaults = rh;
var $n = /* @__PURE__ */ g((r, A = {}) => ($t(r), A.nobrace || !/\{(?:(?!\{).)*\}/.test(r) ? [r] : (0, Wn.default)(r)), "braceExpand");
xA.braceExpand = $n;
var ih = /* @__PURE__ */ g((r, A = {}) => new ZA(r, A).makeRe(), "makeRe");
xA.makeRe = ih;
var oh = /* @__PURE__ */ g((r, A, e = {}) => {
  let t = new ZA(A, e);
  return r = r.filter((i) => t.match(i)), t.options.nonull && !r.length && r.push(A), r;
}, "match");
xA.match = oh;
var zn = /[?*]|[+@!]\(.*?\)|\[|\]/, gh = /* @__PURE__ */ g((r) => r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "regExpEscape"), ZA = class {
  static {
    g(this, "Minimatch");
  }
  options;
  ...
  regexp;
  constructor(A, e = {}) {
    $t(A), e = e || {}, this.options = e, this.pattern = A, this.platform = e.platform || Zn, this.isWindows = this.platform === "win32", this.
  ...
  make() {
    ...
    let i = this.globParts.map((o, s, I) => {
      if (this.isWindows && this.windowsNoMagicRoot) {
        let E = o[0] === "" && o[1] === "" && (o[2] === "?" || !zn.test(o[2])) && !zn.test(o[3]), B = /^[a-z]:/i.test(o[0]);
        if (E)
...
>>> no match, partial?`, A, f, e, p), f === E));
  ...
  parse(A) {
    ...
    if (A === "")
      return "";
    let t, i = null;
    (t = A.match(_Q)) ? i = e.dot ? HQ : TQ : (t = A.match(bQ)) ? i = (e.nocase ? e.dot ? GQ : UQ : e.dot ? YQ : LQ)(t[1]) : (t = A.match(jQ)) ?
    i = (e.nocase ? e.dot ? zQ : qQ : e.dot ? WQ : XQ)(t) : (t = A.match(JQ)) ? i = e.dot ? xQ : vQ : (t = A.match(PQ)) && (i = OQ);
  ...
  makeRe() {
    ...
    let e = this.options, t = e.noglobstar ? $Q : e.dot ? Ah : eh, i = new Set(e.nocase ? ["i"] : []), o = A.map((E) => {
      let B = E.map((h) => {
        if (h instanceof RegExp)
          for (let u of h.flags.split(""))
            i.add(u);
        return typeof h == "string" ? gh(h) : h === YA ? YA : h._src;
      });
...
var mt = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, eC = /* @__PURE__ */ new Set(),
Yo = typeof process == "object" && process ? process : {}, tC = /* @__PURE__ */ g((r, A, e, t) => {
  typeof Yo.emitWarning == "function" ? Yo.emitWarning(r, A, e, t) : console.error(`[${e}] ${A}: ${r}`);
}, "emitWarning"), Hr = globalThis.AbortController, AC = globalThis.AbortSignal;
if (typeof Hr > "u") {
  AC = class {
    static {
      g(this, "AbortSignal");
  ...
  let r = Yo.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1", A = /* @__PURE__ */ g(() => {
    r && (r = !1, tC("AbortController is not defined. If using lru-cache in node 14, load an AbortController polyfill from the `node-abort-c\
...
var sh = /* @__PURE__ */ g((r) => !eC.has(r), "shouldWarn"), vK = Symbol("type"), _e = /* @__PURE__ */ g((r) => r && r === Math.floor(r) && r >
0 && isFinite(r), "isPosInt"), rC = /* @__PURE__ */ g((r) => _e(r) ? r <= Math.pow(2, 8) ? Uint8Array : r <= Math.pow(2, 16) ? Uint16Array :
r <= Math.pow(2, 32) ? Uint32Array : r <= Number.MAX_SAFE_INTEGER ? yt : null : null, "getUintArray"), yt = class extends Array {
  ...
  constructor(A) {
    ...
    this.#l = new sA(e), this.#u = new sA(e), this.#B = 0, this.#c = 0, this.#m = Uo.create(e), this.#s = 0, this.#a = 0, typeof B == "funct\
ion" && (this.#t = B), typeof h == "function" ? (this.#r = h, this.#h = []) : (this.#r = void 0, this.#h = void 0), this.#d = !!this.#t, this.#Q =
    ...
    if (!this.ttlAutopurge && !this.#A && !this.#e) {
      ...
      sh(P) && (eC.add(P), tC("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCac\
heWarning", P, r));
    }
  }
  /**
...
ict"), this.#Q && this.#h?.push([i, t, "evict"])), this.#b(e), A && (this.#C[e] = void 0, this.#o[e] = void 0, this.#m.push(e)), this.#s ===
  ...
  #I(A) {
    if (!this.#p)
      return !1;
    let e = A;
    return !!e && e instanceof Promise && e.hasOwnProperty("__staleWhileFetching") && e.__abortController instanceof Hr;
  }
  async fetch(A, e = {}) {
    let {
      // get options
  ...
  get(A, e = {}) {
    ...
    if (I !== void 0) {
      ...
      get = "hit"), B ? E.__staleWhileFetching : (this.#x(I), i && this.#K(I), E));
    } else s && (s.get = "miss");
  }
  #v(A, e) {
...
import { posix as uh, win32 as jo } from "node:path";
import { fileURLToPath as fh } from "node:url";
import { lstatSync as wh, readdir as dh, readdirSync as ph, readlinkSync as mh, realpathSync as yh } from "fs";
import * as Dh from "node:fs";
import { lstat as Sh, readdir as Fh, readlink as Nh, realpath as kh } from "node:fs/promises";

// ../node_modules/minipass/dist/esm/index.js
import { EventEmitter as _o } from "node:events";
import nC from "node:stream";
import { StringDecoder as nh } from "node:string_decoder";
var iC = typeof process == "object" && process ? process : {
  stdout: null,
  stderr: null
}, Ch = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && (r instanceof He || r instanceof nC || Ih(r) || ah(r)), "isStream"), Ih = /* @__PURE__ */ g(
(r) => !!r && typeof r == "object" && r instanceof _o && typeof r.pipe == "function" && // node core Writable streams have a pipe() method, but it throws
r.pipe !== nC.Writable.prototype.pipe, "isReadable"), ah = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && r instanceof _o && typeof r.
write == "function" && typeof r.end == "function", "isWritable"), Me = Symbol("EOF"), Re = Symbol("maybeEmitEnd"), Te = Symbol("emittedEnd"),
jr = Symbol("emittingEnd"), tr = Symbol("emittedError"), qr = Symbol("closed"), oC = Symbol("read"), zr = Symbol("flush"), gC = Symbol("flus\
hChunk"), Ee = Symbol("encoding"), Dt = Symbol("decoder"), FA = Symbol("flowing"), rr = Symbol("paused"), Kt = Symbol("resume"), NA = Symbol(
"buffer"), PA = Symbol("pipes"), kA = Symbol("bufferLength"), Go = Symbol("bufferPush"), Wr = Symbol("bufferShift"), UA = Symbol("objectMode"),
wA = Symbol("destroyed"), Jo = Symbol("error"), vo = Symbol("emitData"), sC = Symbol("emitEnd"), xo = Symbol("emitEnd2"), pe = Symbol("async"),
Po = Symbol("abort"), Xr = Symbol("aborted"), ir = Symbol("signal"), ot = Symbol("dataListeners"), $A = Symbol("discarded"), or = /* @__PURE__ */ g(
(r) => Promise.resolve().then(r), "defer"), Eh = /* @__PURE__ */ g((r) => r(), "nodefer"), ch = /* @__PURE__ */ g((r) => r === "end" || r ===
"finish" || r === "prefinish", "isEndish"), Bh = /* @__PURE__ */ g((r) => r instanceof ArrayBuffer || !!r && typeof r == "object" && r.constructor &&
r.constructor.name === "ArrayBuffer" && r.byteLength >= 0, "isArrayBufferLike"), Qh = /* @__PURE__ */ g((r) => !Buffer.isBuffer(r) && ArrayBuffer.
isView(r), "isArrayBufferView"), Vr = class {
  static {
    g(this, "Pipe");
  }
  src;
...
}, hh = /* @__PURE__ */ g((r) => !!r.objectMode, "isObjectModeOptions"), lh = /* @__PURE__ */ g((r) => !r.objectMode && !!r.encoding && r.encoding !==
"buffer", "isEncodingOptions"), He = class extends _o {
  static {
    g(this, "Minipass");
  }
  [FA] = !1;
  ...
  constructor(...A) {
    ...
    hh(e) ? (this[UA] = !0, this[Ee] = null) : lh(e) ? (this[Ee] = e.encoding, this[UA] = !1) : (this[UA] = !1, this[Ee] = null), this[pe] =
    !!e.async, this[Dt] = this[Ee] ? new nh(this[Ee]) : null, e && e.debugExposeBuffer === !0 && Object.defineProperty(this, "buffer", { get: /* @__PURE__ */ g(
    () => this[NA], "get") }), e && e.debugExposePipes === !0 && Object.defineProperty(this, "pipes", { get: /* @__PURE__ */ g(() => this[PA],
    "get") });
    let { signal: t } = e;
    t && (this[ir] = t, t.aborted ? this[Po]() : t.addEventListener("abort", () => this[Po]()));
  }
  /**
  ...
  [Po]() {
    this[Xr] = !0, this.emit("abort", this[ir]?.reason), this.destroy(this[ir]?.reason);
  }
  /**
  ...
  write(A, e, t) {
    ...
    return this[UA] ? (this[FA] && this[kA] !== 0 && this[zr](!0), this[FA] ? this.emit("data", A) : this[Go](A), this[kA] !== 0 && this.emit(
    ...
    this[kA] !== 0 && this[zr](!0), this[FA] ? this.emit("data", A) : this[Go](A), this[kA] !== 0 && this.emit("readable"), t && i(t), this[FA]) :
  ...
  read(A) {
    ...
    let e = this[oC](A || null, this[NA][0]);
    return this[Re](), e;
  }
  [oC](A, e) {
    if (this[UA])
      ...
      let t = e;
      A === t.length || A === null ? this[Wr]() : typeof t == "string" ? (this[NA][0] = t.slice(A), e = t.slice(0, A), this[kA] -= A) : (this[NA][0] =
    ...
    this.once("end", t), this[Me] = !0, this.writable = !1, (this[FA] || !this[rr]) && this[Re](), this;
  }
  // don't let the internal resume be overwritten
  [Kt]() {
    this[wA] || (!this[ot] && !this[PA].length && (this[$A] = !0), this[rr] = !1, this[FA] = !0, this.emit("resume"), this[NA].length ? this[zr]() :
  ...
  [zr](A = !1) {
    do
      ;
    while (this[gC](this[Wr]()) && this[NA].length);
  ...
  pipe(A, e) {
    ...
    this[$A] = !1;
    let t = this[Te];
    return e = e || {}, A === iC.stdout || A === iC.stderr ? e.end = !1 : e.end = e.end !== !1, e.proxyErrors = !!e.proxyErrors, t ? e.end &&
    A.end() : (this[PA].push(e.proxyErrors ? new Oo(this, A, e) : new Vr(this, A, e)), this[pe] ? or(() => this[Kt]()) : this[Kt]()), A;
  }
  /**
  ...
  unpipe(A) {
    ...
    e && (this[PA].length === 1 ? (this[FA] && this[ot] === 0 && (this[FA] = !1), this[PA] = []) : this[PA].splice(this[PA].indexOf(e), 1), e.
    unpipe());
  }
  /**
  ...
  on(A, e) {
    let t = super.on(A, e);
    if (A === "data")
      this[$A] = !1, this[ot]++, !this[PA].length && !this[FA] && this[Kt]();
    else if (A === "readable" && this[kA] !== 0)
      super.emit("readable");
    else if (ch(A) && this[Te])
      super.emit(A), this.removeAllListeners(A);
    else if (A === "error" && this[tr]) {
      let i = e;
      this[pe] ? or(() => i.call(this, this[tr])) : i.call(this, this[tr]);
    }
    return t;
  }
  /**
  ...
  off(A, e) {
    let t = super.off(A, e);
    return A === "data" && (this[ot] = this.listeners("data").length, this[ot] === 0 && !this[$A] && !this[PA].length && (this[FA] = !1)), t;
  }
  /**
  ...
  removeAllListeners(A) {
    ...
    return (A === "data" || A === void 0) && (this[ot] = 0, !this[$A] && !this[PA].length && (this[FA] = !1)), e;
  }
  /**
  ...
  [Re]() {
    !this[jr] && !this[Te] && !this[wA] && this[NA].length === 0 && this[Me] && (this[jr] = !0, this.emit("end"), this.emit("prefinish"), this.
    emit("finish"), this[qr] && this.emit("close"), this[jr] = !1);
  }
  /**
  ...
  emit(A, ...e) {
    ...
    if (A !== "error" && A !== "close" && A !== wA && this[wA])
      return !1;
    if (A === "data")
      return !this[UA] && !t ? !1 : this[pe] ? (or(() => this[vo](t)), !0) : this[vo](t);
    if (A === "end")
      return this[sC]();
    if (A === "close") {
      if (this[qr] = !0, !this[Te] && !this[wA])
        return !1;
      let o = super.emit("close");
      return this.removeAllListeners("close"), o;
    } else if (A === "error") {
      this[tr] = t, super.emit(Jo, t);
  ...
  [sC]() {
    return this[Te] ? !1 : (this[Te] = !0, this.readable = !1, this[pe] ? (or(() => this[xo]()), !0) : this[xo]());
  }
  [xo]() {
    if (this[Dt]) {
      let e = this[Dt].end();
  ...
  [Symbol.iterator]() {
    this[$A] = !1;
    let A = !1, e = /* @__PURE__ */ g(() => (this.pause(), this.off(Jo, e), this.off(wA, e), this.off("end", e), A = !0, { done: !0, value: void 0 }),
    "stop"), t = /* @__PURE__ */ g(() => {
      if (A)
        return e();
      let i = this.read();
    ...
    return this.once("end", e), this.once(Jo, e), this.once(wA, e), {
      next: t,
      throw: e,
      return: e,
      [Symbol.iterator]() {
  ...
  destroy(A) {
    ...
    let e = this;
    return typeof e.close == "function" && !this[qr] && e.close(), A ? this.emit("error", A) : this.emit(wA), this;
  }
  /**
...
}, cC = /* @__PURE__ */ g((r) => !r || r === sr || r === Dh ? sr : {
  ...sr,
  ...r,
  promises: {
    ...sr.promises,
...
}, "fsFromOption"), BC = /^\\\\\?\\([a-z]:)\\?$/i, Mh = /* @__PURE__ */ g((r) => r.replace(/\//g, "\\").replace(BC, "$1\\"), "uncToDrive"), Rh = /[\\\/]/,
re = 0, QC = 1, hC = 2, me = 4, lC = 6, uC = 8, gt = 10, fC = 12, te = 15, gr = ~te, To = 16, CC = 32, nr = 64, ce = 128, Zr = 256, Ai = 512,
IC = nr | ce | Ai, bh = 1023, Ho = /* @__PURE__ */ g((r) => r.isFile() ? uC : r.isDirectory() ? me : r.isSymbolicLink() ? gt : r.isCharacterDevice() ?
hC : r.isBlockDevice() ? lC : r.isSocket() ? fC : r.isFIFO() ? QC : re, "entToType"), aC = /* @__PURE__ */ new Map(), Cr = /* @__PURE__ */ g(
(r) => {
  let A = aC.get(r);
  if (A)
    return A;
  ...
  return aC.set(r, e), e;
}, "normalize"), EC = /* @__PURE__ */ new Map(), $r = /* @__PURE__ */ g((r) => {
  let A = EC.get(r);
  if (A)
    return A;
  let e = Cr(r.toLowerCase());
  return EC.set(r, e), e;
}, "normalizeNocase"), ei = class extends er {
  static {
    g(this, "ResolveCache");
  }
  constructor() {
...
}, wC = Symbol("PathScurry setAsCwd"), GA = class {
  static {
    g(this, "PathBase");
  }
  /**
  ...
  constructor(A, e = re, t, i, o, s, I) {
    this.name = A, this.#w = o ? $r(A) : Cr(A), this.#i = e & bh, this.nocase = o, this.roots = i, this.root = t || this, this.#R = s, this.#p =
    I.fullpath, this.#N = I.relative, this.#K = I.relativePosix, this.parent = I.parent, this.parent ? this.#A = this.parent.#A : this.#A = cC(
    I.fs);
  }
  /**
  ...
  children() {
    ...
    return this.#R.set(this, e), this.#i &= ~To, e;
  }
  /**
  ...
  child(A, e) {
    ...
    let t = this.children(), i = this.nocase ? $r(A) : Cr(A);
    for (let E of t)
      if (E.#w === i)
        return E;
  ...
  canReadlink() {
    ...
    if (!this.parent)
      return !1;
    let A = this.#i & te;
    return !(A !== re && A !== gt || this.#i & Zr || this.#i & ce);
  }
  /**
   ...
   */
  isNamed(A) {
    return this.nocase ? this.#w === $r(A) : this.#w === Cr(A);
  }
  /**
  ...
  #Y() {
    this.#i & ce || (this.#i = (this.#i | ce) & gr, this.#S());
  }
  #S() {
    let A = this.children();
    A.provisional = 0;
  ...
  #U() {
    if (this.#i & nr)
      return;
    let A = this.#i;
    (A & te) === me && (A &= gr), this.#i = A | nr, this.#S();
  }
  #G(A = "") {
  ...
  #I(A = "") {
    let e = this.#i;
    e |= Zr, A === "ENOENT" && (e |= ce), (A === "EINVAL" || A === "UNKNOWN") && (e &= gr), this.#i = e, A === "ENOTDIR" && this.parent && this.
    parent.#U();
  }
  #v(A, e) {
  ...
  #x(A, e) {
    let t = Ho(A), i = this.newChild(A.name, t, { parent: this }), o = i.#i & te;
    return o !== me && o !== gt && o !== re && (i.#i |= nr), e.unshift(i), e.provisional++, i;
  }
  #M(A, e) {
    for (let t = e.provisional; t < e.length; t++) {
      let i = e[t];
      if ((this.nocase ? $r(A.name) : Cr(A.name)) === i.#w)
        return this.#P(A, i, t, e);
    }
  }
  #P(A, e, t, i) {
    let o = e.name;
    return e.#i = e.#i & gr | Ho(A), o !== A.name && (e.name = A.name), t !== i.provisional && (t === i.length - 1 ? i.pop() : i.splice(t, 1),
  ...
  #H(A) {
    ...
    let x = Ho(A);
    this.#i = this.#i & gr | x | CC, x !== re && x !== me && x !== gt && (this.#i |= nr);
  }
  #_ = [];
  #T = !1;
  #j(A) {
  ...
  shouldWalk(A, e) {
    return (this.#i & me) === me && !(this.#i & IC) && !A.has(this) && (!e || e(this));
  }
  /**
  ...
  [wC](A) {
    ...
    for (; i && i.parent; )
      e.add(i), i.#N = t.join(this.sep), i.#K = t.join("/"), i = i.parent, t.push("..");
    for (i = A; i && i.parent && !e.has(i); )
      i.#N = void 0, i.#K = void 0, i = i.parent;
  }
}, ti = class r extends GA {
  static {
    g(this, "PathWin32");
  }
  /**
   ...
   */
  getRootString(A) {
    return jo.parse(A).root;
  }
  /**
   * @internal
   */
  getRoot(A) {
    if (A = Mh(A.toUpperCase()), A === this.root.name)
      return this.root;
  ...
  sameRoot(A, e = this.root.name) {
    return A = A.toUpperCase().replace(/\//g, "\\").replace(BC, "$1\\"), A === e;
  }
}, ri = class r extends GA {
  static {
    g(this, "PathPosix");
  }
  /**
   ...
   * @internal
   */
  constructor(A = process.cwd(), e, t, { nocase: i, childrenCacheSize: o = 16 * 1024, fs: s = sr } = {}) {
    this.#r = cC(s), (A instanceof URL || A.startsWith("file://")) && (A = fh(A));
    let I = e.resolve(A);
    this.roots = /* @__PURE__ */ Object.create(null), this.rootPath = this.parseRootPath(I), this.#A = new ei(), this.#e = new ei(), this.#t =
    new qo(o);
  ...
  *iterateSync(A = this.cwd, e = {}) {
  ...
  chdir(A = this.cwd) {
    let e = this.cwd;
    this.cwd = typeof A == "string" ? this.cwd.resolve(A) : A, this.cwd[wC](e);
  }
}, St = class extends ii {
  static {
  ...
  constructor(A = process.cwd(), e = {}) {
    let { nocase: t = !0 } = e;
    super(A, jo, "\\", { ...e, nocase: t }), this.nocase = t;
   ...
   */
  parseRootPath(A) {
    return jo.parse(A).root.toUpperCase();
  }
  /**
   * @internal
   */
  newRoot(A) {
    return new ti(this.rootPath, me, void 0, this.roots, this.nocase, this.childrenCache(), { fs: A });
  }
  /**
  ...
  constructor(A = process.cwd(), e = {}) {
    let { nocase: t = !1 } = e;
    super(A, uh, "/", { ...e, nocase: t }), this.nocase = t;
  }
  /**
   * @internal
   */
   ...
   */
  newRoot(A) {
    return new ri(this.rootPath, me, void 0, this.roots, this.nocase, this.childrenCache(), { fs: A });
  }
  /**
   * Return true if the provided path string is an absolute path
   */
...
}, $K = process.platform === "win32" ? ti : ri, dC = process.platform === "win32" ? St : process.platform === "darwin" ? Ir : Ft;

// ../node_modules/glob/dist/esm/pattern.js
var Lh = /* @__PURE__ */ g((r) => r.length >= 1, "isPatternList"), Yh = /* @__PURE__ */ g((r) => r.length >= 1, "isGlobList"), Nt = class r {
  static {
    g(this, "Pattern");
  }
  #A;
...
var Uh = typeof process == "object" && process && typeof process.platform == "string" ? process.platform : "linux", kt = class {
  static {
    g(this, "Ignore");
  }
  relative;
  ...
  platform;
  mmopts;
  constructor(A, { nobrace: e, nocase: t, noext: i, noglobstar: o, platform: s = Uh }) {
...
var zo = class r {
  ...
  opts;
  constructor(A, e) {
    this.opts = A, this.follow = !!A.follow, this.dot = !!A.dot, this.hasWalkedCache = e ? e.copy() : new zo();
  }
  processPatterns(A, e) {
    this.patterns = e;
    let t = e.map((i) => [A, i]);
...
var Gh = /* @__PURE__ */ g((r, A) => typeof r == "string" ? new kt([r], A) : Array.isArray(r) ? new kt(r, A) : r, "makeIgnore"), oi = class {
  static {
    g(this, "GlobUtil");
  }
  path;
  ...
  constructor(A, e, t) {
    ...
    t.includeChildMatches !== !1, (t.ignore || !this.includeChildMatches) && (this.#e = Gh(t.ignore ?? [], t), !this.includeChildMatches && typeof this.#e.
    add != "function")) {
...
// ../node_modules/glob/dist/esm/glob.js
var vh = typeof process == "object" && process && typeof process.platform == "string" ? process.platform : "linux", Be = class {
  static {
    g(this, "Glob");
  }
  absolute;
  ...
  constructor(A, e) {
    ...
    dotRelative, this.nodir = !!e.nodir, this.mark = !!e.mark, e.cwd ? (e.cwd instanceof URL || e.cwd.startsWith("file://")) && (e.cwd = Jh(
    ...
    if (this.pattern = A, this.platform = e.platform || vh, this.opts = { ...e, platform: this.platform }, e.scurry) {
      if (this.scurry = e.scurry, e.nocase !== void 0 && e.nocase !== e.scurry.nocase)
        throw new Error("nocase option contradicts provided scurry option");
    } else {
      let E = e.platform === "win32" ? St : e.platform === "darwin" ? Ir : e.platform ? Ft : dC;
...
g(ni, "globIterateSync");
function DC(r, A = {}) {
  return new Be(r, A).iterate();
}
g(DC, "globIterate");
var xh = si, Ph = Object.assign(mC, { sync: si }), Oh = ni, _h = Object.assign(DC, {
  sync: ni
}), Th = Object.assign(yC, {
  stream: si,
  iterate: ni
...
var SC = IA(jA(), 1);
async function Ci(r) {
  let A = `{${Array.from(ko).join(",")}}`, e = await gi(je(KC(r, `main${A}`))), [t] = e;
  if (e.length > 1 && Hh.warn(SC.dedent`
      Multiple main files found in your configDir (${KC(r)}).
      Storybook will use the first one found and ignore the others. Please remove the extra files.
    `), !t)
    throw new jh({ location: r });
}
g(Ci, "validateConfigurationFiles");

// src/common/utils/load-custom-presets.ts
function FC({ configDir: r }) {
  Ci(r);
  let A = Xt(Zo(r, "presets"));
  if (Xt(Zo(r, "main"))) {
    let t = Vt(Zo(r, "main"));
    if (t)
      return [t];
...
g(FC, "loadCustomPresets");

// src/common/utils/safeResolve.ts
var RC = IA(Ag(), 1);
var bC = /* @__PURE__ */ g((r, A) => {
  try {
    return (0, RC.default)(r, A);
  } catch {
    return;
  }
}, "safeResolveFrom"), eg = /* @__PURE__ */ g((r) => {
  try {
    return J.resolve(r);
  } catch {
    return;
...
import { posix as zh, sep as Wh } from "node:path";
function Xh(r) {
  return zh.normalize(je(r));
}
g(Xh, "normalizePath");
function LC(r) {
  let A = r.split(`node_modules${Wh}`);
  return Xh(A[A.length - 1]);
}
g(LC, "stripAbsNodeModulesPath");

// src/common/presets.ts
var Qr = /* @__PURE__ */ g((r) => r != null && typeof r == "object" && Array.isArray(r) === !1, "isObject"), Zh = /* @__PURE__ */ g((r) => typeof r ==
"function", "isFunction");
function $h(r) {
  return r.filter((A) => {
...
g($h, "filterPresetsConfig");
function YC(r) {
  let { dir: A, name: e } = JC(r), t = GC(A, `${e}.mjs`);
  return eg(t) ? t : r;
}
g(YC, "resolvePathToMjs");
function UC(r, A, e) {
  return Zh(r) ? [...r({ ...e, ...A })] : Array.isArray(r) ? [...r] : [];
}
g(UC, "resolvePresetFunction");
var Al = /* @__PURE__ */ g((r, A, e) => {
  let t = A.startsWith("/") ? eg : bC.bind(null, r), i = t(A);
  if (i) {
    let { dir: f, name: p } = JC(i);
      ...
      ...B ? {
        previewAnnotations: [
          h ? {
            ...
            bare: B.includes("node_modules") ? LC(B) : B,
            absolute: h
          } : B
        ]
      } : {},
...
}, "resolveAddonName"), el = /* @__PURE__ */ g(({ configDir: r }) => (A) => {
  let e = Qr(A) && A.options || void 0, t = Qr(A) ? A.name : A, i;
  try {
    i = Al(r, t, e);
  } catch {
    Br.error(
...
${A}`
  ...
  if (!i) {
    Br.warn(`Could not resolve addon "${t}", skipping. Is it installed?`);
    return;
  }
  return {
    ...e ? { options: e } : {},
...
g(tl, "getContent");
async function rl(r, A, e) {
  let t = r.name ? r.name : r;
  try {
    let i = r.options ? r.options : {}, o = await tl(r);
    if (typeof o == "function" && (o = o(e, i)), Array.isArray(o))
      return await Ii(o, A + 1, e);
    if (Qr(o)) {
      ...
      let h = UC(
        ...
        i,
        e
      ).filter(B), u = UC(s, i, e).filter(
        B
      );
      return [
        ...await Ii([...h], A + 1, e),
        ...await Ii(
          [...u.map(el(e))].filter(Boolean),
          A + 1,
          e
        ),
        {
    ...
    return Br.warn(o), Br.error(i), [];
  }
}
g(rl, "loadPreset");
async function Ii(r, A, e) {
  return !r || !Array.isArray(r) || !r.length ? [] : (await Promise.all(
    r.map(async (t) => rl(t, A, e))
  )).reduce((t, i) => t.concat(i), []);
}
g(Ii, "loadPresets");
function xC(r, A, e, t, i) {
  ...
  return r.length ? r.reduce((s, { preset: I, options: E }) => {
    ...
    if (typeof B == "function") {
      let h = B, u = {
        ...
        combinedOptions: {
          ...
          presetsList: r,
          presets: {
            apply: /* @__PURE__ */ g(async (f, p, m = {}) => xC(r, f, p, m, i), "apply")
          }
        }
      };
      return s.then(
    ...
    return s.then((h) => Array.isArray(h) && Array.isArray(B) ? [...h, ...B] : Qr(h) && Qr(B) ? { ...h, ...B } : B);
  }, o) : o;
}
g(xC, "applyPresets");
async function il(r, A) {
  let e = await Ii(r, 0, A);
  return {
    apply: /* @__PURE__ */ g(async (t, i, o = {}) => xC(e, t, i, o, A), "apply")
  };
}
g(il, "getPresets");
async function EF(r) {
  ...
  return o.length < i.length && Br.warn(
...
import { createHash as PC, randomBytes as ol } from "node:crypto";
import { mkdirSync as tg, readFileSync as gl, readdirSync as sl, rmSync as OC, writeFileSync as nl } from "node:fs";
import { readFile as _C, readdir as TC, rm as HC, writeFile as Cl } from "node:fs/promises";
import { tmpdir as Il } from "node:os";
...
var rg = class {
  ...
  constructor(A = {}) {
    this.prefix = (A.ns || A.prefix || "") + "-", this.hash_alg = A.hash_alg || "md5", this.cache_dir = A.basePath || hr(Il(), ol(15).toString(
    "base64").replace(/\//g, "-")), this.ttl = A.ttl || 0, PC(this.hash_alg), tg(this.cache_dir, { recursive: !0 });
  }
  generateHash(A) {
    return hr(this.cache_dir, this.prefix + PC(this.hash_alg).update(A).digest("hex"));
  }
  isExpired(A, e) {
  ...
  async get(A, e) {
    try {
      let t = await _C(this.generateHash(A), "utf8");
  ...
  getSync(A, e) {
    try {
      let t = gl(this.generateHash(A), "utf8");
      return this.parseCacheData(t, e);
    } catch {
      return e;
    }
  ...
  async set(A, e, t = {}) {
    ...
    tg(this.cache_dir, { recursive: !0 }), await Cl(this.generateHash(A), this.parseSetData(A, e, i), {
      encoding: i.encoding || "utf8"
    });
  }
  setSync(A, e, t = {}) {
    let i = typeof t == "number" ? { ttl: t } : t;
    tg(this.cache_dir, { recursive: !0 }), nl(this.generateHash(A), this.parseSetData(A, e, i), {
      encoding: i.encoding || "utf8"
    });
  }
  async setMany(A, e) {
  ...
  async remove(A) {
    await HC(this.generateHash(A), { force: !0 });
  }
  removeSync(A) {
    OC(this.generateHash(A), { force: !0 });
  }
  async clear() {
    let A = await TC(this.cache_dir);
    await Promise.all(
      A.filter((e) => e.startsWith(this.prefix)).map((e) => HC(hr(this.cache_dir, e), { force: !0 }))
    );
  }
  clearSync() {
    sl(this.cache_dir).filter((A) => A.startsWith(this.prefix)).forEach((A) => OC(hr(this.cache_dir, A), { force: !0 }));
  }
  async getAll() {
    let A = Date.now(), e = await TC(this.cache_dir);
    return (await Promise.all(
      e.filter((i) => i.startsWith(this.prefix)).map((i) => _C(hr(this.cache_dir, i), "utf8"))
...
import wl from "node:path";

// ../node_modules/pkg-dir/node_modules/find-up/index.js
import Bi from "node:path";
import { fileURLToPath as hl } from "node:url";

// ../node_modules/locate-path/index.js
import XC from "node:process";
import VC from "node:path";
import zC, { promises as WC } from "node:fs";
import { fileURLToPath as Ql } from "node:url";
...
}, cl = /* @__PURE__ */ g(async (r, A) => A(await r), "testElement"), Bl = /* @__PURE__ */ g(async (r) => {
  let A = await Promise.all(r);
  if (A[1] === !0)
    throw new Ei(A[0]);
  return !1;
}, "finder");
async function gg(r, A, {
  concurrency: e = Number.POSITIVE_INFINITY,
  preserveOrder: t = !0
} = {}) {
  let i = ai(e), o = [...r].map((I) => [I, i(cl, I, A)]), s = ai(t ? 1 : Number.POSITIVE_INFINITY);
  try {
    await Promise.all(o.map((I) => s(Bl, I)));
  } catch (I) {
    if (I instanceof Ei)
      return I.value;
    throw I;
...
function $C(r) {
  if (!Object.hasOwnProperty.call(ZC, r))
    throw new Error(`Invalid type specified: ${r}`);
}
g($C, "checkType");
var AI = /* @__PURE__ */ g((r, A) => A[ZC[r]](), "matchType"), eI = /* @__PURE__ */ g((r) => r instanceof URL ? Ql(r) : r, "toPath");
async function ci(r, {
  cwd: A = XC.cwd(),
  type: e = "file",
  allowSymlinks: t = !0,
  ...
  $C(e), A = eI(A);
  let s = t ? WC.stat : WC.lstat;
  return gg(r, async (I) => {
    try {
      let E = await s(VC.resolve(A, I));
      return AI(e, E);
    } catch {
      return !1;
    }
...
function Mt(r, {
  ...
  $C(e), A = eI(A);
  let i = t ? zC.statSync : zC.lstatSync;
  for (let o of r)
    try {
      let s = i(VC.resolve(A, o), {
        throwIfNoEntry: !1
      });
      if (!s)
        continue;
...
import xF, { promises as PF } from "node:fs";

// ../node_modules/pkg-dir/node_modules/find-up/index.js
var ll = /* @__PURE__ */ g((r) => r instanceof URL ? hl(r) : r, "toPath"), ul = Symbol("findUpStop");
function fl(r, A = {}) {
  let e = Bi.resolve(ll(A.cwd) || ""), { root: t } = Bi.parse(e), i = A.stopAt || t, o = A.limit || Number.POSITIVE_INFINITY, s = [r].flat(),
  I = /* @__PURE__ */ g((B) => {
  ...
  for (; ; ) {
    let B = I({ ...A, cwd: e });
    if (B === ul || (B && E.push(Bi.resolve(e, B)), e === i || E.length >= o))
      break;
    e = Bi.dirname(e);
  }
  return E;
}
g(fl, "findUpMultipleSync");
function tI(r, A = {}) {
  return fl(r, { ...A, limit: 1 })[0];
}
g(tI, "findUpSync");

// ../node_modules/pkg-dir/index.js
function rI({ cwd: r } = {}) {
  let A = tI("package.json", { cwd: r });
  return A && wl.dirname(A);
}
g(rI, "packageDirectorySync");

// ../node_modules/find-cache-dir/index.js
var { env: sg, cwd: pl } = dl, iI = /* @__PURE__ */ g((r) => {
  try {
    return Qi.accessSync(r, Qi.constants.W_OK), !0;
  } catch {
    return !1;
  }
}, "isWritable");
function oI(r, A) {
  return A.create && Qi.mkdirSync(r, { recursive: !0 }), r;
}
g(oI, "useDirectory");
function ml(r) {
  let A = ur.join(r, "node_modules");
  if (!(!iI(A) && (Qi.existsSync(A) || !iI(ur.join(r)))))
    return A;
}
g(ml, "getNodeModuleDirectory");
function ng(r = {}) {
  if (sg.CACHE_DIR && !["true", "false", "1", "0"].includes(sg.CACHE_DIR))
    return oI(ur.join(sg.CACHE_DIR, r.name), r);
  let { cwd: A = pl(), files: e } = r;
  if (e) {
    if (!Array.isArray(e))
      throw new TypeError(`Expected \`files\` option to be an array, got \`${typeof e}\`.`);
    A = (0, gI.default)(e.map((i) => ur.resolve(A, i)));
  }
  if (A = rI({ cwd: A }), !(!A || !ml(A)))
    return oI(ur.join(A, "node_modules", ".cache", r.name), r);
}
g(ng, "findCacheDirectory");

// src/common/utils/resolve-path-in-sb-cache.ts
function nI(r, A = "default") {
  let e = ng({ name: "storybook" });
  return e ||= sI(process.cwd(), ".cache", "storybook"), sI(e, A, r);
}
g(nI, "resolvePathInStorybookCache");

// src/common/utils/cache.ts
var QN = ig({
  basePath: nI("dev-server"),
  ns: "storybook"
  // Optional. A grouping namespace for items.
});

// src/common/utils/cli.ts
import { createWriteStream as Pl, mkdirSync as Ol } from "node:fs";
import { readFile as _l, realpath as Tl, rename as Hl, rm as jl, writeFile as ql } from "node:fs/promises";
import zl from "node:os";
import { join as cg } from "node:path";

// ../node_modules/crypto-random-string/index.js
import { promisify as yl } from "util";
import Cg from "crypto";
var CI = yl(Cg.randomBytes), Dl = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-._~".split(""), Kl = "0123456789".split(""),
Sl = "CDEHKMPRTUWXY012458".split(""), Fl = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".
split(""), Nl = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), kl = /* @__PURE__ */ g((r, A) => {
  let e = A.length, t = Math.floor(65536 / e) * e - 1, i = 2 * Math.ceil(1.1 * r), o = "", s = 0;
  for (; s < r; ) {
    let I = Cg.randomBytes(i), E = 0;
    for (; E < i && s < r; ) {
  ...
  return o;
}, "generateForCustomCharacters"), Ml = /* @__PURE__ */ g(async (r, A) => {
  let e = A.length, t = Math.floor(65536 / e) * e - 1, i = 2 * Math.ceil(1.1 * r), o = "", s = 0;
  for (; s < r; ) {
    let I = await CI(i), E = 0;
    for (; E < i && s < r; ) {
      let B = I.readUInt16LE(E);
      E += 2, !(B > t) && (o += A[B % e], s++);
    }
  ...
  return o;
}, "generateForCustomCharactersAsync"), Rl = /* @__PURE__ */ g((r, A, e) => Cg.randomBytes(r).toString(A).slice(0, e), "generateRandomBytes"),
bl = /* @__PURE__ */ g(async (r, A, e) => (await CI(r)).toString(A).slice(0, e), "generateRandomBytesAsync"), Ll = /* @__PURE__ */ new Set([
  void 0,
  "hex",
  "base64",
  "url-safe",
  ...
  "ascii-printable",
  "alphanumeric"
]), II = /* @__PURE__ */ g((r, A) => ({ length: e, type: t, characters: i }) => {
...
import { existsSync as Yl } from "node:fs";
import { join as Ul } from "node:path";
...
g(cI, "getStorybookConfiguration");
...
}, NN = ["@storybook/builder-webpack5", "@storybook/builder-vite"], BI = console, Gl = /* @__PURE__ */ g(({ dependencies: r, devDependencies: A,
peerDependencies: e }, t) => [
  Object.entries(r || {}).find(t),
  Object.entries(A || {}).find(t),
  Object.entries(e || {}).find(t)
], "findDependency"), Jl = /* @__PURE__ */ g((r) => {
  let [A, e, t] = Gl(r, ([s]) => Eg[s]), [i, o] = A || e || t || [];
  return A && e && A[0] === e[0] && BI.warn(
...
}, "getRendererInfo"), vl = ["ts", "js", "tsx", "jsx", "mjs", "cjs"], ag = /* @__PURE__ */ g((r, A) => {
  let e = Ul(A, r), t = vl.find((i) => Yl(`${e}.${i}`));
  return t ? `${e}.${t}` : null;
}, "findConfigFile"), xl = /* @__PURE__ */ g((r, A) => {
  let e = A ?? ".storybook", t = r.scripts?.storybook;
  if (t && !A) {
    let i = cI(t, "-c", "--config-dir");
    i && (e = i);
  }
  return {
    configDir: e,
    mainConfig: ag("main", e),
    previewConfig: ag("preview", e),
    managerConfig: ag("manager", e)
  };
}, "getConfigInfo"), QI = /* @__PURE__ */ g((r, A) => {
  let e = Jl(r), t = xl(r, A);
  return {
    ...e,
    ...t
...
// src/common/utils/cli.ts
var Wl = /* @__PURE__ */ g(() => Tl(zl.tmpdir()), "tempDir"), hI = /* @__PURE__ */ g(async (r = "") => cg(await Wl(), r + Ig()), "getPath");
async function Xl({ prefix: r = "" } = {}) {
  let A = await hI(r);
  return Ol(A), A;
}
g(Xl, "temporaryDirectory");
async function Vl({ name: r, extension: A } = {}) {
  if (r) {
    if (A != null)
      throw new Error("The `name` and `extension` options are mutually exclusive");
    return cg(await Xl(), r);
  }
  return await hI() + (A == null ? "" : "." + A.replace(/^\./, ""));
}
g(Vl, "temporaryFile");
function vN(r) {
...
var ye = /* @__PURE__ */ g(async (r = "storybook.log") => {
  let A = cg(process.cwd(), r), e = await Vl({ name: r }), t = Pl(e, { encoding: "utf8" });
  return new Promise((i, o) => {
    t.once("open", () => {
      i({ logStream: t, moveLogFile: /* @__PURE__ */ g(async () => Hl(e, A), "moveLogFile"), clearLogFile: /* @__PURE__ */ g(async () => ql(
      e, ""), "clearLogFile"), removeLogFile: /* @__PURE__ */ g(async () => jl(e, { recursive: !0, force: !0 }), "removeLogFile"), readLogFile: /* @__PURE__ */ g(
      async () => _l(e, { encoding: "utf8" }), "readLogFile") });
    }), t.once("error", o);
  });
}, "createLogStream"), ON = /* @__PURE__ */ g((r) => Object.keys(it).includes(r), "isCorePackage");

// src/common/utils/check-addon-order.ts
import { logger as Bg } from "@storybook/core/node-logger";
var Qg = /* @__PURE__ */ g((r) => (A) => {
  let e = A.name || A;
  return e && e.replaceAll(/(\\){1,2}/g, "/").includes(r);
}, "predicateFor"), Zl = /* @__PURE__ */ g((r, A, e) => {
  let t = r.findIndex(Qg("@storybook/addon-essentials")), i = r.findIndex(Qg(A.name)), o = r.findIndex(Qg(e.name));
  return i === -1 && A.inEssentials && (i = t), o === -1 && e.inEssentials && (o = t), i !== -1 && o !== -1 && i <= o;
}, "isCorrectOrder"), jN = /* @__PURE__ */ g(async ({ before: r, after: A, configFile: e, getConfig: t }) => {
  try {
    let i = await t(e);
    if (!i?.addons) {
      Bg.warn("Unable to find 'addons' config in main Storybook config");
      return;
    }
    if (!Zl(i.addons, r, A)) {
    ...
    Bg.warn(`Unable to load config file: ${e}`);
  }
}, "checkAddonOrder");

// ../node_modules/lazy-universal-dotenv/lib/index.mjs
var SI = IA(uI(), 1), FI = IA(mI(), 1), NI = IA(KI(), 1);
import lu from "fs";
import uu from "path";
var qe = uu.join(SI.default.get(), ".env");
function kI({ nodeEnv: r, buildTarget: A } = {}) {
  ...
  return [
    ...
    if (lu.existsSync(E)) {
      let B = FI.default.config({
        path: E
      });
      e = Object.assign({}, e, NI.default.expand(B).parsed);
    }
...
import { join as li, resolve as pu, sep as mu } from "node:path";
...
function fr(r) {
  return r instanceof URL ? fu(r) : r;
}
g(fr, "toPath");

// node_modules/path-exists/index.js
import Ik, { promises as ak } from "node:fs";

// node_modules/find-up/index.js
var MI = Symbol("findUpStop");
async function wu(r, A = {}) {
  let e = De.resolve(fr(A.cwd) ?? ""), { root: t } = De.parse(e), i = De.resolve(e, fr(A.stopAt ?? t)), o = A.limit ?? Number.POSITIVE_INFINITY,
  s = [r].flat(), I = /* @__PURE__ */ g(async (B) => {
    if (typeof r != "function")
      return ci(s, B);
    let h = await r(B.cwd);
    return typeof h == "string" ? ci([h], B) : h;
  }, "runMatcher"), E = [];
  for (; ; ) {
    let B = await I({ ...A, cwd: e });
    if (B === MI || (B && E.push(De.resolve(e, B)), e === i || E.length >= o))
      break;
    e = De.dirname(e);
  }
  return E;
...
var yk = /* @__PURE__ */ g(() => {
  ...
  try {
    let A = OA(".git", { type: "directory" });
    A && (r = li(A, ".."));
  } catch {
  }
  try {
    let A = OA(".svn", { type: "directory" });
    A && (r = r || li(A, ".."));
  } catch {
  }
  try {
    let A = OA(".hg", { type: "directory" });
    A && (r = r || li(A, ".."));
  } catch {
  }
  try {
  ...
  try {
    let A = OA(".yarn", { type: "directory" });
    A && (r = r || li(A, ".."));
  } catch {
  }
  return r || process.cwd();
}, "getProjectRoot"), RI = /* @__PURE__ */ g((r) => r.split(process.platform === "win32" ? ";" : ":").filter(Boolean).map((A) => pu("./", A)),
"nodePathsToArray"), yu = /^\.{1,2}([/\\]|$)/;
function bI(r) {
  return yu.test(r) ? r : `.${mu}${r}`;
}
g(bI, "normalizeStoryPath");
...
function Nk(r = {}) {
  ...
  let t = Object.entries(e).reduce(
    ...
    {}
  ), { stringified: i, raw: o } = kI({ nodeEnv: e.NODE_ENV }), s = { ...e, ...o };
  return s.NODE_PATH = RI(s.NODE_PATH || ""), {
    stringified: { ...t, ...i },
    raw: s
  };
}
g(Nk, "loadEnvs");
var kk = /* @__PURE__ */ g((r) => Object.entries(r).reduce((A, [e, t]) => (A[e] = JSON.stringify(t), A), {}), "stringifyEnvs"), Mk = /* @__PURE__ */ g(
...
var Du = /node_modules/, Lk = /* @__PURE__ */ g((r) => Du.test(r) ? {} : { ignore: ["**/node_modules/**"] }, "commonGlobOptions");
...
g(Jk, "getBuilderOptions");

// src/common/utils/get-framework-name.ts
var UI = IA(jA(), 1);

// src/common/utils/normalize-path.ts
import { posix as Ku } from "node:path";
function YI(r) {
  return Ku.normalize(r.replace(/\\/g, "/"));
}
g(YI, "normalizePath");
...
async function Vk(r) {
  ...
  return !A || !A.renderer ? GI(r) : A.renderer;
}
g(Vk, "getRendererName");
async function Zk(r) {
  let A = JI(r), e = Rt[A];
  return e ? LI[e] : null;
}
g(Zk, "extractProperRendererNameFromFramework");

// src/common/utils/get-storybook-refs.ts
import { readFile as vI } from "node:fs/promises";
import { dirname as Su, join as Fu } from "node:path";
import { logger as Nu } from "@storybook/core/node-logger";
var xI = IA(Ag(), 1);
var ku = /* @__PURE__ */ g(async (r) => {
  let A = await Ke("package.json", { cwd: r.configDir });
  if (!A)
    return {};
  let e = Su(A), { dependencies: t = [], devDependencies: i = [] } = JSON.parse(await vI(A, { encoding: "utf8" })) || {}, o = Object.keys({ ...t,
  ...i });
  return (await Promise.all(
    o.map(async (I) => {
      try {
        let E = (0, xI.default)(e, Fu(I, "package.json")), { storybook: B, name: h, version: u } = JSON.parse(await vI(E, { encoding: "utf8" })) ||
        {};
        if (B?.url)
        ...
        if (E.code === "ERR_PACKAGE_PATH_NOT_EXPORTED")
          return;
        Nu.warn(`unable to find package.json for ${I}`);
        return;
      }
    })
...
}, "getAutoRefs"), Mu = /* @__PURE__ */ g((r) => fetch(`${r}/iframe.html`).then(
  async ({ ok: A, status: e }) => {
    if (A) {
      if (e !== 200)
        return !1;
  ...
  () => !1
), "checkRef"), PI = /* @__PURE__ */ g((r) => r.replace(/\/$/, ""), "stripTrailingSlash"), Ru = /* @__PURE__ */ g((r) => {
...
async function oM(r) {
  if (r.test)
    return {};
  let A = await r.presets.apply("refs", await ku(r));
  return Object.entries(A).forEach(([e, t]) => {
    ...
    A[e.toLowerCase()] = {
      ...t,
      id: e.toLowerCase(),
      title: t.title || Ru(t.id || e),
      url: PI(t.url)
    };
  }), await Promise.all(
    Object.entries(A).map(async ([e, t]) => {
      let i = await Mu(t.url);
...
var dM = /* @__PURE__ */ g((r, A) => Object.entries(A).reduce((e, [t, i]) => {
  let o = i.replace(/\\/g, "/").replace(/\$/g, "$$$");
  return e.replace(new RegExp(`{{${t}}}`, "g"), o);
}, r), "interpolate");

// src/common/utils/load-main-config.ts
import { readFile as cf } from "node:fs/promises";
import { relative as Ca, resolve as Bf } from "node:path";
import { MainFileESMOnlyImportError as Qf, MainFileEvaluationError as hf } from "@storybook/core/server-errors";
async function NM({
  ...
  try {
    ...
    if (t.message.match(/Cannot use import statement outside a module/)) {
      let i = Ca(process.cwd(), e), o = t.stack?.match(new RegExp(`${i}:(\\d+):(\\d+)`))?.[1], s, I;
      if (o) {
        let h = (await cf(e, "utf-8")).split(`
`);
...
var Ia = IA(jA(), 1);
import { resolve as Mg } from "node:path";
import { logger as lf } from "@storybook/core/node-logger";
function YM({ configDir: r }) {
  let A = wt(Mg(r, "addons")), e = wt(Mg(r, "manager"));
  if ((A || e) && lf.info("=> Loading custom manager config"), A && e)
    throw new Error(Ia.dedent`
      You have both a "addons.js" and a "manager.js", remove the "addons.js" file from your configDir (${Mg(
      r,
      "addons"
    )})`);
  return e || A;
}
g(YM, "loadManagerOrAddonsFile");

// src/common/utils/load-preview-or-config-file.ts
var aa = IA(jA(), 1);
import { resolve as Rg } from "node:path";
function xM({ configDir: r }) {
  let A = wt(Rg(r, "config")), e = wt(Rg(r, "preview"));
  if (A && e)
    throw new Error(aa.dedent`
      You have both a "config.js" and a "preview.js", remove the "config.js" file from your configDir (${Rg(
      r,
      "config"
    )})`);
  return e || A;
}
g(xM, "loadPreviewOrConfigFile");

// src/common/utils/log.ts
var Ct = IA(mi(), 1);
var yi = console, HM = /* @__PURE__ */ g((r) => (process.stdout.write(Ct.default.cyan(" \u2022 ") + r), (A, e) => {
  if (A) {
...
function qM(r, A) {
  let e = 0, i = r.map((o) => (e = o.length > e ? o.length : e, o)).map((o) => {
    let s = e - o.length, I = o + Ba(" ", s);
    return I = Ba(" ", A || 2) + Ct.default.inverse(` ${I} `), I;
  }).join(`
`);
  yi.log(i);
}
...
var Qa = IA(mi(), 1);
function XM(r, A) {
  console.log(Qa.default.cyan(String(r))), console.dir(A, { depth: null });
}
g(XM, "logConfig");

// src/common/utils/normalize-stories.ts
var la = IA(kg(), 1);
import { lstatSync as df } from "node:fs";
import { basename as pf, dirname as mf, relative as yf, resolve as ha } from "node:path";
import { InvalidStoriesEntryError as Df } from "@storybook/core/server-errors";
var Di = "", Kf = "**/*.@(mdx|stories.@(js|jsx|mjs|ts|tsx))", Sf = /* @__PURE__ */ g((r, A) => {
  try {
    return df(ha(r, A)).isDirectory();
  } catch {
    return !1;
  }
}, "isDirectory"), Ff = /* @__PURE__ */ g(({
  configDir: r,
  workingDir: A,
  directory: e
}) => {
  let t = ha(r, e), i = yf(A, t);
  return bI(i);
}, "getDirectoryFromWorkingDir"), Nf = /* @__PURE__ */ g((r, { configDir: A, workingDir: e, defaultFilesPattern: t = Kf }) => {
  let i;
  if (typeof r == "string") {
    let B = la.scan(r);
    if (B.isGlob) {
...
}, "normalizeStoriesEntry"), oR = /* @__PURE__ */ g((r, A) => {
  if (!r || Array.isArray(r) && r.length === 0)
    throw new Df();
  return r.map((e) => Nf(e, A));
}, "normalizeStories");

// src/common/utils/readTemplate.ts
import { readFile as kf } from "node:fs/promises";
async function CR(r) {
  return kf(r, {
    encoding: "utf8"
  });
...
var BB = IA(jA(), 1);
import { readConfig as vy, writeConfig as xy } from "@storybook/core/csf-tools";

// src/common/js-package-manager/JsPackageManagerFactory.ts
var Jr = IA(_g(), 1);
import { basename as by, parse as CB, relative as Ly } from "node:path";

// src/common/js-package-manager/BUNProxy.ts
import { existsSync as Fd, readFileSync as Nd } from "node:fs";
import { platform as kd } from "node:os";
import { join as Md } from "node:path";
import { logger as Rd } from "@storybook/core/node-logger";
import { FindPackageVersionsError as bd } from "@storybook/core/server-errors";
var Ac = IA(jA(), 1);
import Ld from "semver/functions/sort.js";

// src/common/js-package-manager/JsPackageManager.ts
import { existsSync as ls, readFileSync as pd } from "node:fs";
import { readFile as md, writeFile as yd } from "node:fs/promises";
import { dirname as Dd, resolve as Kd } from "node:path";

// node_modules/execa/index.js
var TE = IA(_g(), 1);
import { Buffer as hd } from "node:buffer";
import ld from "node:path";
import Qs from "node:child_process";
...
g(Tg, "stripFinalNewline");

// node_modules/npm-run-path/index.js
import Fi from "node:process";
import pr from "node:path";
import rw from "node:url";
...
function iw(r = {}) {
  let {
    cwd: A = Fi.cwd(),
    path: e = Fi.env[Si()],
    execPath: t = Fi.execPath
  } = r, i, o = A instanceof URL ? rw.fileURLToPath(A) : A, s = pr.resolve(o), I = [];
  for (; i !== s; )
    I.push(pr.join(s, "node_modules/.bin")), i = s, s = pr.resolve(s, "..");
  return I.push(pr.resolve(o, t, "..")), [...I, e].join(pr.delimiter);
}
g(iw, "npmRunPath");
function oE({ env: r = Fi.env, ...A } = {}) {
  r = { ...r };
  let e = Si({ env: r });
...
var ow = /* @__PURE__ */ g((r, A, e, t) => {
  ...
  !gw(i, o) && t || Object.defineProperty(r, e, o);
}, "copyProperty"), gw = /* @__PURE__ */ g(function(r, A) {
...
}, "canCopyProperty"), sw = /* @__PURE__ */ g((r, A) => {
  let e = Object.getPrototypeOf(A);
  e !== Object.getPrototypeOf(r) && Object.setPrototypeOf(r, e);
}, "changePrototype"), nw = /* @__PURE__ */ g((r, A) => `/* Wrapped ${r}*/
${A}`, "wrappedToString"), Cw = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), Iw = Object.getOwnPropertyDescriptor(Function.
prototype.toString, "name"), aw = /* @__PURE__ */ g((r, A, e) => {
  let t = e === "" ? "" : `with ${e.trim()}() `, i = nw.bind(null, t, A.toString());
  Object.defineProperty(i, "name", Iw), Object.defineProperty(r, "toString", { ...Cw, value: i });
}, "changeToString");
function Hg(r, A, { ignoreNonConfigurable: e = !1 } = {}) {
  let { name: t } = r;
  for (let i of Reflect.ownKeys(A))
    ow(r, A, i, e);
  return sw(r, A), aw(r, A, t), r;
}
g(Hg, "mimicFunction");

// node_modules/onetime/index.js
var Ni = /* @__PURE__ */ new WeakMap(), gE = /* @__PURE__ */ g((r, A = {}) => {
  if (typeof r != "function")
...
import dw from "node:process";

// node_modules/human-signals/build/src/main.js
import { constants as Qw } from "node:os";

// node_modules/human-signals/build/src/realtime.js
var nE = /* @__PURE__ */ g(() => {
  let r = jg - CE + 1;
  return Array.from({ length: r }, Ew);
}, "getRealtimeSignals"), Ew = /* @__PURE__ */ g((r, A) => ({
  name: `SIGRT${A + 1}`,
  number: CE + A,
  action: "terminate",
  description: "Application-specific signal (realtime)",
  standard: "posix"
}), "getRealtimeSignal"), CE = 34, jg = 64;

// node_modules/human-signals/build/src/signals.js
import { constants as cw } from "node:os";
...
var hw = /* @__PURE__ */ g(() => {
  let r = qg();
  return Object.fromEntries(r.map(lw));
}, "getSignalsByName"), lw = /* @__PURE__ */ g(({
  name: r,
  number: A,
  description: e,
  supported: t,
  ...
  forced: o,
  standard: s
}) => [r, { name: r, number: A, description: e, supported: t, action: i, forced: o, standard: s }], "getSignalByName"), aE = hw(), uw = /* @__PURE__ */ g(
() => {
  let r = qg(), A = jg + 1, e = Array.from(
    { length: A },
    (t, i) => fw(i, r)
  );
  return Object.assign({}, ...e);
}, "getSignalsByNumber"), fw = /* @__PURE__ */ g((r, A) => {
  let e = ww(r, A);
  if (e === void 0)
    return {};
...
}, "getSignalByNumber"), ww = /* @__PURE__ */ g((r, A) => {
  let e = A.find(({ name: t }) => Qw.signals[t] === r);
  return e !== void 0 ? e : A.find((t) => t.number === r);
}, "findSignalByNumber"), C0 = uw();

// node_modules/execa/lib/error.js
var pw = /* @__PURE__ */ g(({ timedOut: r, timeout: A, errorCode: e, signal: t, signalDescription: i, exitCode: o, isCanceled: s }) => r ? `\
...
o !== void 0 ? `failed with exit code ${o}` : "failed", "getErrorPrefix"), mr = /* @__PURE__ */ g(({
  ...
  isCanceled: B,
  killed: h,
  parsed: { options: { timeout: u, cwd: f = dw.cwd() } }
}) => {
  o = o === null ? void 0 : o, i = i === null ? void 0 : i;
  let p = i === void 0 ? void 0 : aE[i].description, m = t && t.code, U = `Command ${pw({ timedOut: E, timeout: u, errorCode: m, signal: i, signalDescription: p,
...
var ki = ["stdin", "stdout", "stderr"], mw = /* @__PURE__ */ g((r) => ki.some((A) => r[A] !== void 0), "hasAlias"), EE = /* @__PURE__ */ g((r) => {
  if (!r)
    return;
  let { stdio: A } = r;
  if (A === void 0)
    return ki.map((t) => r[t]);
  if (mw(r))
    throw new Error(`It's not possible to provide \`stdio\` in combination with one of ${ki.map((t) => `\`${t}\``).join(", ")}`);
  if (typeof A == "string")
    return A;
  if (!Array.isArray(A))
    throw new TypeError(`Expected \`stdio\` to be of type \`string\` or \`Array\`, got \`${typeof A}\``);
  let e = Math.max(A.length, ki.length);
  return Array.from({ length: e }, (t, i) => A[i]);
}, "normalizeStdio");

// node_modules/execa/lib/kill.js
import Kw from "node:os";
...
var Mi = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && typeof r.removeListener == "function" && typeof r.emit == "function" && typeof r.
reallyExit == "function" && typeof r.listeners == "function" && typeof r.kill == "function" && typeof r.pid == "number" && typeof r.on == "f\
unction", "processOk"), zg = Symbol.for("signal-exit emitter"), Wg = globalThis, yw = Object.defineProperty.bind(Object), Xg = class {
  static {
    g(this, "Emitter");
  }
  emitted = {
...
}), "signalExitWrap"), Vg = class extends Ri {
  static {
  ...
  /* c8 ignore start */
  #A = $g.platform === "win32" ? "SIGINT" : "SIGHUP";
  /* c8 ignore stop */
  #e = new Xg();
  #t;
  #r;
  ...
  #a(A) {
    return Mi(this.#t) ? (this.#t.exitCode = A || 0, this.#e.emit("exit", this.#t.exitCode, null), this.#g.call(this.#t, this.#t.exitCode)) :
    0;
  }
  #n(A, ...e) {
    let t = this.#r;
   ...
   */
  unload: d0
} = Dw(Mi($g) ? new Zg($g) : new Vg());

// node_modules/execa/lib/kill.js
var Sw = 1e3 * 5, BE = /* @__PURE__ */ g((r, A = "SIGTERM", e = {}) => {
  let t = r(A);
  return Fw(r, A, e, t), t;
}, "spawnedKill"), Fw = /* @__PURE__ */ g((r, A, e, t) => {
  if (!Nw(A, e, t))
    return;
  let i = Mw(e), o = setTimeout(() => {
    r("SIGKILL");
  }, i);
  o.unref && o.unref();
}, "setKillTimeout"), Nw = /* @__PURE__ */ g((r, { forceKillAfterTimeout: A }, e) => kw(r) && A !== !1 && e, "shouldForceKill"), kw = /* @__PURE__ */ g(
(r) => r === Kw.constants.signals.SIGTERM || typeof r == "string" && r.toUpperCase() === "SIGTERM", "isSigterm"), Mw = /* @__PURE__ */ g(({ forceKillAfterTimeout: r = !0 }) => {
  if (r === !0)
    return Sw;
  if (!Number.isFinite(r) || r < 0)
    throw new TypeError(`Expected the \`forceKillAfterTimeout\` option to be a non-negative integer, got \`${r}\` (${typeof r})`);
  return r;
}, "getForceKillAfterTimeout"), QE = /* @__PURE__ */ g((r, A) => {
  r.kill() && (A.isCanceled = !0);
}, "spawnedCancel"), Rw = /* @__PURE__ */ g((r, A, e) => {
  r.kill(A), e(Object.assign(new Error("Timed out"), { timedOut: !0, signal: A }));
}, "timeoutKill"), hE = /* @__PURE__ */ g((r, { timeout: A, killSignal: e = "SIGTERM" }, t) => {
  if (A === 0 || A === void 0)
    return t;
...
}, "setupTimeout"), lE = /* @__PURE__ */ g(({ timeout: r }) => {
...
}, "validateTimeout"), uE = /* @__PURE__ */ g(async (r, { cleanup: A, detached: e }, t) => {
  if (!A || e)
    return t;
  let i = cE(() => {
    r.kill();
...
import { createWriteStream as bw } from "node:fs";
import { ChildProcess as Lw } from "node:child_process";
...
g(bi, "isStream");
function As(r) {
  return bi(r) && r.writable !== !1 && typeof r._write == "function" && typeof r._writableState == "object";
}
g(As, "isWritableStream");

// node_modules/execa/lib/pipe.js
var Yw = /* @__PURE__ */ g((r) => r instanceof Lw && typeof r.then == "function", "isExecaChildProcess"), es = /* @__PURE__ */ g((r, A, e) => {
  if (typeof e == "string")
    return r[A].pipe(bw(e)), r;
  if (As(e))
    return r[A].pipe(e), r;
  if (!Yw(e))
...
}, "pipeToTarget"), fE = /* @__PURE__ */ g((r) => {
  r.stdout !== null && (r.pipeStdout = es.bind(void 0, r, "stdout")), r.stderr !== null && (r.pipeStderr = es.bind(void 0, r, "stderr")), r.
  all !== void 0 && (r.pipeAll = es.bind(void 0, r, "all"));
}, "addPipeMethods");

// node_modules/execa/lib/stream.js
import { createReadStream as Ad, readFileSync as ed } from "node:fs";
import { setTimeout as td } from "node:timers/promises";

// node_modules/get-stream/source/contents.js
var yr = /* @__PURE__ */ g(async (r, { init: A, convertChunk: e, getSize: t, truncateChunk: i, addChunk: o, getFinalChunk: s, finalize: I }, {
maxBuffer: E = Number.POSITIVE_INFINITY } = {}) => {
  ...
  try {
    for await (let h of r) {
      let u = Jw(h), f = e[u](h, B);
      pE({ convertedChunk: f, state: B, getSize: t, truncateChunk: i, addChunk: o, maxBuffer: E });
    }
    return Uw({ state: B, convertChunk: e, getSize: t, truncateChunk: i, addChunk: o, getFinalChunk: s, maxBuffer: E }), I(B);
  } catch (h) {
    throw h.bufferedData = I(B), h;
  }
}, "getStreamContents"), Uw = /* @__PURE__ */ g(({ state: r, getSize: A, truncateChunk: e, addChunk: t, getFinalChunk: i, maxBuffer: o }) => {
  let s = i(r);
  s !== void 0 && pE({ convertedChunk: s, state: r, getSize: A, truncateChunk: e, addChunk: t, maxBuffer: o });
}, "appendFinalChunk"), pE = /* @__PURE__ */ g(({ convertedChunk: r, state: A, getSize: e, truncateChunk: t, addChunk: i, maxBuffer: o }) => {
  ...
  throw E !== void 0 && wE(E, A, i, o), new Li();
}, "appendChunk"), wE = /* @__PURE__ */ g((r, A, e, t) => {
  A.contents = e(r, A, t), A.length = t;
}, "addNewChunk"), Gw = /* @__PURE__ */ g((r) => typeof r == "object" && r !== null && typeof r[Symbol.asyncIterator] == "function", "isAsyn\
cIterable"), Jw = /* @__PURE__ */ g((r) => {
  let A = typeof r;
  if (A === "string")
    return "string";
  if (A !== "object" || r === null)
  ...
  r.byteOffset) && dE.call(r.buffer) === "[object ArrayBuffer]" ? "typedArray" : "others";
}, "getChunkType"), { toString: dE } = Object.prototype, Li = class extends Error {
  static {
...
var ts = /* @__PURE__ */ g((r) => r, "identity"), rs = /* @__PURE__ */ g(() => {
}, "noop"), is = /* @__PURE__ */ g(({ contents: r }) => r, "getContentsProp"), Yi = /* @__PURE__ */ g((r) => {
  throw new Error(`Streams in object mode are not supported: ${String(r)}`);
}, "throwObjectStream"), Ui = /* @__PURE__ */ g((r) => r.length, "getLengthProp");

// node_modules/get-stream/source/array-buffer.js
async function os(r, A) {
  return yr(r, qw, A);
}
g(os, "getStreamAsArrayBuffer");
var vw = /* @__PURE__ */ g(() => ({ contents: new ArrayBuffer(0) }), "initArrayBuffer"), xw = /* @__PURE__ */ g((r) => Pw.encode(r), "useTex\
tEncoder"), Pw = new TextEncoder(), mE = /* @__PURE__ */ g((r) => new Uint8Array(r), "useUint8Array"), yE = /* @__PURE__ */ g((r) => new Uint8Array(
r.buffer, r.byteOffset, r.byteLength), "useUint8ArrayWithOffset"), Ow = /* @__PURE__ */ g((r, A) => r.slice(0, A), "truncateArrayBufferChunk"),
_w = /* @__PURE__ */ g((r, { contents: A, length: e }, t) => {
  let i = SE() ? Hw(A, t) : Tw(A, t);
  return new Uint8Array(i).set(r, e), i;
}, "addArrayBufferChunk"), Tw = /* @__PURE__ */ g((r, A) => {
  if (A <= r.byteLength)
    return r;
  let e = new ArrayBuffer(KE(A));
  return new Uint8Array(e).set(new Uint8Array(r), 0), e;
}, "resizeArrayBufferSlow"), Hw = /* @__PURE__ */ g((r, A) => {
  if (A <= r.maxByteLength)
    return r.resize(A), r;
  let e = new ArrayBuffer(A, { maxByteLength: KE(A) });
  return new Uint8Array(e).set(new Uint8Array(r), 0), e;
}, "resizeArrayBuffer"), KE = /* @__PURE__ */ g((r) => DE ** Math.ceil(Math.log(r) / Math.log(DE)), "getNewContentsLength"), DE = 2, jw = /* @__PURE__ */ g(
({ contents: r, length: A }) => SE() ? r : r.slice(0, A), "finalizeArrayBuffer"), SE = /* @__PURE__ */ g(() => "resize" in ArrayBuffer.prototype,
"hasArrayBufferResize"), qw = {
  init: vw,
  convertChunk: {
    string: xw,
    buffer: mE,
...
async function Gi(r, A) {
  ...
  try {
    return FE(await os(r, A));
  } catch (e) {
    throw e.bufferedData !== void 0 && (e.bufferedData = FE(e.bufferedData)), e;
  }
}
g(Gi, "getStreamAsBuffer");
var FE = /* @__PURE__ */ g((r) => globalThis.Buffer.from(r), "arrayBufferToNodeBuffer");

// node_modules/get-stream/source/string.js
async function gs(r, A) {
  return yr(r, Zw, A);
}
g(gs, "getStreamAsString");
var zw = /* @__PURE__ */ g(() => ({ contents: "", textDecoder: new TextDecoder() }), "initString"), Ji = /* @__PURE__ */ g((r, { textDecoder: A }) => A.
decode(r, { stream: !0 }), "useTextDecoder"), Ww = /* @__PURE__ */ g((r, { contents: A }) => A + r, "addStringChunk"), Xw = /* @__PURE__ */ g(
(r, A) => r.slice(0, A), "truncateStringChunk"), Vw = /* @__PURE__ */ g(({ textDecoder: r }) => {
  let A = r.decode();
  return A === "" ? void 0 : A;
}, "getFinalStringChunk"), Zw = {
  init: zw,
  convertChunk: {
    string: ts,
    buffer: Ji,
...
}, "validateInputOptions"), rd = /* @__PURE__ */ g(({ input: r, inputFile: A }) => typeof A != "string" ? r : (RE(r), ed(A)), "getInputSync"),
bE = /* @__PURE__ */ g((r) => {
  let A = rd(r);
  if (bi(A))
    throw new TypeError("The `input` option cannot be a stream in sync mode");
  return A;
}, "handleInputSync"), id = /* @__PURE__ */ g(({ input: r, inputFile: A }) => typeof A != "string" ? r : (RE(r), Ad(A)), "getInput"), LE = /* @__PURE__ */ g(
(r, A) => {
  let e = id(A);
  e !== void 0 && (bi(e) ? e.pipe(r.stdin) : r.stdin.end(e));
}, "handleInput"), YE = /* @__PURE__ */ g((r, { all: A }) => {
  if (!A || !r.stdout && !r.stderr)
    return;
  let e = (0, ME.default)();
  return r.stdout && e.add(r.stdout), r.stderr && e.add(r.stderr), e;
}, "makeAllStream"), ss = /* @__PURE__ */ g(async (r, A) => {
  if (!(!r || A === void 0)) {
    await td(0), r.destroy();
    try {
      return await A;
    } catch (e) {
...
}, "getBufferedData"), ns = /* @__PURE__ */ g((r, { encoding: A, buffer: e, maxBuffer: t }) => {
  if (!(!r || !e))
    return A === "utf8" || A === "utf-8" ? gs(r, { maxBuffer: t }) : A === null || A === "buffer" ? Gi(r, { maxBuffer: t }) : od(r, t, A);
}, "getStreamPromise"), od = /* @__PURE__ */ g(async (r, A, e) => (await Gi(r, { maxBuffer: A })).toString(e), "applyEncoding"), UE = /* @__PURE__ */ g(
async ({ stdout: r, stderr: A, all: e }, { encoding: t, buffer: i, maxBuffer: o }, s) => {
  let I = ns(r, { encoding: t, buffer: i, maxBuffer: o }), E = ns(A, { encoding: t, buffer: i, maxBuffer: o }), B = ns(e, { encoding: t, buffer: i,
  maxBuffer: o * 2 });
  try {
...
var gd = (async () => {
})().constructor.prototype, sd = ["then", "catch", "finally"].map((r) => [
  r,
  Reflect.getOwnPropertyDescriptor(gd, r)
]), Cs = /* @__PURE__ */ g((r, A) => {
  for (let [e, t] of sd) {
    let i = typeof A == "function" ? (...o) => Reflect.apply(t.value, A(), o) : t.value.bind(A);
    Reflect.defineProperty(r, e, { ...t, value: i });
  }
}, "mergePromise"), GE = /* @__PURE__ */ g((r) => new Promise((A, e) => {
  r.on("exit", (t, i) => {
...
import { Buffer as nd } from "node:buffer";
import { ChildProcess as Cd } from "node:child_process";
var xE = /* @__PURE__ */ g((r, A = []) => Array.isArray(A) ? [r, ...A] : [r], "normalizeArgs"), Id = /^[\w.-]+$/, ad = /* @__PURE__ */ g((r) => typeof r !=
"string" || Id.test(r) ? r : `"${r.replaceAll('"', '\\"')}"`, "escapeArg"), Is = /* @__PURE__ */ g((r, A) => xE(r, A).join(" "), "joinComman\
d"), as = /* @__PURE__ */ g((r, A) => xE(r, A).map((e) => ad(e)).join(" "), "getEscapedCommand"), PE = / +/g, Es = /* @__PURE__ */ g((r) => {
  let A = [];
  for (let e of r.trim().split(PE)) {
    let t = A.at(-1);
    t && t.endsWith("\\") ? A[A.length - 1] = `${t.slice(0, -1)} ${e}` : A.push(e);
  }
  return A;
}, "parseCommand"), JE = /* @__PURE__ */ g((r) => {
  let A = typeof r;
  if (A === "string")
    return r;
  if (A === "number")
    return String(r);
  if (A === "object" && r !== null && !(r instanceof Cd) && "stdout" in r) {
    let e = typeof r.stdout;
    if (e === "string")
      return r.stdout;
    if (nd.isBuffer(r.stdout))
...
}, "parseExpression"), vE = /* @__PURE__ */ g((r, A, e) => e || r.length === 0 || A.length === 0 ? [...r, ...A] : [
  ...r.slice(0, -1),
  `${r.at(-1)}${A[0]}`,
  ...A.slice(1)
], "concatTokens"), Ed = /* @__PURE__ */ g(({ templates: r, expressions: A, tokens: e, index: t, template: i }) => {
  let o = i ?? r.raw[t], s = o.split(PE).filter(Boolean), I = vE(
    e,
    s,
    o.startsWith(" ")
  );
  if (t === A.length)
    return I;
  let E = A[t], B = Array.isArray(E) ? E.map((h) => JE(h)) : [JE(E)];
  return vE(
    I,
    B,
    o.endsWith(" ")
  );
}, "parseTemplate"), cs = /* @__PURE__ */ g((r, A) => {
  let e = [];
  for (let [t, i] of r.entries())
    e = Ed({ templates: r, expressions: A, tokens: e, index: t, template: i });
  return e;
}, "parseTemplates");

// node_modules/execa/lib/verbose.js
import { debuglog as cd } from "node:util";
import Bd from "node:process";
var OE = cd("execa").enabled, vi = /* @__PURE__ */ g((r, A) => String(r).padStart(A, "0"), "padField"), Qd = /* @__PURE__ */ g(() => {
  let r = /* @__PURE__ */ new Date();
  return `${vi(r.getHours(), 2)}:${vi(r.getMinutes(), 2)}:${vi(r.getSeconds(), 2)}.${vi(r.getMilliseconds(), 3)}`;
}, "getTimestamp"), Bs = /* @__PURE__ */ g((r, { verbose: A }) => {
  A && Bd.stderr.write(`[${Qd()}] ${r}
`);
}, "logCommand");

// node_modules/execa/index.js
var ud = 1e3 * 1e3 * 100, fd = /* @__PURE__ */ g(({ env: r, extendEnv: A, preferLocal: e, localDir: t, execPath: i }) => {
  let o = A ? { ...xi.env, ...r } : r;
  return e ? oE({ env: o, cwd: t, execPath: i }) : o;
}, "getEnv"), HE = /* @__PURE__ */ g((r, A, e = {}) => {
  let t = TE.default._parse(r, A, e);
  return r = t.command, A = t.args, e = t.options, e = {
    ...
    extendEnv: !0,
    preferLocal: !1,
    localDir: e.cwd || xi.cwd(),
    execPath: xi.execPath,
    encoding: "utf8",
    reject: !0,
    cleanup: !0,
    all: !1,
    ...
    verbose: OE,
    ...e
  }, e.env = fd(e), e.stdio = EE(e), xi.platform === "win32" && ld.basename(r, ".exe") === "cmd" && A.unshift("/q"), { file: r, args: A, options: e,
  parsed: t };
}, "handleArguments"), Dr = /* @__PURE__ */ g((r, A, e) => typeof A != "string" && !hd.isBuffer(A) ? e === void 0 ? void 0 : "" : r.stripFinalNewline ?
Tg(A) : A, "handleOutput");
function jE(r, A, e) {
  let t = HE(r, A, e), i = Is(r, A), o = as(r, A);
  Bs(o, t.options), lE(t.options);
  let s;
  try {
    s = Qs.spawn(t.file, t.args, t.options);
  } catch (p) {
    let m = new Qs.ChildProcess(), D = Promise.reject(mr({
      error: p,
      stdout: "",
      stderr: "",
      all: "",
  ...
  let I = GE(s), E = hE(s, t.options, I), B = uE(s, t.options, E), h = { isCanceled: !1 };
  s.kill = BE.bind(null, s.kill.bind(s)), s.cancel = QE.bind(null, s, h);
  let f = sE(/* @__PURE__ */ g(async () => {
    let [{ error: p, exitCode: m, signal: D, timedOut: U }, R, T, M] = await UE(s, t.options, B), x = Dr(t.options, R), V = Dr(t.options, T),
    gA = Dr(t.options, M);
    if (p || m !== 0 || D !== null) {
      let sA = mr({
        error: p,
  ...
  return LE(s, t.options), s.all = YE(s, t.options), fE(s), Cs(s, f), s;
}
g(jE, "execa");
function qE(r, A, e) {
  let t = HE(r, A, e), i = Is(r, A), o = as(r, A);
  Bs(o, t.options);
  let s = bE(t.options), I;
  try {
    I = Qs.spawnSync(t.file, t.args, { ...t.options, input: s });
  } catch (h) {
    throw mr({
      error: h,
      stdout: "",
  ...
  let E = Dr(t.options, I.stdout, I.error), B = Dr(t.options, I.stderr, I.error);
...
"normalizeScriptStdin"), _E = /* @__PURE__ */ g((r = {}) => ({
  preferLocal: !0,
  ...wd(r),
  ...r
...
g(XE, "execaCommandSync");

// src/common/js-package-manager/JsPackageManager.ts
var us = IA(mi(), 1);
import { gt as Sd, satisfies as VE } from "semver";

// ../node_modules/tiny-invariant/dist/esm/tiny-invariant.js
var dd = process.env.NODE_ENV === "production", hs = "Invariant failed";
function Pi(r, A) {
  if (!r) {
    if (dd)
      throw new Error(hs);
    var e = typeof A == "function" ? A() : A, t = e ? "".concat(hs, ": ").concat(e) : hs;
    throw new Error(t);
  }
}
g(Pi, "invariant");
  ...
  isStorybookInMonorepo() {
    ...
    for (; ; ) {
      try {
        ...
        if (ls(t) || ls(i))
          return !0;
        let o = J.resolve(`${A}/package.json`), s = pd(o, "utf8");
...
`;
    await yd(this.packageJsonPath(), t, "utf8");
  }
  /**
...
An error occurred while installing dependencies:`), Ye.log(i.message), new nt(i);
  ...
  async removeDependencies(A, e) {
    ...
    if (t) {
      let { packageJson: i } = A;
      Pi(i, "Missing packageJson."), e.forEach((o) => {
  ...
  getVersionedPackages(A) {
    return Promise.all(
      A.map(async (e) => {
        let [t, i] = ZE(e), o = await this.latestVersion(t, i), I = it[t];
  ...
  async getVersion(A, e) {
    ...
    try {
      ...
      if (t)
        return Ye.warn(`
     ${us.default.yellow(String(s))}`), t;
      throw Ye.error(`
     ${us.default.red(String(s))}`), new nt(s);
    }
    return `^${t && (!e || VE(t, e)) && Sd(t, i) ? t : i}`;
  }
  /**
  ...
  async latestVersion(A, e) {
    ...
    let i = (await this.runGetVersions(A, !0)).reverse().find((o) => VE(o, e));
    return Pi(
      i != null,
...
var Yd = /npm ERR! code (\w+)/, Ud = {
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ke(
      (s) => {
        let I = Md(s, "node_modules", e, "package.json");
        return Fd(I) ? I : void 0;
      },
      { cwd: t }
    );
    return i ? JSON.parse(Nd(i, "utf-8")) : null;
  }
  getInstallArgs() {
  ...
  async findInstallations(e, { depth: t = 99 } = {}) {
    let i = /* @__PURE__ */ g(async ({ packageDepth: o }) => {
      let s = kd() === "win32" ? "2>NUL" : "2>/dev/null";
      return this.executeCommand({
        command: "npm",
    ...
    try {
      ...
      try {
        ...
        Rd.warn("An issue occurred while trying to find dependencies metadata using npm.");
        return;
      }
    }
  }
  ...
  mapDependencies(e, t) {
    let i = {}, o = {}, s = {}, I = /* @__PURE__ */ g(([E, B]) => {
      ...
      o[E]?.includes(h.version) || (i[E] ? i[E].push(h) : i[E] = [h], o[E] = Ld([...o[E] || [], h.version]), o[E].length > 1 && (s[E] = o[E])),
...
import { existsSync as Gd, readFileSync as Jd } from "node:fs";
import { platform as vd } from "node:os";
import { join as xd } from "node:path";
import { logger as Pd } from "@storybook/core/node-logger";
import { FindPackageVersionsError as Od } from "@storybook/core/server-errors";
var ec = IA(jA(), 1);
import _d from "semver/functions/sort.js";
var Td = /npm (ERR!|error) (code|errno) (\w+)/i, Hd = {
  E401: "Authentication failed or is required.",
  E403: "Access to the resource is forbidden.",
  E404: "Requested resource not found.",
  EACCES: "Permission issue.",
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ke(
      (s) => {
        let I = xd(s, "node_modules", e, "package.json");
        return Gd(I) ? I : void 0;
      },
      { cwd: t }
    );
    return i ? JSON.parse(Jd(i, "utf-8")) : null;
  }
  getInstallArgs() {
    return this.installArgs || (this.installArgs = []), this.installArgs;
  }
  ...
  async findInstallations(e, { depth: t = 99 } = {}) {
    let i = /* @__PURE__ */ g(async ({ packageDepth: o }) => {
      let s = vd() === "win32" ? "2>NUL" : "2>/dev/null";
      return this.executeCommand({
        command: "npm",
        args: ["ls", "--json", `--depth=${o}`, s],
        env: {
    ...
    try {
      ...
      try {
        ...
        Pd.warn("An issue occurred while trying to find dependencies metadata using npm.");
        return;
      }
    }
  }
  ...
  mapDependencies(e, t) {
    let i = {}, o = {}, s = {}, I = /* @__PURE__ */ g(([E, B]) => {
      ...
      o[E]?.includes(h.version) || (i[E] ? i[E].push(h) : i[E] = [h], o[E] = _d([...o[E] || [], h.version]), o[E].length > 1 && (s[E] = o[E])),
      B.dependencies && Object.entries(B.dependencies).forEach(I);
    }, "recurse");
    return Object.entries(e.dependencies).forEach(I), {
      dependencies: i,
...
import { existsSync as tc, readFileSync as rc } from "node:fs";
import { join as ic } from "node:path";
import { FindPackageVersionsError as jd } from "@storybook/core/server-errors";
var oc = IA(jA(), 1);
var qd = /(ELIFECYCLE|ERR_PNPM_[A-Z_]+)\s+(.*)/i, Sr = class extends ie {
  constructor() {
    super(...arguments);
    this.type = "pnpm";
  }
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = OA([".pnp.js", ".pnp.cjs"], { cwd: t });
    if (i)
      try {
        let s = J(i), I = await s.resolveToUnqualified(e, t, {
          considerBuiltins: !1
        }), E = s.findPackageLocator(I), B = s.getPackageInformation(E);
        return JSON.parse(
          rc(ic(B.packageLocation, "package.json"), "utf-8")
        );
      } catch (s) {
    ...
    let o = await OA(
      (s) => {
        let I = ic(s, "node_modules", e, "package.json");
        return tc(I) ? I : void 0;
      },
      { cwd: t }
    );
    return o ? JSON.parse(rc(o, "utf-8")) : null;
  }
  getResolutions(e, t) {
    return {
      overrides: {
...
import { existsSync as zd, readFileSync as Wd } from "node:fs";
import { join as Xd } from "node:path";
...
// src/common/js-package-manager/Yarn1Proxy.ts
var Zd = /^error\s(.*)$/gm, Fr = class extends ie {
  constructor() {
    super(...arguments);
    this.type = "yarn1";
  }
  ...
  async getPackageJSON(e, t = this.cwd) {
    let i = await Ke(
      (o) => {
        let s = Xd(o, "node_modules", e, "package.json");
        return zd(s) ? s : void 0;
      },
      { cwd: t }
    );
    return i ? JSON.parse(Wd(i, "utf-8")) : null;
  }
  async getRegistryURL() {
    let t = (await this.executeCommand({
      command: "yarn",
  ...
  mapDependencies(e, t) {
    if (e.type === "tree") {
      let { trees: i } = e.data, o = {}, s = {}, I = {}, E = /* @__PURE__ */ g((B) => {
        let { children: h } = B, { name: u, value: f } = Oi(B.name);
  ...
  parseErrorFromLogs(e) {
    let t = "YARN1 error", i = e.match(Zd);
    if (i) {
...
var _t = IA(Wc(), 1), sB = IA(iB(), 1);
import { existsSync as ky, readFileSync as My } from "node:fs";
import { join as oB } from "node:path";
import { FindPackageVersionsError as Ry } from "@storybook/core/server-errors";
var nB = IA(jA(), 1);
var gB = {
  YN0001: "EXCEPTION",
  ...
  async getPackageJSON(e, t = this.cwd) {
    ...
    if (i)
      try {
        let I = J(i), E = await I.resolveToUnqualified(e, t, {
          ...
          libzip: (0, sB.getLibzipSync)()
        }), f = new _t.VirtualFS({ baseFs: u }), p = new _t.PosixFS(f), m = oB(h.packageLocation, "package.json");
    ...
    let o = await Ke(
      (I) => {
        let E = oB(I, "node_modules", e, "package.json");
        return ky(E) ? E : void 0;
      },
      { cwd: t }
    );
    return o ? JSON.parse(My(o, "utf-8")) : null;
  }
  getResolutions(e, t) {
    return {
      resolutions: {
...
`), o = {}, s = {}, I = {};
    return i.forEach((E) => {
      if (!E || !t.some((u) => new RegExp(`${u.replace(/\*/g, ".*")}`).test(E)))
        return;
      let { name: B, value: h } = Oi(E.replaceAll('"', ""));
...
// src/common/js-package-manager/JsPackageManagerFactory.ts
var IB = "package-lock.json", aB = "pnpm-lock.yaml", EB = "yarn.lock", cB = "bun.lockb", uo = class {
  static {
  ...
  static getPackageManager({ force: A } = {}, e) {
    ...
    let i = [
      ...
      let p = CB(u).dir, m = CB(f).dir, D = Ly(p, m);
      return p === m ? 0 : D.startsWith("..") ? -1 : 1;
    })[0], o = i && by(i), s = Yy(e), I = Gy(e), E = Uy(e), B = Jy(e);
    if (B && (o === EB || !s && !I))
      return B === 1 ? new Fr({ cwd: e }) : new Gr({ cwd: e });
    if (I && o === aB)
      return new Sr({ cwd: e });
    if (s && o === IB)
      return new Ut({ cwd: e });
...
// src/common/utils/remove.ts
var fo = console;
async function EU(r, A = {}) {
  let { packageManager: e } = A, t = uo.getPackageManager({ force: e }, A.cwd), i = await t.retrievePackageJson(), { mainConfig: o, configDir: s,
  ...I } = QI(i, A.configDir);
  if (typeof s > "u")
    throw new Error(BB.dedent`
      Unable to find storybook config directory
    `);
  if (!o) {
    fo.error("Unable to find storybook main.js config");
    return;
  }
  let E = await vy(o);
  fo.log(`Uninstalling ${r}`), await t.removeDependencies({ packageJson: i }, [r]), fo.log(`Removing '${r}' from main.js addons field.`);
  try {
    E.removeEntryFromArray(["addons"], r), await xy(E);
  } catch {
    fo.warn(`Failed to remove '${r}' from main.js addons field.`);
  }
}
g(EU, "removeAddon");
...
g(QU, "isPreservingSymlinks");

// src/common/utils/template.ts
import { existsSync as QB, readFileSync as wo } from "node:fs";
import { dirname as hB, resolve as lB } from "node:path";
var uB = /* @__PURE__ */ g((r, A = {}) => Object.entries(A).reduce((e, [t, i]) => e.replace(new RegExp(`%${t}%`, "g"), i), r), "interpolate");
function wU(r, A) {
  let e = hB(J.resolve("@storybook/core/package.json")), t = wo(`${e}/assets/server/base-preview-body.html`, "utf8"), i = lB(r, "preview-bod\
y.html"), o = t;
  return QB(i) && (o = wo(i, "utf8") + o), uB(o, A);
}
g(wU, "getPreviewBodyTemplate");
function dU(r, A) {
  let e = hB(J.resolve("@storybook/core/package.json")), t = wo(`${e}/assets/server/base-preview-head.html`, "utf8"), i = lB(r, "preview-hea\
d.html"), o = t;
  return QB(i) && (o += wo(i, "utf8")), uB(o, A);
}
g(dU, "getPreviewHeadTemplate");

// src/common/utils/validate-config.ts
import { join as Py } from "node:path";
import {
  CouldNotEvaluateFrameworkError as Oy,
  InvalidFrameworkNameError as _y,
  MissingFrameworkFieldError as Ty
} from "@storybook/core/server-errors";
var fB = ["html", "preact", "react", "server", "svelte", "vue", "vue3", "web-components"], Hy = [...fB, ...fB.map((r) => `@storybook/${r}`)];
function SU(r) {
  if (!r)
    throw new Ty();
  if (Hy.includes(r))
    throw new _y({ frameworkName: r });
  if (!Object.keys(Rt).includes(r))
    try {
      J.resolve(Py(r, "preset"));
    } catch {
      throw new Oy({ frameworkName: r });
    }
}
g(SU, "validateFrameworkName");
...
g(wB, "getPrettier");
async function bU(r, A) {
  try {
    let { resolveConfig: e, format: t } = await wB(), i = await e(r);
...
g(bU, "formatFileContent");
async function jy(r, A) {
  let { resolveConfig: e, format: t } = await wB(), i = await e(r, { editorconfig: !0 });
...
var pB = IA(jA(), 1);
import { relative as Wy } from "node:path";
import { normalizeStories as Xy, normalizeStoryPath as Vy } from "@storybook/core/common";
import { sanitize as Zy, storyNameFromExport as $y, toId as AD } from "@storybook/csf";
import { userOrAutoTitleFromSpecifier as eD } from "@storybook/core/preview-api";

// src/common/utils/posix.ts
import { posix as qy, sep as zy } from "node:path";
var dB = /* @__PURE__ */ g((r, A = zy) => r.split(A).filter(Boolean).join(qy.sep), "posix");

// src/common/utils/get-story-id.ts
async function TU(r, A) {
  let e = await A.presets.apply("stories", [], A), t = tD({
    ...r,
    stories: e,
    configDir: A.configDir
  });
  if (t === void 0)
    throw new Error(pB.dedent`
    ...
    `);
  let i = $y(r.exportedStoryName), o = AD(t, i), s = Zy(t);
...
function tD({
  ...
  return o.map((E) => eD(I, E, i)).filter(Boolean)[0];
}
g(tD, "getStoryTitle");
export {
  nt as HandledError,
  ie as JsPackageManager,
  uo as JsPackageManagerFactory,
  ko as boost,
  NN as builderPackages,
  QN as cache,
  jN as checkAddonOrder,
  qM as codeLog,
  HM as commandLog,
  Lk as commonGlobOptions,
  ig as createFileSystemCache,
  ye as createLogStream,
  JI as extractProperFrameworkName,
  Zk as extractProperRendererNameFromFramework,
  $h as filterPresetsConfig,
  ag as findConfigFile,
  bU as formatFileContent,
  Rt as frameworkPackages,
  LI as frameworkToRenderer,
  ku as getAutoRefs,
  Jk as getBuilderOptions,
  Ba as getChars,
  xN as getCoercedStorybookVersion,
  xl as getConfigInfo,
  Ff as getDirectoryFromWorkingDir,
  PN as getEnvConfig,
  GI as getFrameworkName,
  wt as getInterpretedFile,
  Sn as getInterpretedFileWithExt,
  ZE as getPackageDetails,
  il as getPresets,
  wU as getPreviewBodyTemplate,
  dU as getPreviewHeadTemplate,
  yk as getProjectRoot,
  oM as getRefs,
  Vk as getRendererName,
  TU as getStoryId,
  tD as getStoryTitle,
  cI as getStorybookConfiguration,
  QI as getStorybookInfo,
  na as globToRegexp,
  Mo as interopRequireDefault,
  dM as interpolate,
  ON as isCorePackage,
  QU as isPreservingSymlinks,
  EF as loadAllPresets,
  FC as loadCustomPresets,
  Nk as loadEnvs,
  NM as loadMainConfig,
  YM as loadManagerOrAddonsFile,
  rl as loadPreset,
  xM as loadPreviewOrConfigFile,
  XM as logConfig,
  RI as nodePathsToArray,
  oR as normalizeStories,
  Nf as normalizeStoriesEntry,
  bI as normalizeStoryPath,
  jM as paddedLog,
  vN as parseList,
  dB as posix,
  CR as readTemplate,
  EU as removeAddon,
  Eg as rendererPackages,
  Al as resolveAddonName,
  nI as resolvePathInStorybookCache,
  kU as satisfies,
  Xt as serverRequire,
  Vt as serverResolve,
  kk as stringifyEnvs,
  Mk as stringifyProcessEnvs,
  LC as stripAbsNodeModulesPath,
  Xl as temporaryDirectory,
  Vl as temporaryFile,
  Ci as validateConfigurationFiles,
  SU as validateFrameworkName,
  it as versions
};
